...
func (sr *SFxMetricsDataReceiver) Start(_ consumer.Traces, mc consumer.Metrics, _ consumer.Logs) error {
	...
	sr.receiver, err = f.CreateMetricsReceiver(context.Background(), component.ReceiverCreateSettings{TelemetryCreateSettings: component.TelemetryCreateSettings{Logger: zap.L()}}, &config, mc)
	if err != nil {
		return err
	}
