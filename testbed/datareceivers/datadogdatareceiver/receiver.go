...
package datadogdatareceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/testbed/datareceivers/datadogdatareceiver"
...
func (dd *datadogDataReceiver) Start(tc consumer.Traces, _ consumer.Metrics, _ consumer.Logs) error {
	...
	cfg.ServerConfig.NetAddr.Endpoint = "0.0.0.0:8126"
