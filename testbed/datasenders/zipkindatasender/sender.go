...
package zipkindatasender // import "github.com/open-telemetry/opentelemetry-collector-contrib/testbed/datasenders/zipkindatasender"
...
func (zs *zipkinDataSender) Start() error {
	...
	cfg.ClientConfig.Endpoint = fmt.Sprintf("http://%s/api/v2/spans", zs.GetEndpoint())
