...
package datadogdatasender // import "github.com/open-telemetry/opentelemetry-collector-contrib/testbed/datasenders/datadogdatasender"
...
func (dd *datadogDataSender) Start() error {
	...
	cfg.ClientConfig.Endpoint = fmt.Sprintf("http://%s:%v/v0.4/traces", testbed.DefaultHost, 8126)
