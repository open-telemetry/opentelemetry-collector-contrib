...
require (
	...
	go.opentelemetry.io/collector/config/confignet v1.58.1-0.20260514231715-e7f22744c28c // indirect
	...
	go.opentelemetry.io/collector/config/configtls v1.58.1-0.20260514231715-e7f22744c28c // indirect
