...
require (
	...
	go.opentelemetry.io/collector/exporter/nopexporter v0.152.1-0.20260514231715-e7f22744c28c
...
require (
	...
	go.opentelemetry.io/collector/config/confighttp v0.152.1-0.20260514231715-e7f22744c28c // indirect
