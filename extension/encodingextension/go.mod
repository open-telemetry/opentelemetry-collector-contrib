...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/codec v0.85.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/pkg/codec => ../../pkg/codec
