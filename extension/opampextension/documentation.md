...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `extension.opamp.HeartbeatIntervalNegotiation` | alpha | When enabled, the OpAMP extension defaults `reports_heartbeat` to true. | v0.162.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/51427) |
