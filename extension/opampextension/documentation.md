...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `extension.opampextension.HeartbeatIntervalNegotiation` | alpha | When enabled, the OpAMP extension defaults `reports_heartbeat` to true. | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/pull/48043) |
