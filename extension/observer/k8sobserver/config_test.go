...
func TestInvalidAuth(t *testing.T) {
	...
	factory := NewFactory()
	factories.Extensions[typeStr] = factory
	cfg, err := servicetest.LoadConfigAndValidate("testdata/invalid_auth.yaml", factories)
	require.NotNil(t, cfg)
...
func TestInvalidNoObserving(t *testing.T) {
	...
	factory := NewFactory()
	factories.Extensions[typeStr] = factory
	cfg, err := servicetest.LoadConfigAndValidate("testdata/invalid_no_observing.yaml", factories)
	require.NotNil(t, cfg)
