...
| `src_gateway.project_id` | `gcp.vpc.flow.src.gateway.project.id` |
| `src_gateway.location` | `gcp.vpc.flow.src.gateway.region` |
| `src_gateway.name` | `gcp.vpc.flow.src.gateway.name` |
| `src_gateway.type` | `gcp.vpc.flow.src.gateway.type` |
| `src_gateway.vpc.project_id` | `gcp.vpc.flow.src.gateway.vpc.project.id` |
| `src_gateway.vpc.subnetwork_name` | `gcp.vpc.flow.src.gateway.vpc.subnet.name` |
| `src_gateway.vpc.subnetwork_region` | `gcp.vpc.flow.src.gateway.vpc.subnet.region` |
| `src_gateway.vpc.vpc_name` | `gcp.vpc.flow.src.gateway.vpc.name` |
| `src_gateway.interconnect_name` | `gcp.vpc.flow.src.gateway.interconnect.name` |
| `src_gateway.interconnect_project_number` | `gcp.vpc.flow.src.gateway.interconnect.project.number` |
| `dest_gateway.project_id` | `gcp.vpc.flow.dest.gateway.project.id` |
| `dest_gateway.location` | `gcp.vpc.flow.dest.gateway.region` |
| `dest_gateway.name` | `gcp.vpc.flow.dest.gateway.name` |
| `dest_gateway.type` | `gcp.vpc.flow.dest.gateway.type` |
| `dest_gateway.vpc.project_id` | `gcp.vpc.flow.dest.gateway.vpc.project.id` |
| `dest_gateway.vpc.subnetwork_name` | `gcp.vpc.flow.dest.gateway.vpc.subnet.name` |
| `dest_gateway.vpc.subnetwork_region` | `gcp.vpc.flow.dest.gateway.vpc.subnet.region` |
| `dest_gateway.vpc.vpc_name` | `gcp.vpc.flow.dest.gateway.vpc.name` |
| `dest_gateway.interconnect_name` | `gcp.vpc.flow.dest.gateway.interconnect.name` |
| `dest_gateway.interconnect_project_number` | `gcp.vpc.flow.dest.gateway.interconnect.project.number` |
| `src_gke_details.cluster.cluster_location` | `gcp.vpc.flow.src.gke.cluster.location` |
| `src_gke_details.cluster.cluster_name` | `gcp.vpc.flow.src.gke.cluster.name` |
| `src_gke_details.pod.pod_name` | `gcp.vpc.flow.src.gke.pod.name` |
| `src_gke_details.pod.pod_namespace` | `gcp.vpc.flow.src.gke.pod.namespace` |
| `src_gke_details.pod.pod_workload.workload_name` | `gcp.vpc.flow.src.gke.pod.workload.name` |
| `src_gke_details.pod.pod_workload.workload_type` | `gcp.vpc.flow.src.gke.pod.workload.type` |
| `src_gke_details.service.service_name` | `gcp.vpc.flow.src.gke.service.name` |
| `src_gke_details.service.service_namespace` | `gcp.vpc.flow.src.gke.service.namespace` |
| `dest_gke_details.cluster.cluster_location` | `gcp.vpc.flow.dest.gke.cluster.location` |
| `dest_gke_details.cluster.cluster_name` | `gcp.vpc.flow.dest.gke.cluster.name` |
| `dest_gke_details.pod.pod_name` | `gcp.vpc.flow.dest.gke.pod.name` |
| `dest_gke_details.pod.pod_namespace` | `gcp.vpc.flow.dest.gke.pod.namespace` |
| `dest_gke_details.pod.pod_workload.workload_name` | `gcp.vpc.flow.dest.gke.pod.workload.name` |
| `dest_gke_details.pod.pod_workload.workload_type` | `gcp.vpc.flow.dest.gke.pod.workload.type` |
| `dest_gke_details.service.service_name` | `gcp.vpc.flow.dest.gke.service.name` |
| `dest_gke_details.service.service_namespace` | `gcp.vpc.flow.dest.gke.service.namespace` |
| `src_google_service.type` | `gcp.vpc.flow.src.google.service.type` |
| `src_google_service.service_name` | `gcp.vpc.flow.src.google.service.name` |
| `src_google_service.connectivity` | `gcp.vpc.flow.src.google.service.connectivity` |
| `src_google_service.private_domain` | `gcp.vpc.flow.src.google.service.domain.private` |
| `dest_google_service.type` | `gcp.vpc.flow.dest.google.service.type` |
| `dest_google_service.service_name` | `gcp.vpc.flow.dest.google.service.name` |
| `dest_google_service.connectivity` | `gcp.vpc.flow.dest.google.service.connectivity` |
| `dest_google_service.private_domain` | `gcp.vpc.flow.dest.google.service.domain.private` |
| `src_instance.project_id` | `gcp.vpc.flow.src.instance.project.id` |
| `src_instance.region` | `gcp.vpc.flow.src.instance.vm.region` |
| `src_instance.vm_name` | `gcp.vpc.flow.src.instance.vm.name` |
| `src_instance.zone` | `gcp.vpc.flow.src.instance.vm.zone` |
| `src_instance.managed_instance_group.name` | `gcp.vpc.flow.src.instance.managedinstancegroup.name` |
| `src_instance.managed_instance_group.region` | `gcp.vpc.flow.src.instance.managedinstancegroup.region` |
| `src_instance.managed_instance_group.zone` | `gcp.vpc.flow.src.instance.managedinstancegroup.zone` |
| `dest_instance.project_id` | `gcp.vpc.flow.dest.instance.project.id` |
| `dest_instance.region` | `gcp.vpc.flow.dest.instance.vm.region` |
| `dest_instance.vm_name` | `gcp.vpc.flow.dest.instance.vm.name` |
| `dest_instance.zone` | `gcp.vpc.flow.dest.instance.vm.zone` |
| `dest_instance.managed_instance_group.name` | `gcp.vpc.flow.dest.instance.managedinstancegroup.name` |
| `dest_instance.managed_instance_group.region` | `gcp.vpc.flow.dest.instance.managedinstancegroup.region` |
| `dest_instance.managed_instance_group.zone` | `gcp.vpc.flow.dest.instance.managedinstancegroup.zone` |
| `src_location.asn` | `gcp.vpc.flow.src.asn` |
| `src_location.city` | `gcp.vpc.flow.src.geo.city` |
| `src_location.continent` | `gcp.vpc.flow.src.geo.continent` |
| `src_location.country` | `gcp.vpc.flow.src.geo.country.iso_code.alpha3` |
| `src_location.region` | `gcp.vpc.flow.src.geo.region` |
| `dest_location.asn` | `gcp.vpc.flow.dest.asn` |
| `dest_location.city` | `gcp.vpc.flow.dest.geo.city` |
| `dest_location.continent` | `gcp.vpc.flow.dest.geo.continent` |
| `dest_location.country` | `gcp.vpc.flow.dest.geo.country.iso_code.alpha3` |
| `dest_location.region` | `gcp.vpc.flow.dest.geo.region` |
