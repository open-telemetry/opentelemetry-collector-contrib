...
| `src_instance.managed_instance_group.name` | `gcp.vpc.flow.source.instance.managedinstancegroup.name` |
| `src_instance.managed_instance_group.region` | `gcp.vpc.flow.source.instance.managedinstancegroup.region` |
| `src_instance.managed_instance_group.zone` | `gcp.vpc.flow.source.instance.managedinstancegroup.zone` |
