...
# Exports VPC flow logs that should contain Phase 1-2 fields generated by
# generate_vpc_flow_fixtures_phase1_2.sh. The script fetches raw log entries
# and organizes them into JSONL files for later transformation into fixtures.
#
# Usage:
#   cp scripts/vpc_flow_fixtures.env.example scripts/vpc_flow_fixtures.env
#   scripts/export_vpc_flow_logs_phase1_2.sh
#
...
AGG_OUTPUT="${OUTPUT_DIR}/vpc_logs_phase1_2.jsonl"
