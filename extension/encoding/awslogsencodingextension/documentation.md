...
| `extension.encoding.awslogsencoding.DontEmitV0RPCConventions` | beta | When enabled, CloudTrail log unmarshaler no longer emits the deprecated semconv v1.38.0 attributes rpc.service and rpc.system. Requires extension.encoding.awslogsencoding.EmitV1RPCConventions to also be enabled. | v0.150.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/47549) |
| `extension.encoding.awslogsencoding.EmitV1RPCConventions` | beta | When enabled, CloudTrail log unmarshaler emits rpc.system.name (semconv v1.40.0) instead of the deprecated rpc.system (semconv v1.38.0). | v0.150.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/47549) |
