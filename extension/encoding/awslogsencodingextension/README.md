...
| `userIdentity.accessKeyId`                                | `aws.user_identity.access_key.id`                                         |
| `userIdentity.identityStoreArn`                           | `aws.user_identity.identity_store.arn`                                    |
| `userIdentity.invokedBy`                                  | `aws.user_identity.invoked_by`                                            |
| `userIdentity.principalId`                                | `aws.user_identity.principal.id`                                          |
| `userIdentity.arn`                                        | `aws.user_identity.principal.arn`                                         |
| `userIdentity.type`                                       | `aws.user_identity.principal.type`                                        |
