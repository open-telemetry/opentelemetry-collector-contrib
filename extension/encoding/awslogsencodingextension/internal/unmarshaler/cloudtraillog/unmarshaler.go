...
func (u *CloudTrailLogUnmarshaler) UnmarshalAWSLogs(reader io.Reader) (plog.Logs, error) {
	streamUnmarshaler, err := u.NewStreamUnmarshaler(reader)
	if err != nil {
...
func (u *CloudTrailLogUnmarshaler) NewStreamUnmarshaler(reader io.Reader, options ...encoding.DecoderOption) (encoding.LogsDecoder, error) {
