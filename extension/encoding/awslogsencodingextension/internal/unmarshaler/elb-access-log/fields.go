...
const (
	...
	AttributeELBRequestProcessingTimeMs  = "aws.elb.request_processing_time_ms"  // int
	AttributeELBResponseProcessingTimeMs = "aws.elb.response_processing_time_ms" // int
	AttributeELBTargetProcessingTimeMs   = "aws.elb.target_processing_time_ms"   // int
