...
func mapMetricToSplunkEvent(res pcommon.Resource, m pmetric.Metric, config *Config) ([]*splunk.Event, error) {
	...
	case pmetric.MetricTypeExponentialHistogram:
		return nil, fmt.Errorf("unsupported type ExponentialHistogram %q", m.Name())
	case pmetric.MetricTypeEmpty:
		return nil, nil
	default:
		return nil, fmt.Errorf("unsupported type %q", m.Name())
	}
}
