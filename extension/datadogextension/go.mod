...
require (
	...
	go.opentelemetry.io/collector/processor v1.60.1-0.20260618174006-415d3dcae73b // indirect
	...
	go.opentelemetry.io/collector/receiver v1.60.1-0.20260618174006-415d3dcae73b // indirect
