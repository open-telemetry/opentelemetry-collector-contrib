...
func TestMissingClientConfigManagerHTTP(t *testing.T) {
	s, err := NewHTTP(componenttest.NewNopTelemetrySettings(), confighttp.HTTPServerConfig{}, nil)
...
func TestStartAndStopHTTP(t *testing.T) {
	// prepare
	srvSettings := confighttp.HTTPServerConfig{
...
func TestEndpointsAreWired(t *testing.T) {
	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			// prepare
			s, err := NewHTTP(componenttest.NewNopTelemetrySettings(), confighttp.HTTPServerConfig{}, &mockCfgMgr{
