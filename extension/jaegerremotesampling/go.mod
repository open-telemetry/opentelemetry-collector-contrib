...
require (
	...
	go.opentelemetry.io/collector/config/configgrpc v0.96.1-0.20240315132530-eb5d2b9fbd12
	go.opentelemetry.io/collector/config/confighttp v0.96.1-0.20240315132530-eb5d2b9fbd12
...
require (
	...
	go.opentelemetry.io/collector/config/configauth v0.96.1-0.20240315132530-eb5d2b9fbd12 // indirect
	go.opentelemetry.io/collector/config/configcompression v0.96.1-0.20240315132530-eb5d2b9fbd12 // indirect
	go.opentelemetry.io/collector/config/configtelemetry v0.96.1-0.20240315132530-eb5d2b9fbd12 // indirect
	go.opentelemetry.io/collector/config/internal v0.96.1-0.20240315132530-eb5d2b9fbd12 // indirect
