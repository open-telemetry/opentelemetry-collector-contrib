...
require (
	...
	go.opentelemetry.io/collector/config/confignet v0.102.2-0.20240606163453-9907ba50df0d
...
require (
	...
	go.opentelemetry.io/collector/pdata v1.9.1-0.20240606163453-9907ba50df0d // indirect
