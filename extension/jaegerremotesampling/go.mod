...
require (
	...
	go.opentelemetry.io/collector/config/confignet v0.95.1-0.20240301231835-2fa6df8ad748
...
require (
	...
	go.opentelemetry.io/collector/config/configauth v0.95.1-0.20240301231835-2fa6df8ad748 // indirect
