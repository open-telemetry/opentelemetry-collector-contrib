...
func TestNewFactory(t *testing.T) {
	...
	ext, _ := createExtension(context.Background(), extensiontest.NewNopSettings(f.Type()), cfg)
	fext, _ := f.Create(context.Background(), extensiontest.NewNopSettings(f.Type()), cfg)
