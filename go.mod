...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/cudareceiver v0.0.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/cudareceiver => ./receiver/cudareceiver
