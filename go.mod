...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.75.0 // indirect
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/mesosreceiver => ./receiver/mesosreceiver
