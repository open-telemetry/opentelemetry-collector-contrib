...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/schemaprocessor v0.0.0-00010101000000-000000000000
...
require (
	...
	go.opentelemetry.io/otel/schema v0.0.2 // indirect
