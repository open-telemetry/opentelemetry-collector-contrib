...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/configschema v0.36.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/cmd/configschema => ./cmd/configschema
