...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/containertest v0.50.0 // indirect
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/scrapertest v0.50.0 // indirect
