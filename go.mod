...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.37.0-rc.3.0.20220624141355-3b08b438490e // indirect
	github.com/DataDog/datadog-agent/pkg/quantile v0.37.0-rc.3.0.20220624141355-3b08b438490e // indirect
