...
package data // import "github.com/open-telemetry/opentelemetry-collector-contrib/processor/intervalprocessor/internal/data"
...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/intervalprocessor/internal/data/expo"
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/intervalprocessor/internal/putil/pslice"
)
...
type Aggregator interface {
	Numbers(state, dp pmetric.NumberDataPoint)
	Histograms(state, dp pmetric.HistogramDataPoint)
	Exponential(state, dp pmetric.ExponentialHistogramDataPoint)
}
...
func (Adder) Numbers(state, dp pmetric.NumberDataPoint) {
	switch dp.ValueType() {
...
func (Adder) Histograms(state, dp pmetric.HistogramDataPoint) {
...
func (Adder) Exponential(state, dp pmetric.ExponentialHistogramDataPoint) {
