	...
	tests := []struct {
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				DeploymentEnvironment:     ResourceAttributeConfig{Enabled: true},
				DeploymentEnvironmentName: ResourceAttributeConfig{Enabled: true},
				DeploymentID:              ResourceAttributeConfig{Enabled: true},
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				DeploymentEnvironment:     ResourceAttributeConfig{Enabled: false},
				DeploymentEnvironmentName: ResourceAttributeConfig{Enabled: false},
				DeploymentID:              ResourceAttributeConfig{Enabled: false},
