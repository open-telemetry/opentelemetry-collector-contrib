	...
	tests := []struct {
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				HostIpv4Addresses: ResourceAttributeConfig{Enabled: true},
				HostIpv6Addresses: ResourceAttributeConfig{Enabled: true},
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				HostIpv4Addresses: ResourceAttributeConfig{Enabled: false},
				HostIpv6Addresses: ResourceAttributeConfig{Enabled: false},
