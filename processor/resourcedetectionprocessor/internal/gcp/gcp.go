...
func (d *detector) Detect(context.Context) (resource pcommon.Resource, schemaURL string, err error) {
	...
	b.attrs.PutString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderGCP)
	b.add(conventions.AttributeCloudAccountID, d.detector.ProjectID)

	switch d.detector.CloudPlatform() {
	case gcp.GKE:
		b.attrs.PutString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformGCPKubernetesEngine)
	...
	case gcp.CloudRun:
		b.attrs.PutString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformGCPCloudRun)
	...
	case gcp.CloudFunctions:
		b.attrs.PutString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformGCPCloudFunctions)
		b.add(conventions.AttributeFaaSName, d.detector.FaaSName)
		b.add(conventions.AttributeFaaSVersion, d.detector.FaaSVersion)
		b.add(conventions.AttributeFaaSID, d.detector.FaaSID)
		b.add(conventions.AttributeCloudRegion, d.detector.FaaSCloudRegion)
	case gcp.AppEngineFlex:
		b.attrs.PutString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformGCPAppEngine)
	...
	case gcp.GCE:
		b.attrs.PutString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformGCPComputeEngine)
...
func (r *resourceBuilder) addZoneAndRegion(detect func() (string, string, error)) {
	...
	r.attrs.PutString(conventions.AttributeCloudAvailabilityZone, zone)
	r.attrs.PutString(conventions.AttributeCloudRegion, region)
}
...
func (r *resourceBuilder) addZoneOrRegion(detect func() (string, gcp.LocationType, error)) {
	...
	switch locType {
	case gcp.Zone:
		r.attrs.PutString(conventions.AttributeCloudAvailabilityZone, v)
	case gcp.Region:
		r.attrs.PutString(conventions.AttributeCloudRegion, v)
	default:
