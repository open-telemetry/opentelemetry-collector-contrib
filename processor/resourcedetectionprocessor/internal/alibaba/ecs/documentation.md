...
| ---- | ----------- | ------ | ------- | ------------------- | --------- |
| cloud.account.id | The cloud account ID (Alibaba Cloud owner account ID) | Any Str | true | [cloud.account.id](https://github.com/open-telemetry/semantic-conventions/blob/v1.40.0/docs/registry/attributes/cloud.md#cloud-account-id) | - |
| cloud.availability_zone | The cloud availability zone (zone ID) | Any Str | true | [cloud.availability_zone](https://github.com/open-telemetry/semantic-conventions/blob/v1.40.0/docs/registry/attributes/cloud.md#cloud-availability-zone) | - |
