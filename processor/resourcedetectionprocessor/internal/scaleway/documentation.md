...
| host.image.name | The host image name | Any Str | true | [host.image.name](https://github.com/open-telemetry/semantic-conventions/blob/v1.40.0/docs/registry/attributes/host.md#host-image-name) | - |
