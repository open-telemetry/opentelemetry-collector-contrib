...
type DetectorConfig struct {
	...
	// K8SConfig contains user-specified configurations for the K8S detector
	K8SConfig k8s.Config `mapstructure:"k8s"`

	// K8SNodeConfig contains user-specified configurations for the K8SNode detector (deprecated: use K8SConfig)
	K8SNodeConfig k8s.Config `mapstructure:"k8snode"`
...
func detectorCreateDefaultConfig() DetectorConfig {
	return DetectorConfig{
		...
		K8SConfig:              k8s.CreateDefaultConfig(),
		K8SNodeConfig:          k8s.CreateDefaultConfig(),
