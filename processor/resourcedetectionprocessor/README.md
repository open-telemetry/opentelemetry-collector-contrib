...
- `imds_check_max_retry`: The maximum number of attempts to make when testing if the IMDS endpoint is available. The default is 1. 
The default value of 1 guarantees that the IMDS availability check is quick and avoids false-positive pod health check errors.
