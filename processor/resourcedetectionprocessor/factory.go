...
func defaultHTTPClientConfig() confighttp.HTTPClientConfig {
...
func (f *factory) getResourceDetectionProcessor(
	...
	provider, err := f.getResourceProvider(params, oCfg.HTTPClientConfig.Timeout, oCfg.Detectors, oCfg.DetectorConfig, oCfg.Attributes)
	if err != nil {
		return nil, err
	}
	...
	return &resourceDetectionProcessor{
		...
		httpClientSettings: oCfg.HTTPClientConfig,
