...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/metadataproviders v0.125.0
	...
	go.opentelemetry.io/collector/semconv v0.125.1-0.20250512225928-0bef08994deb
