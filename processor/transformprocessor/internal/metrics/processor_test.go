...
func Test_ProcessMetrics_MetricContext(t *testing.T) {
	tests := []struct {
		...
		{
			statements: []string{`drop_bucket(".*") where metric.name == "operationB"`},
			want: func(td pmetric.Metrics) {
		...
		{
			statements: []string{`drop_bucket("^[0-9]+$") where metric.name == "operationB"`},
			want: func(td pmetric.Metrics) {
				m := td.ResourceMetrics().At(0).ScopeMetrics().At(0).Metrics().At(1)
				m.Histogram().DataPoints().At(0).SetCount(1)
				m.Histogram().DataPoints().At(0).SetSum(5)
		...
		{
			statements: []string{`drop_bucket("^[0-9]+\\.[0-9]+$") where metric.name == "operationB"`},
			want: func(td pmetric.Metrics) {
				m := td.ResourceMetrics().At(0).ScopeMetrics().At(0).Metrics().At(1)
				m.Histogram().DataPoints().At(0).SetCount(1)
				m.Histogram().DataPoints().At(0).SetSum(5)
		...
		{
			statements: []string{`drop_bucket("^(10|20)$") where metric.name == "operationB"`},
			want: func(td pmetric.Metrics) {
				m := td.ResourceMetrics().At(0).ScopeMetrics().At(0).Metrics().At(1)
				m.Histogram().DataPoints().At(0).SetCount(1)
				m.Histogram().DataPoints().At(0).SetSum(5)
