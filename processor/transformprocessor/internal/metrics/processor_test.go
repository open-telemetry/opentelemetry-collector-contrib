...
func Test_ProcessMetrics_ResourceContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "resource", Statements: []string{tt.statement}}}, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
...
func Test_ProcessMetrics_InferredResourceContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "", Statements: []string{tt.statement}}}, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_ScopeContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "scope", Statements: []string{tt.statement}}}, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_MetricContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statements[0], func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "metric", Statements: tt.statements}}, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_InferredMetricContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statements[0], func(t *testing.T) {
			...
			td := constructMetrics()
			processor, err := NewProcessor(contextStatements, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_DataPointContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statements[0], func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "datapoint", Statements: tt.statements}}, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_MixContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor(tt.contextStatements, ottl.IgnoreError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_ErrorMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor([]common.ContextStatements{{Context: tt.context, Statements: []string{tt.statement}}}, ottl.PropagateError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
...
func Test_ProcessMetrics_StatementsErrorMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			td := constructMetrics()
			processor, err := NewProcessor(tt.statements, tt.errorMode, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
			assert.NoError(t, err)
			_, err = processor.ProcessMetrics(context.Background(), td)
			if tt.wantErrorWith != "" {
				if err == nil {
...
func Test_NewProcessor_ConditionsParse(t *testing.T) {
	...
	for ctx, tests := range contextsTests {
		t.Run(ctx, func(t *testing.T) {
			for _, tt := range tests {
				t.Run(tt.name, func(t *testing.T) {
					_, err := NewProcessor(tt.statements, ottl.PropagateError, componenttest.NewNopTelemetrySettings(), []ottl.Factory[ottlmetric.TransformContext]{})
					if tt.wantErrorWith != "" {
						if err == nil {
							t.Errorf("expected error containing '%s', got: <nil>", tt.wantErrorWith)
						}
