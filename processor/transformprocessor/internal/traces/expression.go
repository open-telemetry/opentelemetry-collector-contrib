...
// statement holds a top level statement for processing trace data. A statement is a combination of a function
...
// literal holds a literal value defined as part of a statement. It does not read from telemetry data.
type literal struct {
	value interface{}
}
