...
var (
	...
	EmptyAdditionalLogFuncs = []ottl.Factory[ottllog.TransformContext]{}
)
...
func Test_ProcessLogs_ResourceContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "resource", Statements: []string{tt.statement}}}, ottl.IgnoreError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
...
func Test_ProcessLogs_InferredResourceContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "", Statements: []string{tt.statement}}}, ottl.IgnoreError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
...
func Test_ProcessLogs_ScopeContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "scope", Statements: []string{tt.statement}}}, ottl.IgnoreError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
...
func Test_ProcessLogs_LogContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.statement, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor([]common.ContextStatements{{Context: "log", Statements: []string{tt.statement}}}, ottl.IgnoreError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
...
func Test_ProcessLogs_ErrorMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(string(tt.context), func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor([]common.ContextStatements{{Context: tt.context, Statements: []string{`set(attributes["test"], ParseJSON(1))`}}}, ottl.PropagateError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
...
func Test_ProcessLogs_StatementsErrorMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor(tt.statements, tt.errorMode, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
			_, err = processor.ProcessLogs(context.Background(), td)
			if tt.wantErrorWith != "" {
				if err == nil {
...
func Test_ProcessLogs_CacheAccess(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			td := constructLogs()
			processor, err := NewProcessor(tt.statements, ottl.IgnoreError, false, componenttest.NewNopTelemetrySettings(), EmptyAdditionalLogFuncs)
			assert.NoError(t, err)
...
func Test_NewProcessor_AdditionalLogFuncs(t *testing.T) {
	type testCase struct {
		name               string
		statements         []common.ContextStatements
		wantErrorWith      string
	...
	tests := []testCase{
		{
			name: "additional log funcs : statement with added log func",
			statements: []common.ContextStatements{
				{
			...
			additionalLogFuncs: []ottl.Factory[ottllog.TransformContext]{NewTestLogFuncFactory[ottllog.TransformContext]()},
		},
		{
			name: "additional log funcs : statement with missing log func",
			statements: []common.ContextStatements{
				{
					Context:    common.ContextID("log"),
					Statements: []string{`set(cache["attr"], TestLogFunc())`},
