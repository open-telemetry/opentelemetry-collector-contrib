...
`function` is a case-sensitive string that represents the function to use for the aggregation and `attributes` is an optional list of attribute keys to aggregate upon.
