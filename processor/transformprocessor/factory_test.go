...
func TestFactoryCreateMetrics_InvalidActions(t *testing.T) {
	...
	ap, err := factory.CreateMetrics(context.Background(), processortest.NewNopSettingsWithType(metadata.Type), cfg, consumertest.NewNop())
	assert.Error(t, err)
	assert.Nil(t, ap)
}
...
func TestFactoryCreateMetrics(t *testing.T) {
	...
	metricsProcessor, err := factory.CreateMetrics(context.Background(), processortest.NewNopSettingsWithType(metadata.Type), cfg, consumertest.NewNop())
...
func TestFactoryCreateSpanProcessor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mp, err := factory.CreateTraces(context.Background(), processortest.NewNopSettingsWithType(metadata.Type), cfg, consumertest.NewNop())
			assert.NotNil(t, mp)
			assert.NoError(t, err)
