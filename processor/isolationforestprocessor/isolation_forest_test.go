...
func TestOnlineIsolationForestCreation(t *testing.T) {
	forest := newOnlineIsolationForest(10, 100, 8, 0.1)
...
func TestOnlineIsolationForestCreationWithAdaptive(t *testing.T) {
	...
	forest := newOnlineIsolationForestWithAdaptive(5, 100, 6, adaptiveConfig, 0.1)
...
func TestOnlineIsolationForestCreationWithDisabledAdaptive(t *testing.T) {
	...
	forest := newOnlineIsolationForestWithAdaptive(3, 80, 4, adaptiveConfig, 0.1)
...
func TestOnlineIsolationForestCreationWithNilAdaptive(t *testing.T) {
	forest := newOnlineIsolationForestWithAdaptive(3, 80, 4, nil, 0.1)
...
func TestBasicAnomalyDetection(t *testing.T) {
	forest := newOnlineIsolationForest(20, 50, 6, 0.1)
...
func TestAdaptiveThreshold(t *testing.T) {
	forest := newOnlineIsolationForest(10, 100, 6, 0.1)
...
func TestForestStatistics(t *testing.T) {
	forest := newOnlineIsolationForest(5, 20, 4, 0.1)
...
func TestAdaptiveForestStatistics(t *testing.T) {
	...
	forest := newOnlineIsolationForestWithAdaptive(3, 50, 4, adaptiveConfig, 0.1)
...
func TestGetCurrentWindowSize(t *testing.T) {
	...
	forest := newOnlineIsolationForest(5, 100, 4, 0.1)
	...
	adaptiveForest := newOnlineIsolationForestWithAdaptive(5, 100, 4, adaptiveConfig, 0.1)
...
func TestAdaptiveWindowResizing(t *testing.T) {
	...
	forest := newOnlineIsolationForestWithAdaptive(2, 30, 4, adaptiveConfig, 0.1)
...
func TestResizeDataWindow(t *testing.T) {
	forest := newOnlineIsolationForest(2, 5, 4, 0.1)
...
func TestOnlineIsolationForestCreation_AutoMaxDepth(t *testing.T) {
	...
	forest := newOnlineIsolationForest(5, 32, 0, 0.1)
...
func TestProcessSample_EmptySample(t *testing.T) {
	forest := newOnlineIsolationForest(5, 10, 4, 0.1)
...
func TestCalculateAnomalyScore_NoTrees(t *testing.T) {
	forest := newOnlineIsolationForest(0, 10, 4, 0.1)
...
func TestCalculateAnomalyScore_NoValidTrees(t *testing.T) {
	forest := newOnlineIsolationForest(3, 10, 4, 0.1)
...
func TestCalculateAnomalyScore_ScoreBounds(t *testing.T) {
	forest := newOnlineIsolationForest(1, 10, 4, 0.1)
...
func TestUpdateForest_SlidingWindow(t *testing.T) {
	forest := newOnlineIsolationForest(2, 3, 4, 0.1) // Small window for testing
...
func TestUpdateAdaptiveThreshold_SufficientSamples(t *testing.T) {
	forest := newOnlineIsolationForest(1, 100, 4, 0.1)
...
func TestUpdateTreesIncremental(t *testing.T) {
	forest := newOnlineIsolationForest(20, 10, 4, 0.1) // Many trees to test subset updates
...
func TestUpdateNodePath_MaxDepthReached(t *testing.T) {
	forest := newOnlineIsolationForest(1, 10, 2, 0.1)
...
func TestSplitNode_InsufficientData(t *testing.T) {
	forest := newOnlineIsolationForest(1, 2, 4, 0.1) // Very small window
...
func TestGetWindowData_WindowNotFull(t *testing.T) {
	forest := newOnlineIsolationForest(1, 5, 4, 0.1)
...
func TestGetWindowData_WindowFull(t *testing.T) {
	forest := newOnlineIsolationForest(1, 3, 4, 0.1)
...
func TestOnlineForestStatistics_EdgeCases(t *testing.T) {
	forest := newOnlineIsolationForest(0, 10, 4, 0.1) // Zero trees
...
func BenchmarkIsolationForestProcessing(b *testing.B) {
	forest := newOnlineIsolationForest(100, 1000, 10, 0.1)
...
func BenchmarkAdaptiveIsolationForestProcessing(b *testing.B) {
	...
	forest := newOnlineIsolationForestWithAdaptive(100, 1000, 10, adaptiveConfig, 0.1)
