...
require (
	...
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/attributes v0.7.1 // indirect
	github.com/DataDog/opentelemetry-mapping-go/pkg/quantile v0.7.1 // indirect
