...
| metadata_cardinality_limit | uint32 | `0` | Maximum number of distinct metadata combinations that can be tracked simultaneously. `0` means no limit. When the limit is reached, new combinations are rejected with a permanent error. |
