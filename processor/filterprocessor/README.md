...
* `Label(name)`
    a function that takes a label name string as an argument and returns a the result as its native datatype (string,int,bool): the value of a label with that
