...
func TestProcessorBadClientProvider(t *testing.T) {
	clientProvider := func(_ *zap.Logger, _ k8sconfig.APIConfig, _ kube.ExtractionRules, _ kube.Filters, _ []kube.Association, _ kube.IgnoredPodNames, _ kube.APIClientsetProvider, _ kube.InformerProvider) (kube.Client, error) {
