...
func newFakeClient(_ *zap.Logger, apiCfg k8sconfig.APIConfig, rules kube.ExtractionRules, filters kube.Filters, associations []kube.Association, exclude kube.ExcludePods, _ kube.APIClientsetProvider, _ kube.InformerProvider) (kube.Client, error) {
