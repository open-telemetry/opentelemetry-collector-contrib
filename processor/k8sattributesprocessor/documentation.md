...
| `processor.k8sattributes.ShareInformerCaches` | alpha | When enabled, processor instances with strictly equivalent defaulted configuration share the same watcher and informer caches across signals and pipelines. | v0.149.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/36234) |
