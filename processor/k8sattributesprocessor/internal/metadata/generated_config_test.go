	...
	tests := []struct {
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				ContainerPorts:                ResourceAttributeConfig{Enabled: true},
				ContainerResourcesRequestsCPU: ResourceAttributeConfig{Enabled: true},
		...
		},
		{
			...
			want: ResourceAttributesConfig{
				...
				ContainerPorts:                ResourceAttributeConfig{Enabled: false},
				ContainerResourcesRequestsCPU: ResourceAttributeConfig{Enabled: false},
