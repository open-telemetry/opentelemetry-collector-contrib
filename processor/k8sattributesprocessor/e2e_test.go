	...
	tcs := []struct {
	...
	}{
		{
			...
			attrs: map[string]*expectedValue{
				...
				"k8s.job.name":                 newExpectedValue(equal, "telemetrygen-"+testID+"-traces-cronjob"),
		...
		},
		{
			...
			attrs: map[string]*expectedValue{
				...
				"k8s.cronjob.uid":              newExpectedValue(exist, ""),
				"k8s.job.name":                 newExpectedValue(equal, "telemetrygen-"+testID+"-metrics-cronjob"),
				"k8s.job.uid":                  newExpectedValue(exist, ""),
				"k8s.annotations.workload":     newExpectedValue(equal, "cronjob"),
		...
		},
		{
			...
			attrs: map[string]*expectedValue{
				...
				"k8s.cronjob.uid":                    newExpectedValue(exist, ""),
				"k8s.job.name":                       newExpectedValue(equal, "telemetrygen-"+testID+"-logs-cronjob"),
				"k8s.job.uid":                        newExpectedValue(exist, ""),
				"k8s.annotations.workload":           newExpectedValue(equal, "cronjob"),
		...
		},
		{
			...
			attrs: map[string]*expectedValue{
				...
				"k8s.cronjob.uid":              newExpectedValue(exist, ""),
				"k8s.job.name":                 newExpectedValue(equal, "telemetrygen-"+testID+"-profiles-cronjob"),
				"k8s.job.uid":                  newExpectedValue(exist, ""),
				"k8s.annotations.workload":     newExpectedValue(equal, "cronjob"),
