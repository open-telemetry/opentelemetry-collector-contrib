...
const (
	...
	typeStr = "join_attributes"
	// The stability level of the exporter.
	stability = component.StabilityLevelBeta
)

// NewFactory creates a factory for the processor processor.
...
// createTracesProcessor creates an instance of processor for processing traces
func createTracesProcessor(
	...
	processor, err := newJoinAttrProcessor(ctx, oCfg)
	if err != nil {
		// TODO: Placeholder for an error metric in the next PR
		return nil, fmt.Errorf("error creating a JoinAttributes processor: %w", err)
	}
