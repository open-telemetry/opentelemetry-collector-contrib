...
func Functions[K any]() map[string]interface{} {
	functions := ottl.NewFunctionMap(
		ottlfuncs.WithIsMatch[K](),
		ottlfuncs.WithDeleteKey[K](),
		ottlfuncs.WithDeleteMatchingKeys[K](),
	)
	functions["route"] = func() (ottl.ExprFunc[K], error) {
