...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.118.0
...
require (
	...
	go.opentelemetry.io/collector/processor/processortest v0.118.1-0.20250124013028-e8807bfe9423
