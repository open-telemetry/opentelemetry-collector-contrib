...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/filter v0.80.0-fn.patch.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl v0.80.0-fn.patch.1
