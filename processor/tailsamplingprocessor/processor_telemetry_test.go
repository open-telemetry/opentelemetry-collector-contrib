...
func TestMetricsWayInModesRecordIngestDecisionTelemetry(t *testing.T) {
	for _, tc := range []struct {
		name     string
		strategy samplingStrategy
	}{
		{name: "full-trace-way-in", strategy: samplingStrategyFullTraceWayIn},
		{name: "root-span-only-way-in", strategy: samplingStrategyRootSpanOnlyWayIn},
	} {
