...
import (
	...
	"github.com/asserts/opentelemetry-collector-contrib/processor/tailsamplingprocessor/internal/idbatcher"
...
func TestConcurrentTraceArrival(t *testing.T) {
	t.Skip("Flaky Test - See https://github.com/asserts/opentelemetry-collector-contrib/issues/10205")
	traceIds, batches := generateIdsAndBatches(128)
...
func TestConcurrentTraceMapSize(t *testing.T) {
	t.Skip("Flaky test, see https://github.com/asserts/opentelemetry-collector-contrib/issues/9126")
