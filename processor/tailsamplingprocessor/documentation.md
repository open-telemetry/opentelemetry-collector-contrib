...
| `processor.tailsamplingprocessor.errormodeignore` | alpha | When enabled, the default error_mode for the ottl_condition policy is 'ignore' instead of 'propagate', so errors evaluating a condition are logged without dropping otherwise valid data. | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48420) |
