...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `processor.tailsamplingprocessor.defaultErrorModeIgnore` | alpha | When enabled, changes the default error_mode of the ottl_condition sampling policy from propagate to ignore. | v0.158.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48420) |
