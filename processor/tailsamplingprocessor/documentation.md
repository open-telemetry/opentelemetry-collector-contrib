...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `processor.tailsamplingprocessor.defaultErrorModeIgnore` | alpha | Changes the default error_mode of the tail sampling processor from propagate to ignore | v0.153.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48420) |
