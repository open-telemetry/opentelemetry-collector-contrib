...
| `processor.tailsamplingprocessor.metricstatcountbytessampled` | alpha | When enabled, a new metric stat_count_bytes_sampled will be available in the tail sampling processor. Differently from stat_count_traces_sampled, this metric will count the number of bytes sampled or not per sampling policy, where the original counts traces. | v0.152.0 | N/A | [Link](TODO) |
