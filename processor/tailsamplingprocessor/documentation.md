...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `processor.tailsamplingprocessor.defaultOTTLErrorModeIgnore` | alpha | Changes the default error_mode of the ottl_condition policy from propagate to ignore | v0.155.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48420) |
