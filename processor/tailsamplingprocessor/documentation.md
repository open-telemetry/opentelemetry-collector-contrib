...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `processor.tailsamplingprocessor.defaultErrorModeIgnore` | alpha | When enabled, the default error_mode for ottl_condition is 'ignore' instead of 'propagate'. | v0.161.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/48420) |
