...
type Config struct {
	...
	// SampleOnRootSpanOnly determines if the sampling decision should be made immediately
	// upon the arrival of the root span, without waiting for the decision wait time.
