...
func TestDBObfuscationUsesDBSystemForAttributes(t *testing.T) {
	...
	sqlSpan.Attributes().PutStr(string(semconv128.DBSystemKey), semconv128.DBSystemMySQL.Value.AsString())
	...
	redisSpan.Attributes().PutStr(string(semconv128.DBSystemKey), semconv128.DBSystemRedis.Value.AsString())
