...
const dbSystemKey = string(semconv128.DBSystemKey)

var (
	mysqlSystem         = semconv128.DBSystemMySQL.Value.AsString()
	redisSystem         = semconv128.DBSystemRedis.Value.AsString()
	memcachedSystem     = semconv128.DBSystemMemcached.Value.AsString()
	mongoSystem         = semconv128.DBSystemMongoDB.Value.AsString()
	openSearchSystem    = semconv128.DBSystemOpensearch.Value.AsString()
	elasticsearchSystem = semconv128.DBSystemElasticsearch.Value.AsString()
)
...
func TestAllDBSystemsSpanName(t *testing.T) {
	testCases := []struct {
		...
		{
			name:     "postgresql",
			dbSystem: semconv128.DBSystemPostgreSQL.Value.AsString(),
		...
		{
			name:     "mariadb",
			dbSystem: semconv128.DBSystemMariaDB.Value.AsString(),
		...
		{
			name:     "sqlite",
			dbSystem: semconv128.DBSystemSqlite.Value.AsString(),
