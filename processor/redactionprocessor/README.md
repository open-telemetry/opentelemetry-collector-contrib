...
This processor deletes span/log/metric attributes that don't match a list of allowed
...
processors:
  redaction:
    ...
    # allowed_keys is a list of span/log/metric attribute keys that are kept on the span/log/metric and
    ...
    # the processor adds to the spans/logs/metrics when it redacts or masks other
...
Only span/log/metric attributes included on the list of allowed keys list are retained.
