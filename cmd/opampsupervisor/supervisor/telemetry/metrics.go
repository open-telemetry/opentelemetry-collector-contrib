...
const (
	CollectorStartupAttemptsMetric = "supervisor.agent.startup_attempts"
	CollectorStartupErrorsMetric   = "supervisor.agent.startup_errors"
	CollectorConfigErrorsMetric    = "supervisor.agent.config_errors"
