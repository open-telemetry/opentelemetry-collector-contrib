...
type AgentPackage struct {
	...
	// Signature is the signature of the package that will be installed. This is used to
...
// AgentSignature represents options for verifying the agent signature from the PackagesAvailable message.
