...
require github.com/open-telemetry/opentelemetry-collector-contrib v0.66.0
...
require (
	...
	go.opentelemetry.io/collector/receiver/otlpreceiver v0.66.1-0.20221202005155-1c54042beb70 // indirect
