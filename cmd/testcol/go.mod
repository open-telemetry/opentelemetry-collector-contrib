...
module github.com/open-telemetry/opentelemetry-collector-contrib/cmd/testcol

go 1.21.1

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatocumulativeprocessor v0.92.0
