...
require (
	...
	go.opentelemetry.io/collector/client v1.16.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/component v0.110.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configauth v0.110.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configcompression v1.16.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configgrpc v0.110.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configopaque v1.16.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configretry v1.16.1-0.20241004063257-d6cd5935eefc
	go.opentelemetry.io/collector/config/configtls v1.16.1-0.20241004063257-d6cd5935eefc
