...
require (
	...
	github.com/open-telemetry/otel-arrow/collector/exporter/otelarrowexporter v0.18.0
	github.com/stretchr/testify v1.9.0
	go.opentelemetry.io/collector v0.96.1-0.20240322165517-15201f1e5967
...
require (
	...
	go.opentelemetry.io/collector/config/confignet v0.96.1-0.20240322165517-15201f1e5967 // indirect
