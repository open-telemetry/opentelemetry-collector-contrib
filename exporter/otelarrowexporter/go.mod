...
require (
	...
	go.opentelemetry.io/collector/config/configauth v1.56.1-0.20260415114935-307e3abdbae9
...
require (
	...
	go.opentelemetry.io/collector/config/confignet v1.56.1-0.20260415114935-307e3abdbae9 // indirect
