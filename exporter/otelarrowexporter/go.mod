...
require (
	...
	go.opentelemetry.io/collector/config/configcompression v1.66.1-0.20260910194618-5602640a11d3
	go.opentelemetry.io/collector/config/configgrpc v1.66.1-0.20260910194618-5602640a11d3
