...
| `exporter.prometheusremotewritexporter.removeTopLevelHTTPSettings` | alpha | When enabled, it rejects top-level HTTP client settings (e.g. endpoint, tls, proxy_url); configure them under the http block instead. | v0.158.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/46209) |
