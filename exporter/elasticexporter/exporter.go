...
func newElasticTracesExporter(
	...
	return exporterhelper.NewTracesExporter(cfg, component.ExporterCreateSettings{Logger: params.Logger}, func(ctx context.Context, traces pdata.Traces) error {
		var errs []error
...
func newElasticMetricsExporter(
	...
	return exporterhelper.NewMetricsExporter(cfg, component.ExporterCreateSettings{Logger: params.Logger}, func(ctx context.Context, input pdata.Metrics) error {
		var errs []error
