...
require (
	...
	go.opentelemetry.io/collector/semconv v0.119.1-0.20250210123122-44b3eeda354c // indirect; indirect	go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.59.0 // indirect
