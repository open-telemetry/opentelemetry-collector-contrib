...
func TestMetricDataToLogService(t *testing.T) {
	...
	doubleHistogramDataPoint.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{1, 2, 3}))
	doubleHistogramDataPoint.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{1, 2}))
