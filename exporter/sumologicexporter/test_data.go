...
func buildExampleHistogramMetric(fillData bool) metricPair {
	...
	if fillData {
		...
		dp.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{0, 12, 7, 5, 8, 13}))
		dp.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{0.1, 0.2, 0.5, 0.8, 1}))
		dp.SetTimestamp(1618124444.169 * 1e9)
		dp.SetSum(45.6)
		dp.SetCount(7)
		...
		dp.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{0, 10, 1, 1, 4, 6}))
		dp.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{0.1, 0.2, 0.5, 0.8, 1}))
		dp.SetTimestamp(1608424699.186 * 1e9)
		dp.SetSum(54.1)
		dp.SetCount(98)
