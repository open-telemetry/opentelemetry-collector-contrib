...
require (
	...
	go.opentelemetry.io/collector/config/confighttp v0.0.0-20230620160303-6059751e64e0
	go.opentelemetry.io/collector/config/configopaque v0.0.0-20230620160303-6059751e64e0
