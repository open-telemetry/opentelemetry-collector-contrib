...
func (c *Config) Validate() error {
	...
	if c.HTTPClientConfig.Headers == nil {
		c.HTTPClientConfig.Headers = make(map[string]configopaque.String)
	}
	...
	if c.Endpoint == "" {
		...
		c.HTTPClientConfig.Headers["Authorization"] = configopaque.String(fmt.Sprintf("Api-Token %s", c.APIToken))
	}
	...
	c.HTTPClientConfig.Headers["Content-Type"] = "text/plain; charset=UTF-8"
	c.HTTPClientConfig.Headers["User-Agent"] = "opentelemetry-collector"
