module github.com/asserts/opentelemetry-collector-contrib/exporter/awsemfexporter
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/opencensus v0.0.0-00010101000000-000000000000
