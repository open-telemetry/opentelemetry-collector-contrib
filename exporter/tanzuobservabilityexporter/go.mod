...
require (
	...
	go.opentelemetry.io/collector/connector v0.0.0-20230615165320-df20186ee21c // indirect
	go.opentelemetry.io/collector/consumer v0.79.1-0.20230620160303-6059751e64e0 // indirect
