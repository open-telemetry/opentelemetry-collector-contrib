...
type TelemetryBuilder struct {
	meter                                    metric.Meter
	OtelcolExporterSplunkhecHeartbeatsFailed metric.Int64Counter
	OtelcolExporterSplunkhecHeartbeatsSent   metric.Int64Counter
...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...telemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	builder.OtelcolExporterSplunkhecHeartbeatsFailed, err = builder.meter.Int64Counter(
		"otelcol_exporter_splunkhec_heartbeats_failed",
		metric.WithDescription("number of heartbeats failed"),
		metric.WithUnit("1"),
	)
	errs = errors.Join(errs, err)
	builder.OtelcolExporterSplunkhecHeartbeatsSent, err = builder.meter.Int64Counter(
