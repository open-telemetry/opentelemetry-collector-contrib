...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/splunk v0.0.0-00010101000000-000000000000
...
>>>>>>> f937be340e ([pkg/translator/splunk] Add new package for translating OTel to Splunk)
