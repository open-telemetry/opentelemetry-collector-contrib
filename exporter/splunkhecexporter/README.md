...
- `sending_queue` (default:true): Specifies [queue batch config](https://github.com/open-telemetry/opentelemetry-collector/blob/main/exporter/exporterhelper/README.md#sending-queue).
