...
func configureExporterBench[T any](
	...
	exp.producer = kafkaclient.NewFranzSyncProducer(client, cfg.IncludeMetadataKeys, cfg.RecordHeaders, cfg.Producer.MaxMessageBytes, componenttest.NewNopHost(), nil)
