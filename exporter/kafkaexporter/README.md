...
- `topic_from_attribute` (default = ""): Specify the resource attribute whose value should be used as the message's topic. This option, when set, will take precedence over the default topic. If topic_from_attribute is not found in the attributes, the value set in topic will be used instead. 
