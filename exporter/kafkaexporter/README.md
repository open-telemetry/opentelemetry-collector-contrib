...
- `sending_queue`: see [Exporter Helper](github.com/open-telemetry/opentelemetry-collector/tree/main/exporter/exporterhelper/README.md) for the full set of available options.
  - `enabled` (default = true)
