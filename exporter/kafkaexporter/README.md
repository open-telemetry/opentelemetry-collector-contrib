...
- `record_headers` (default = {}): Specifies a map of key/value pairs to set as static headers on every outgoing Kafka record. This is applied independently of any partitioning strategy.
