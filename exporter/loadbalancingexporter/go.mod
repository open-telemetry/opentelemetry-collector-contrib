module github.com/asserts/opentelemetry-collector-contrib/exporter/loadbalancingexporter

go 1.19

require (
	github.com/asserts/opentelemetry-collector-contrib/pkg/batchpersignal v0.0.0-00010101000000-000000000000
