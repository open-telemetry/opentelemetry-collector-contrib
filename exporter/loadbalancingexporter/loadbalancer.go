...
func newLoadBalancer(params exporter.CreateSettings, cfg component.Config, factory componentFactory) (*loadBalancer, error) {
	...
	if oCfg.Resolver.K8sSvc != nil {
		...
		res, err = newK8sResolver(clt, k8sLogger, oCfg.Resolver.K8sSvc.Service, oCfg.Resolver.K8sSvc.Ports, oCfg.Resolver.K8sSvc.Interval, oCfg.Resolver.K8sSvc.Timeout)
		if err != nil {
			return nil, err
		}
	}
