module github.com/asserts/opentelemetry-collector-contrib/exporter/awskinesisexporter
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/zipkin v0.0.0-00010101000000-000000000000
