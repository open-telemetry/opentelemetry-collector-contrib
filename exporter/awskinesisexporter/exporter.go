...
// awsKinesisExporter implements an OpenTelemetry trace exporter that exports all spans to AWS Kinesis
type awsKinesisExporter struct {
...
func createExporter(ctx context.Context, c component.Config, log *zap.Logger, opts ...func(opt *options)) (*awsKinesisExporter, error) {
	options := &options{
...
func (e awsKinesisExporter) start(ctx context.Context, _ component.Host) error {
	return e.producer.Ready(ctx)
}

// ConsumeTraces receives a span batch and exports it to AWS Kinesis
func (e awsKinesisExporter) consumeTraces(ctx context.Context, td ptrace.Traces) error {
...
func (e awsKinesisExporter) consumeMetrics(ctx context.Context, md pmetric.Metrics) error {
...
func (e awsKinesisExporter) consumeLogs(ctx context.Context, ld plog.Logs) error {
