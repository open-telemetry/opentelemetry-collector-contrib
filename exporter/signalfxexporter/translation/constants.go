...
const (
	// defaulTranslationRules defines default translation rules to be applied if
	// config.SendCompatibleMetrics set to true and config.TranslationRules not specified explicitly.
	// Keep it in YAML format to be able to easily copy and paste in config if modifications needed.
