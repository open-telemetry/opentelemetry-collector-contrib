...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/golden v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.102.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.102.1
