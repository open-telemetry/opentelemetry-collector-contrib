...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.92.0
	...
	go.opentelemetry.io/collector/config/configretry v0.92.1-0.20240117180253-4371e14440ee
