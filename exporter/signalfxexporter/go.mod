...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/gopsutilenv v0.151.0
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.151.0
