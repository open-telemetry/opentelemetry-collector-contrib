...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/common v0.76.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/coreinternal v0.76.1
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/splunk v0.76.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.76.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.76.1
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.76.1
...
require (
	...
	go.opentelemetry.io/collector/receiver v0.76.1-0.20230426191218-56daa378f504 // indirect
