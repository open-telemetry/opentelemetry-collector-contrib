...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchperresourceattr v0.102.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.102.0
	...
	go.opentelemetry.io/collector/config/configretry v0.102.2-0.20240606163453-9907ba50df0d
	go.opentelemetry.io/collector/config/configtls v0.102.2-0.20240606163453-9907ba50df0d
