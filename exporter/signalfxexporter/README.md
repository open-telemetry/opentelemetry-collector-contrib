...
- `root_path`: Used by the host metadata logic to know where the root filesystem is.
  This is useful when running in a containerized environment where the root
