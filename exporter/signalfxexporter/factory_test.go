...
func TestCreateMetrics(t *testing.T) {
	...
	_, err := createMetricsExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
...
func TestCreateTraces(t *testing.T) {
	...
	_, err := createTracesExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
	assert.NoError(t, err)
}
...
func TestCreateMetrics_CustomConfig(t *testing.T) {
	...
	te, err := createMetricsExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), config)
	assert.NoError(t, err)
	assert.NotNil(t, te)
}
