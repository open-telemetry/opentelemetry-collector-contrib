...
func testMetricsData() pmetric.Metrics {
	...
	dp11.Attributes().PutString("state", "used")
	dp11.Attributes().PutString("host", "host0")
	dp11.Attributes().PutString("kubernetes_node", "node0")
	dp11.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp12.Attributes().PutString("state", "free")
	dp12.Attributes().PutString("host", "host0")
	dp12.Attributes().PutString("kubernetes_node", "node0")
	dp12.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp21.Attributes().PutString("host", "host0")
	dp21.Attributes().PutString("direction", "read")
	dp21.Attributes().PutString("device", "sda1")
	...
	dp22.Attributes().PutString("host", "host0")
	dp22.Attributes().PutString("direction", "read")
	dp22.Attributes().PutString("device", "sda2")
	...
	dp23.Attributes().PutString("host", "host0")
	dp23.Attributes().PutString("direction", "write")
	dp23.Attributes().PutString("device", "sda1")
	...
	dp24.Attributes().PutString("host", "host0")
	dp24.Attributes().PutString("direction", "write")
	dp24.Attributes().PutString("device", "sda2")
	...
	dp31.Attributes().PutString("host", "host0")
	dp31.Attributes().PutString("direction", "write")
	dp31.Attributes().PutString("device", "sda1")
	...
	dp32.Attributes().PutString("host", "host0")
	dp32.Attributes().PutString("direction", "read")
	dp32.Attributes().PutString("device", "sda2")
	...
	dp33.Attributes().PutString("host", "host0")
	dp33.Attributes().PutString("direction", "write")
	dp33.Attributes().PutString("device", "sda1")
	...
	dp34.Attributes().PutString("host", "host0")
	dp34.Attributes().PutString("direction", "write")
	dp34.Attributes().PutString("device", "sda2")
	...
	dp41.Attributes().PutString("host", "host0")
	dp41.Attributes().PutString("direction", "read")
	dp41.Attributes().PutString("device", "sda1")
	...
	dp42.Attributes().PutString("host", "host0")
	dp42.Attributes().PutString("direction", "read")
	dp42.Attributes().PutString("device", "sda2")
	...
	dp43.Attributes().PutString("host", "host0")
	dp43.Attributes().PutString("direction", "write")
	dp43.Attributes().PutString("device", "sda1")
	...
	dp44.Attributes().PutString("host", "host0")
	dp44.Attributes().PutString("direction", "write")
	dp44.Attributes().PutString("device", "sda2")
	...
	dp51.Attributes().PutString("host", "host0")
	dp51.Attributes().PutString("direction", "receive")
	dp51.Attributes().PutString("device", "eth0")
	dp51.Attributes().PutString("kubernetes_node", "node0")
	dp51.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp52.Attributes().PutString("host", "host0")
	dp52.Attributes().PutString("direction", "transmit")
	dp52.Attributes().PutString("device", "eth0")
	dp52.Attributes().PutString("kubernetes_node", "node0")
	dp52.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp61.Attributes().PutString("host", "host0")
	dp61.Attributes().PutString("direction", "receive")
	dp61.Attributes().PutString("device", "eth0")
	dp61.Attributes().PutString("kubernetes_node", "node0")
	dp61.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp62.Attributes().PutString("host", "host0")
	dp62.Attributes().PutString("direction", "receive")
	dp62.Attributes().PutString("device", "eth1")
	dp62.Attributes().PutString("kubernetes_node", "node0")
	dp62.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp71.Attributes().PutString("host", "host0")
	dp71.Attributes().PutString("kubernetes_node", "node0")
	dp71.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp81.Attributes().PutString("host", "host0")
	dp81.Attributes().PutString("kubernetes_node", "node0")
	dp81.Attributes().PutString("kubernetes_cluster", "cluster0")
	...
	dp91.Attributes().PutString("host", "host0")
	dp91.Attributes().PutString("kubernetes_node", "node0")
	dp91.Attributes().PutString("kubernetes_cluster", "cluster0")
