...
require (
	github.com/elastic/go-docappender/v2 v2.8.1-0.20250410075735-3ded4a49a367
...
require (
	...
	go.opentelemetry.io/collector/exporter/otlpexporter v0.122.0 // indirect
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.122.0 // indirect
	...
	go.opentelemetry.io/collector/processor/batchprocessor v0.122.0 // indirect
	go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.122.0 // indirect
