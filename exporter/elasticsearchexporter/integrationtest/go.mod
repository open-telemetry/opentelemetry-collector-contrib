...
require (
	...
	go.opentelemetry.io/collector/exporter/otlpexporter v0.108.0 // indirect
	go.opentelemetry.io/collector/exporter/otlphttpexporter v0.108.0 // indirect
	go.opentelemetry.io/collector/extension/auth v0.108.0 // indirect
	go.opentelemetry.io/collector/extension/zpagesextension v0.108.0 // indirect
	...
	go.opentelemetry.io/collector/processor/batchprocessor v0.108.0 // indirect
	go.opentelemetry.io/collector/processor/memorylimiterprocessor v0.108.0 // indirect
