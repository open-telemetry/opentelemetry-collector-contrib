...
require (
	...
	go.opentelemetry.io/collector/confmap/provider/fileprovider v1.24.1-0.20250130214220-d9b97ffb43cc
...
require (
	...
	go.opentelemetry.io/collector/config/confignet v1.24.1-0.20250130214220-d9b97ffb43cc // indirect
	go.opentelemetry.io/collector/config/configopaque v1.24.1-0.20250130214220-d9b97ffb43cc // indirect
	...
	go.opentelemetry.io/collector/config/configtls v1.24.1-0.20250130214220-d9b97ffb43cc // indirect
