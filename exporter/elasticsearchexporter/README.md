...
- `telemetry`:
  ...
  - `log_failed_docs_source_rate_limit` (default="1s"): Rate limiting of logs emitted by `log_failed_docs_source` config, e.g. "1s" means roughly 1 log line per second.
