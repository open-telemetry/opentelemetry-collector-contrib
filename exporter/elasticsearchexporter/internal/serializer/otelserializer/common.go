...
func writeAttributes(v *json.Visitor, attributes pcommon.Map, stringifyMapValues bool) {
	...
	attributes.Range(func(k string, val pcommon.Value) bool {
		switch k {
		case elasticsearch.DataStreamType, elasticsearch.DataStreamDataset, elasticsearch.DataStreamNamespace, elasticsearch.MappingHintsAttrKey, elasticsearch.DocumentIDAttributeName, elasticsearch.IndexAttributeName:
			return true
		}
