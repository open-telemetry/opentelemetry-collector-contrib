module github.com/asserts/opentelemetry-collector-contrib/exporter/prometheusexporter

go 1.19

require (
	github.com/asserts/opentelemetry-collector-contrib/internal/coreinternal v0.71.0
	github.com/asserts/opentelemetry-collector-contrib/pkg/resourcetotelemetry v0.71.0
