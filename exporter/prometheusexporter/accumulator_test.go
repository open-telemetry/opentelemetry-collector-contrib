...
func TestAccumulateMetrics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			signature := timeseriesSignature(ilm2.Scope(), ilm2.Metrics().At(0), m2Labels, pcommon.NewMap())
...
func TestAccumulateDeltaToCumulative(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			signature := timeseriesSignature(ilm.Scope(), ilm.Metrics().At(0), mLabels, pcommon.NewMap())
			m, ok := a.registeredMetrics.Load(signature)
			require.True(t, ok)
...
func TestAccumulateDeltaToCumulativeHistogram(t *testing.T) {
	...
	t.Run("AccumulateHappyPath", func(t *testing.T) {
		...
		signature := timeseriesSignature(ilm.Scope(), ilm.Metrics().At(0), m2.Attributes(), pcommon.NewMap())
	...
	t.Run("MisalignedTimestamps/Drop", func(t *testing.T) {
		...
		m1 := ilm.Metrics().At(0).Histogram().DataPoints().At(0)
		signature := timeseriesSignature(ilm.Scope(), ilm.Metrics().At(0), m1.Attributes(), pcommon.NewMap())
...
func TestAccumulateDroppedMetrics(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			signature := timeseriesSignature(ilm.Scope(), ilm.Metrics().At(0), pcommon.NewMap(), pcommon.NewMap())
...
func TestTimeseriesSignatureNotMutating(t *testing.T) {
	...
	timeseriesSignature(pcommon.NewInstrumentationScope(), pmetric.NewMetric(), attrs, attrs)
