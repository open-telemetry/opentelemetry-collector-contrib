module github.com/asserts/opentelemetry-collector-contrib/exporter/lokiexporter
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/loki v0.0.0-00010101000000-000000000000
