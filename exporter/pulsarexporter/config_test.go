	...
	tests := []struct {
	...
	}{
		{
			...
			expected: &Config{
				...
				Trace:                   ExporterOption{Topic: "otlp_trace", Encoding: defaultEncoding},
				Log:                     ExporterOption{Topic: "otlp_log", Encoding: defaultEncoding},
				Metric:                  ExporterOption{Topic: "otlp_metric", Encoding: defaultEncoding},
