...
func TestWithTracesMarshalers_err(t *testing.T) {
	...
	r, err := f.CreateTraces(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
...
func TestCreateTraces_err(t *testing.T) {
	...
	r, err := f.createTracesExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
	require.NoError(t, err)
	err = r.Start(context.Background(), componenttest.NewNopHost())
	// no available broker
	require.Error(t, err)
...
func TestCreateMetrics_err(t *testing.T) {
	...
	r, err := mf.createMetricsExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
	require.NoError(t, err)
	err = r.Start(context.Background(), componenttest.NewNopHost())
	require.Error(t, err)
}
...
func TestCreateLogs_err(t *testing.T) {
	...
	r, err := mf.createLogsExporter(context.Background(), exportertest.NewNopSettingsWithType(metadata.Type), cfg)
	require.NoError(t, err)
	err = r.Start(context.Background(), componenttest.NewNopHost())
	require.Error(t, err)
}
