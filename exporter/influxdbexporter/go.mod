...
require (
	github.com/influxdata/influxdb-observability/common v0.0.0-20210428044130-36c13427a6b3
	github.com/influxdata/influxdb-observability/otel2influx v0.0.0-20210428044130-36c13427a6b3
