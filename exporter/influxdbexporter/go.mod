...
require (
	github.com/influxdata/influxdb-observability/common v0.0.0-20210428221606-d5eceaef775d
	github.com/influxdata/influxdb-observability/otel2influx v0.0.0-20210428221606-d5eceaef775d
