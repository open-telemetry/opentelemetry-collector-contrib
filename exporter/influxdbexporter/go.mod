...
replace (
	...
	go.opentelemetry.io/collector/consumer => go.opentelemetry.io/collector/consumer v0.70.0
	go.opentelemetry.io/collector/pdata => go.opentelemetry.io/collector/pdata v1.0.0-rc4
)
