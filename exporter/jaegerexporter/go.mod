...
require (
	...
	go.opentelemetry.io/collector/config/configopaque v0.80.1-0.20230629234129-50c94c941969
...
require (
	...
	go.opentelemetry.io/collector/config/confignet v0.80.1-0.20230629234129-50c94c941969 // indirect
