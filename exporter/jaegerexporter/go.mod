...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/jaeger v0.57.0
...
require (
	...
	go.opentelemetry.io/collector/semconv v0.56.1-0.20220803125008-a585d0de68c4 // indirect
