...
func convertToDatadogTd(td pdata.Traces, cfg *config.Config, blk *Denylister) ([]*pb.TracePayload, []datadog.Metric) {
	// TODO:
	...
	for i := 0; i < resourceSpans.Len(); i++ {
		...
		payload := resourceSpansToDatadogSpans(rs, hostname, cfg, blk)
