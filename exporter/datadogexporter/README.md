...
> This behavior can also be enabled by enabling the `noAPMStatsFeatureGate` feature gate. Example: `otelcol --config=config.yaml --feature-gates=+noAPMStatsFeatureGate`
