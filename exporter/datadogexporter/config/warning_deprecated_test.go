...
func TestDeprecationSendMonotonic(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			warnings: []string{
				"\"metrics::send_monotonic_counter\" has been deprecated in favor of \"metrics::sums::cumulative_monotonic_mode\" and will be removed in v0.50.0.\n\nSee github.com/open-telemetry/opentelemetry-collector-contrib/issues/8489 for details",
			},
		},
		{
