...
const (
	// Deprecated: [v0.109.0] Use `datadogconfig.TypeStr` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.MetricsConfig` instead.
// MetricsConfig defines the metrics exporter specific configuration options
type MetricsConfig = datadogconfig.MetricsConfig

// Deprecated: [v0.109.0] Use `datadogconfig.HistogramMode` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.HistogramConfig` instead.
// HistogramConfig customizes export of OTLP Histograms.
type HistogramConfig = datadogconfig.HistogramConfig

// Deprecated: [v0.109.0] Use `datadogconfig.CumulativeMonotonicMode` instead.
...
const (
	// Deprecated: [v0.109.0] Use `datadogconfig.CumulativeMonotonicSumMode` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.InitialValueMode` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.SumConfig` instead.
// SumConfig customizes export of OTLP Sums.
type SumConfig = datadogconfig.SumConfig

// Deprecated: [v0.109.0] Use `datadogconfig.SummaryMode` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.MetricsExporterConfig` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.TagsConfig` instead.
// TagsConfig defines the tag-related configuration
// It is embedded in the configuration
type TagsConfig = datadogconfig.TagsConfig

// Deprecated: [v0.109.0] Use `datadogconfig.HostnameSource` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.HostMetadataConfig` instead.
...
// Deprecated: [v0.109.0] Use `datadogconfig.Config` instead.
