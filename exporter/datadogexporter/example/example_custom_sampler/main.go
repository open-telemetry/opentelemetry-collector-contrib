// This program sends one span to the Datadog Agent and is meant to illustrate how to connect an existing
// OpenTelemtry-instrumented program. The default connection is HTTP and the gRPC connection is activated
// by means of the -grpc flag.
