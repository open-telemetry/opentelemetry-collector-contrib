...
func newLogsExporter(
	...
	if isMetricExportV2Enabled() {
		apiClient := clientutil.CreateAPIClient(
			...
			cfg.TimeoutSettings,
			cfg.LimitedHTTPClientConfig.TLSSetting.InsecureSkipVerify)
	...
	s := logs.NewSender(cfg.Logs.TCPAddr.Endpoint, params.Logger, cfg.TimeoutSettings, cfg.LimitedHTTPClientConfig.TLSSetting.InsecureSkipVerify, cfg.Logs.DumpPayloads, string(cfg.API.Key))
