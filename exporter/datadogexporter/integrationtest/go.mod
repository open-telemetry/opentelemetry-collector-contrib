...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/serializerexporter v0.74.0-rc.2 // indirect
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.74.0-rc.2 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/util/otel v0.74.0-rc.2 // indirect
