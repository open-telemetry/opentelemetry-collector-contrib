...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/exporter/serializerexporter v0.52.1 // indirect
	...
	github.com/DataDog/datadog-agent/pkg/serializer v0.52.1 // indirect
