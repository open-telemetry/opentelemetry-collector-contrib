module github.com/domleb/opentelemetry-collector-contrib/exporter/awscloudwatchlogsexporter
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/aws/cwlogs v0.122.0
