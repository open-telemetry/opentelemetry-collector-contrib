...
require (
	github.com/coralogix/opentelemetry-cx-protobuf-api/coralogixpb v0.0.0-20211121134705-02b1bedef993
...
replace github.com/coralogix/opentelemetry-cx-protobuf-api/coralogixpb => ./coralogixpb
