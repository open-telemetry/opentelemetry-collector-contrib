...
func TestEnsureExporter(t *testing.T) {
	...
	exporter1 := ensureExporter(exportertest.NewNopSettingsWithType(metadata.Type), eCfg)
	exporter2 := ensureExporter(exportertest.NewNopSettingsWithType(metadata.Type), eCfg)
