...
func TestOriginNotAws(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderGCP)
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginEcs(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	attrs.UpsertString(conventions.AttributeContainerName, "container-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginEcsEc2(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAWS)
	attrs.UpsertString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformAWSECS)
	attrs.UpsertString(conventions.AttributeAWSECSLaunchtype, conventions.AttributeAWSECSLaunchtypeEC2)
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	attrs.UpsertString(conventions.AttributeContainerName, "container-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginEcsFargate(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAWS)
	attrs.UpsertString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformAWSECS)
	attrs.UpsertString(conventions.AttributeAWSECSLaunchtype, conventions.AttributeAWSECSLaunchtypeFargate)
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	attrs.UpsertString(conventions.AttributeContainerName, "container-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginEb(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	attrs.UpsertString(conventions.AttributeContainerName, "container-123")
	attrs.UpsertString(conventions.AttributeServiceInstanceID, "service-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginAppRunner(t *testing.T) {
	...
	attrs := resource.Attributes()
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAWS)
	attrs.UpsertString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformAWSAppRunner)
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestOriginPrefersInfraService(t *testing.T) {
	...
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAWS)
	attrs.UpsertString(conventions.AttributeCloudPlatform, conventions.AttributeCloudPlatformAWSEC2)
	attrs.UpsertString(conventions.AttributeK8SClusterName, "cluster-123")
	attrs.UpsertString(conventions.AttributeHostID, "instance-123")
	attrs.UpsertString(conventions.AttributeContainerName, "container-123")
	attrs.UpsertString(conventions.AttributeServiceInstanceID, "service-123")
	span := constructServerSpan(parentSpanID, spanName, ptrace.StatusCodeError, "OK", attributes)
...
func TestFilteredAttributesMetadata(t *testing.T) {
	...
	attrs.UpsertString("string_value", "value")
	attrs.UpsertInt("int_value", 123)
	attrs.UpsertDouble("float_value", 456.78)
	attrs.UpsertBool("bool_value", false)
	attrs.UpsertEmpty("null_value")

	arrayValue := attrs.UpsertEmptySlice("array_value")
	arrayValue.AppendEmpty().SetIntVal(12)
	arrayValue.AppendEmpty().SetIntVal(34)
	arrayValue.AppendEmpty().SetIntVal(56)

	mapValue := attrs.UpsertEmptyMap("map_value")
	mapValue.UpsertDouble("value1", -987.65)
	mapValue.UpsertBool("value2", true)
...
func constructDefaultResource() pcommon.Resource {
	...
	attrs.UpsertString(conventions.AttributeServiceVersion, "semver:1.1.4")
	...
	attrs.UpsertString(conventions.AttributeK8SNamespaceName, "default")
	attrs.UpsertString(conventions.AttributeK8SDeploymentName, "signup_aggregator")
	attrs.UpsertString(conventions.AttributeK8SPodName, "signup_aggregator-x82ufje83")
	attrs.UpsertString(conventions.AttributeCloudProvider, conventions.AttributeCloudProviderAWS)
	attrs.UpsertString(conventions.AttributeCloudAccountID, "123456789")
	attrs.UpsertString(conventions.AttributeCloudRegion, "us-east-1")
	attrs.UpsertString(conventions.AttributeCloudAvailabilityZone, "us-east-1c")
	attrs.UpsertString(resourceStringKey, "string")
	attrs.UpsertInt(resourceIntKey, 10)
	attrs.UpsertDouble(resourceDoubleKey, 5.0)
	attrs.UpsertBool(resourceBoolKey, true)

	resourceMap := attrs.UpsertEmptyMap(resourceMapKey)
	resourceMap.UpsertInt("key1", 1)
	resourceMap.UpsertString("key2", "value")

	resourceArray := attrs.UpsertEmptySlice(resourceArrayKey)
...
func constructTimedEventsWithReceivedMessageEvent(tm pcommon.Timestamp) ptrace.SpanEventSlice {
	...
	eventAttr.UpsertString("message.type", "RECEIVED")
	eventAttr.UpsertInt(conventions.AttributeMessagingMessageID, 1)
	eventAttr.UpsertInt(conventions.AttributeMessagingMessagePayloadCompressedSizeBytes, 6478)
	eventAttr.UpsertInt(conventions.AttributeMessagingMessagePayloadSizeBytes, 12452)
...
func constructTimedEventsWithSentMessageEvent(tm pcommon.Timestamp) ptrace.SpanEventSlice {
	...
	eventAttr := event.Attributes()
	eventAttr.UpsertString("message.type", "SENT")
	eventAttr.UpsertInt(conventions.AttributeMessagingMessageID, 1)
	eventAttr.UpsertInt(conventions.AttributeMessagingMessagePayloadSizeBytes, 7480)
