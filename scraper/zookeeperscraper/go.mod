module github.com/domleb/opentelemetry-collector-contrib/scraper/zookeeperscraper
...
require (
	...
	go.opentelemetry.io/collector/scraper/scrapertest v0.122.2-0.20250319144947-41a9ea7f7402
