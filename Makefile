...
EXTENSION_MODS_0 := $(shell find ./extension/[a-j]* $(FIND_MOD_ARGS) -exec $(TO_MOD_DIR) )
EXTENSION_MODS_1 := $(shell find ./extension/[k-z]* $(FIND_MOD_ARGS) -exec $(TO_MOD_DIR) )
EXTENSION_MODS := $(EXTENSION_MODS_0) $(EXTENSION_MODS_1)
