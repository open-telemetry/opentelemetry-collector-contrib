...
package gelfreceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/gelfreceiver"
...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza/operator/input/gelfinternal"
...
func createDefaultConfig() *FileLogConfig {
	return &FileLogConfig{
		...
		InputConfig: *gelfinternal.NewConfig(),
	}
}
...
type FileLogConfig struct {
	InputConfig        gelfinternal.Config `mapstructure:",squash"`
