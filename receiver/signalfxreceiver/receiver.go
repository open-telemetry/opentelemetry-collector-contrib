...
func (r *sfxReceiver) preRequest(ctx context.Context, resp http.ResponseWriter, req *http.Request) ([]byte, bool) {
...
func (r *sfxReceiver) postRequest(ctx context.Context, resp http.ResponseWriter, err error) {
	if err != nil {
...
func (r *sfxReceiver) handleDatapointReq(resp http.ResponseWriter, req *http.Request) {
	...
	body, ok := r.preRequest(ctx, resp, req)
	if !ok {
		return
	}
