...
require go.opentelemetry.io/collector/extension/extensionauth v1.32.1-0.20250526141150-249e5d55ad2f // indirect
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/faro v0.126.0
