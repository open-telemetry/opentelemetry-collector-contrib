module github.com/domleb/opentelemetry-collector-contrib/receiver/faroreceiver
...
require go.opentelemetry.io/collector/extension/extensionauth v0.122.2-0.20250319144947-41a9ea7f7402 // indirect
