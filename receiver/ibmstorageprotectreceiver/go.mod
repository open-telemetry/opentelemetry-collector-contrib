module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/ibmstorageprotectreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.102.0 // indirect
