		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SplunkAverageSchedulerExecutionLatency:      MetricConfig{Enabled: true},
					SplunkAvgIndexerRate:                        MetricConfig{Enabled: true},
					...
					SplunkIndexQueueRatio:                       MetricConfig{Enabled: true},
					SplunkIndexerCPUSeconds:                     MetricConfig{Enabled: true},
					SplunkIndexerRawWriteSeconds:                MetricConfig{Enabled: true},
					...
					SplunkIoAverageIops:                         MetricConfig{Enabled: true},
					...
					SplunkSchedulerAverageRunTime:               MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SplunkAverageSchedulerExecutionLatency:      MetricConfig{Enabled: false},
					SplunkAvgIndexerRate:                        MetricConfig{Enabled: false},
					...
					SplunkIndexQueueRatio:                       MetricConfig{Enabled: false},
					SplunkIndexerCPUSeconds:                     MetricConfig{Enabled: false},
					SplunkIndexerRawWriteSeconds:                MetricConfig{Enabled: false},
					...
					SplunkIoAverageIops:                         MetricConfig{Enabled: false},
					...
					SplunkSchedulerAverageRunTime:               MetricConfig{Enabled: false},
