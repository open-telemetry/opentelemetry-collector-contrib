		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SplunkServerSearchesAdhocTotal:              MetricConfig{Enabled: true},
					SplunkServerSearchesCompletedTotal:          MetricConfig{Enabled: true},
					SplunkServerSearchesIncompleteTotal:         MetricConfig{Enabled: true},
					SplunkServerSearchesInvalidTotal:            MetricConfig{Enabled: true},
					SplunkServerSearchesScheduledTotal:          MetricConfig{Enabled: true},
					SplunkServerSearchesTotal:                   MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SplunkServerSearchesAdhocTotal:              MetricConfig{Enabled: false},
					SplunkServerSearchesCompletedTotal:          MetricConfig{Enabled: false},
					SplunkServerSearchesIncompleteTotal:         MetricConfig{Enabled: false},
					SplunkServerSearchesInvalidTotal:            MetricConfig{Enabled: false},
					SplunkServerSearchesScheduledTotal:          MetricConfig{Enabled: false},
					SplunkServerSearchesTotal:                   MetricConfig{Enabled: false},
