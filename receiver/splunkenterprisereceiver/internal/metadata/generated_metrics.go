...
func (m *metricSplunkHealth) init() {
	...
	m.data.SetDescription("Gauge tracking each health color (`green`, `yellow`, and `red`) for each feature of the Splunk server. `1` if that is the current color and `0` if not.")
