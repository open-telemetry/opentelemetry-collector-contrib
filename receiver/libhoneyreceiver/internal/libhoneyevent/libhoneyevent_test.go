...
func TestToPTraceSpan_TimestampPreservation(t *testing.T) {
	...
	t.Run("JSON batch with time inside data preserves timestamps", func(t *testing.T) {
		// Simulates Refinery sending events where the timestamp is inside the data
		// object rather than as a top-level "time" field.
		jsonBatch := `[
			{"samplerate": 1, "data": {"time": "2026-01-30T09:36:48Z", "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "aaaaaaaaaaaaaaaa", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": "2026-01-30T09:36:49Z", "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "bbbbbbbbbbbbbbbb", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 2000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": "2026-01-30T09:36:51Z", "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "cccccccccccccccc", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": "2026-01-30T09:36:48Z", "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "b8d1d0affba3d6c2", "duration_ms": 4000, "service.name": "demo-svc"}}
		]`
	...
	t.Run("JSON batch with numeric epoch time preserves timestamps", func(t *testing.T) {
		// Simulates events where time is a JSON number (epoch seconds).
		jsonBatch := `[
			{"time": 1769767008, "samplerate": 1, "data": {"name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "aaaaaaaaaaaaaaaa", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"time": 1769767009, "samplerate": 1, "data": {"name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "bbbbbbbbbbbbbbbb", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 2000, "service.name": "demo-svc"}},
			{"time": 1769767011, "samplerate": 1, "data": {"name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "cccccccccccccccc", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"time": 1769767008, "samplerate": 1, "data": {"name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "b8d1d0affba3d6c2", "duration_ms": 4000, "service.name": "demo-svc"}}
		]`
		...
		expectedT := time.Unix(1769767008, 0).UTC()
	...
	t.Run("JSON batch with numeric epoch time inside data preserves timestamps", func(t *testing.T) {
		// Simulates events where time is a numeric epoch inside the data object.
		jsonBatch := `[
			{"samplerate": 1, "data": {"time": 1769767008, "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "aaaaaaaaaaaaaaaa", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": 1769767009, "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "bbbbbbbbbbbbbbbb", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 2000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": 1769767011, "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "cccccccccccccccc", "trace.parent_id": "b8d1d0affba3d6c2", "duration_ms": 1000, "service.name": "demo-svc"}},
			{"samplerate": 1, "data": {"time": 1769767008, "name": "test-span", "trace.trace_id": "854b46f148a643a2ed4075f240556292", "trace.span_id": "b8d1d0affba3d6c2", "duration_ms": 4000, "service.name": "demo-svc"}}
		]`
