...
The Wavefront receiver accepts metrics and implements carbonreceiver proto and
transport. It's very similar to Carbon: it is TCP based in which each received text
line represents a single metric data point. They differ on the format of their
