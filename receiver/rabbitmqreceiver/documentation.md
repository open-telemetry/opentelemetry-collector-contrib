...
| Name | Description | Values |
| ---- | ----------- | ------ |
| rabbitmq.node.name | The name of the RabbitMQ node. | Any Str |
| rabbitmq.queue.name | The name of the RabbitMQ queue. | Any Str |
| rabbitmq.vhost.name | The name of the RabbitMQ vHost. | Any Str |
