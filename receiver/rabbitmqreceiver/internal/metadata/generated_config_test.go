...
func TestResourceAttributesConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "all_set",
			want: ResourceAttributesSettings{
				RabbitmqNodeName:  ResourceAttributeSettings{Enabled: true},
				RabbitmqQueueName: ResourceAttributeSettings{Enabled: true},
				RabbitmqVhostName: ResourceAttributeSettings{Enabled: true},
			},
		},
		{
			name: "none_set",
			want: ResourceAttributesSettings{
				RabbitmqNodeName:  ResourceAttributeSettings{Enabled: false},
				RabbitmqQueueName: ResourceAttributeSettings{Enabled: false},
				RabbitmqVhostName: ResourceAttributeSettings{Enabled: false},
			},
		},
	}
