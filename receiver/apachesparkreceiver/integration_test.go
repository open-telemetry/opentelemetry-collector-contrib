...
func TestApacheSparkIntegration(t *testing.T) {
	scraperinttest.NewIntegrationTest(
		...
		scraperinttest.WithCompareOptions(
			...
			pmetrictest.IgnoreMetricAttributeValue("active"),
			pmetrictest.IgnoreMetricAttributeValue("complete"),
			pmetrictest.IgnoreMetricAttributeValue("failed"),
			pmetrictest.IgnoreMetricAttributeValue("pending"),
