		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SparkExecutorTaskMax:                               MetricConfig{Enabled: true},
					SparkExecutorTaskResults:                           MetricConfig{Enabled: true},
					SparkExecutorTime:                                  MetricConfig{Enabled: true},
					SparkJobStageActive:                                MetricConfig{Enabled: true},
					SparkJobStageResults:                               MetricConfig{Enabled: true},
					SparkJobTaskActive:                                 MetricConfig{Enabled: true},
					SparkJobTaskResults:                                MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SparkExecutorTaskMax:                               MetricConfig{Enabled: false},
					SparkExecutorTaskResults:                           MetricConfig{Enabled: false},
					SparkExecutorTime:                                  MetricConfig{Enabled: false},
					SparkJobStageActive:                                MetricConfig{Enabled: false},
					SparkJobStageResults:                               MetricConfig{Enabled: false},
					SparkJobTaskActive:                                 MetricConfig{Enabled: false},
					SparkJobTaskResults:                                MetricConfig{Enabled: false},
