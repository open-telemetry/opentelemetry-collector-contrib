		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SparkComponentExecutorGcOperations:           MetricConfig{Enabled: true},
					SparkComponentExecutorGcTime:                 MetricConfig{Enabled: true},
					SparkComponentExecutorJvmMemory:              MetricConfig{Enabled: true},
					SparkComponentExecutorMemoryPool:             MetricConfig{Enabled: true},
					SparkComponentExecutorMemoryStorage:          MetricConfig{Enabled: true},
					SparkComponentJvmCPUTime:                     MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SparkComponentExecutorGcOperations:           MetricConfig{Enabled: false},
					SparkComponentExecutorGcTime:                 MetricConfig{Enabled: false},
					SparkComponentExecutorJvmMemory:              MetricConfig{Enabled: false},
					SparkComponentExecutorMemoryPool:             MetricConfig{Enabled: false},
					SparkComponentExecutorMemoryStorage:          MetricConfig{Enabled: false},
					SparkComponentJvmCPUTime:                     MetricConfig{Enabled: false},
