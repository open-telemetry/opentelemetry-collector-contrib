...
### spark.driver.block_manager.memory.max

Maximum memory available to the BlockManager.
...
| ---- | ----------- | ------ |
| application_id | The ID of the application for which the metric was recorded. | Any Str |
| gc_severity | The severity of the garbage collection performed for the metric. | Str: ``major``, ``minor`` |
...
### spark.driver.executor_metrics.unified_memory

Amount of unified memory currently used by the driver.
