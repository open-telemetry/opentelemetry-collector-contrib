...
func (mb *MetricsBuilder) Emit() pdata.Metrics {
	...
	mb.metricSystemNetworkConnections.emit(mb.data.ResourceMetrics().At(0).InstrumentationLibraryMetrics().At(0).Metrics())
	mb.metricSystemNetworkDropped.emit(mb.data.ResourceMetrics().At(0).InstrumentationLibraryMetrics().At(0).Metrics())
	mb.metricSystemNetworkErrors.emit(mb.data.ResourceMetrics().At(0).InstrumentationLibraryMetrics().At(0).Metrics())
	mb.metricSystemNetworkIo.emit(mb.data.ResourceMetrics().At(0).InstrumentationLibraryMetrics().At(0).Metrics())
	mb.metricSystemNetworkPackets.emit(mb.data.ResourceMetrics().At(0).InstrumentationLibraryMetrics().At(0).Metrics())
