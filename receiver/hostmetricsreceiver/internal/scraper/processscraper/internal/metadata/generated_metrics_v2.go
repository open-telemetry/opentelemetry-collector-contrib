...
func (m *metricProcessChildCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64) {
...
func (m *metricProcessChildCount) emit(metrics pmetric.MetricSlice) {
...
func (mb *MetricsBuilder) RecordProcessChildCountDataPoint(ts pcommon.Timestamp, val int64) {
