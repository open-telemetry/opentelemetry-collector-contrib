...
type metricNfsClientNetCount struct {
	...
	config        NfsClientNetCountConfig // metric config provided by user.
...
func (m *metricNfsClientNetCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, networkTransportAttributeValue string) {
	...
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsClientNetCountAttributeKeyNetworkTransport) {
...
func newMetricNfsClientNetCount(cfg NfsClientNetCountConfig) metricNfsClientNetCount {
...
type metricNfsClientNetTCPConnectionAccepted struct {
	data     pmetric.Metric                          // data buffer for generated metric.
	config   NfsClientNetTCPConnectionAcceptedConfig // metric config provided by user.
	capacity int                                     // max observed number of data points added to the metric.
}
...
func newMetricNfsClientNetTCPConnectionAccepted(cfg NfsClientNetTCPConnectionAcceptedConfig) metricNfsClientNetTCPConnectionAccepted {
...
type metricNfsClientOperationCount struct {
	data          pmetric.Metric                // data buffer for generated metric.
	config        NfsClientOperationCountConfig // metric config provided by user.
	capacity      int                           // max observed number of data points added to the metric.
	aggDataPoints []int64                       // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsClientOperationCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, oncRPCVersionAttributeValue int64, nfsOperationNameAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsClientOperationCountAttributeKeyOncRPCVersion) {
		dp.Attributes().PutInt("onc_rpc.version", oncRPCVersionAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, NfsClientOperationCountAttributeKeyNfsOperationName) {
...
func newMetricNfsClientOperationCount(cfg NfsClientOperationCountConfig) metricNfsClientOperationCount {
...
type metricNfsClientProcedureCount struct {
	data          pmetric.Metric                // data buffer for generated metric.
	config        NfsClientProcedureCountConfig // metric config provided by user.
	capacity      int                           // max observed number of data points added to the metric.
	aggDataPoints []int64                       // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsClientProcedureCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, oncRPCVersionAttributeValue int64, oncRPCProcedureNameAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsClientProcedureCountAttributeKeyOncRPCVersion) {
		dp.Attributes().PutInt("onc_rpc.version", oncRPCVersionAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, NfsClientProcedureCountAttributeKeyOncRPCProcedureName) {
...
func newMetricNfsClientProcedureCount(cfg NfsClientProcedureCountConfig) metricNfsClientProcedureCount {
...
type metricNfsClientRPCAuthrefreshCount struct {
	data     pmetric.Metric                     // data buffer for generated metric.
	config   NfsClientRPCAuthrefreshCountConfig // metric config provided by user.
	capacity int                                // max observed number of data points added to the metric.
}
...
func newMetricNfsClientRPCAuthrefreshCount(cfg NfsClientRPCAuthrefreshCountConfig) metricNfsClientRPCAuthrefreshCount {
...
type metricNfsClientRPCCount struct {
	data     pmetric.Metric          // data buffer for generated metric.
	config   NfsClientRPCCountConfig // metric config provided by user.
	capacity int                     // max observed number of data points added to the metric.
}
...
func newMetricNfsClientRPCCount(cfg NfsClientRPCCountConfig) metricNfsClientRPCCount {
...
type metricNfsClientRPCRetransmitCount struct {
	data     pmetric.Metric                    // data buffer for generated metric.
	config   NfsClientRPCRetransmitCountConfig // metric config provided by user.
	capacity int                               // max observed number of data points added to the metric.
}
...
func newMetricNfsClientRPCRetransmitCount(cfg NfsClientRPCRetransmitCountConfig) metricNfsClientRPCRetransmitCount {
...
type metricNfsServerFhStaleCount struct {
	data     pmetric.Metric              // data buffer for generated metric.
	config   NfsServerFhStaleCountConfig // metric config provided by user.
	capacity int                         // max observed number of data points added to the metric.
}
...
func newMetricNfsServerFhStaleCount(cfg NfsServerFhStaleCountConfig) metricNfsServerFhStaleCount {
...
type metricNfsServerIo struct {
	data          pmetric.Metric    // data buffer for generated metric.
	config        NfsServerIoConfig // metric config provided by user.
	capacity      int               // max observed number of data points added to the metric.
	aggDataPoints []int64           // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerIo) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, networkIoDirectionAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerIoAttributeKeyNetworkIoDirection) {
...
func newMetricNfsServerIo(cfg NfsServerIoConfig) metricNfsServerIo {
...
type metricNfsServerNetCount struct {
	data          pmetric.Metric          // data buffer for generated metric.
	config        NfsServerNetCountConfig // metric config provided by user.
	capacity      int                     // max observed number of data points added to the metric.
	aggDataPoints []int64                 // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerNetCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, networkTransportAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerNetCountAttributeKeyNetworkTransport) {
		dp.Attributes().PutStr("network.transport", networkTransportAttributeValue)
	}
...
func newMetricNfsServerNetCount(cfg NfsServerNetCountConfig) metricNfsServerNetCount {
...
type metricNfsServerNetTCPConnectionAccepted struct {
	data     pmetric.Metric                          // data buffer for generated metric.
	config   NfsServerNetTCPConnectionAcceptedConfig // metric config provided by user.
	capacity int                                     // max observed number of data points added to the metric.
}
...
func newMetricNfsServerNetTCPConnectionAccepted(cfg NfsServerNetTCPConnectionAcceptedConfig) metricNfsServerNetTCPConnectionAccepted {
...
type metricNfsServerOperationCount struct {
	data          pmetric.Metric                // data buffer for generated metric.
	config        NfsServerOperationCountConfig // metric config provided by user.
	capacity      int                           // max observed number of data points added to the metric.
	aggDataPoints []int64                       // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerOperationCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, oncRPCVersionAttributeValue int64, nfsOperationNameAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerOperationCountAttributeKeyOncRPCVersion) {
		dp.Attributes().PutInt("onc_rpc.version", oncRPCVersionAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, NfsServerOperationCountAttributeKeyNfsOperationName) {
		dp.Attributes().PutStr("nfs.operation.name", nfsOperationNameAttributeValue)
	}
...
func newMetricNfsServerOperationCount(cfg NfsServerOperationCountConfig) metricNfsServerOperationCount {
...
type metricNfsServerProcedureCount struct {
	data          pmetric.Metric                // data buffer for generated metric.
	config        NfsServerProcedureCountConfig // metric config provided by user.
	capacity      int                           // max observed number of data points added to the metric.
	aggDataPoints []int64                       // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerProcedureCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, oncRPCVersionAttributeValue int64, oncRPCProcedureNameAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerProcedureCountAttributeKeyOncRPCVersion) {
		dp.Attributes().PutInt("onc_rpc.version", oncRPCVersionAttributeValue)
	}
	if slices.Contains(m.config.EnabledAttributes, NfsServerProcedureCountAttributeKeyOncRPCProcedureName) {
		dp.Attributes().PutStr("onc_rpc.procedure.name", oncRPCProcedureNameAttributeValue)
	}
...
func newMetricNfsServerProcedureCount(cfg NfsServerProcedureCountConfig) metricNfsServerProcedureCount {
...
type metricNfsServerRepcacheRequests struct {
	data          pmetric.Metric                  // data buffer for generated metric.
	config        NfsServerRepcacheRequestsConfig // metric config provided by user.
	capacity      int                             // max observed number of data points added to the metric.
	aggDataPoints []int64                         // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerRepcacheRequests) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, nfsServerRepcacheStatusAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerRepcacheRequestsAttributeKeyNfsServerRepcacheStatus) {
...
func newMetricNfsServerRepcacheRequests(cfg NfsServerRepcacheRequestsConfig) metricNfsServerRepcacheRequests {
...
type metricNfsServerRPCCount struct {
	data          pmetric.Metric          // data buffer for generated metric.
	config        NfsServerRPCCountConfig // metric config provided by user.
	capacity      int                     // max observed number of data points added to the metric.
	aggDataPoints []int64                 // slice containing number of aggregated datapoints at each index
}
...
func (m *metricNfsServerRPCCount) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, errorTypeAttributeValue string) {
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, NfsServerRPCCountAttributeKeyErrorType) {
...
func newMetricNfsServerRPCCount(cfg NfsServerRPCCountConfig) metricNfsServerRPCCount {
...
type metricNfsServerThreadCount struct {
	data     pmetric.Metric             // data buffer for generated metric.
	config   NfsServerThreadCountConfig // metric config provided by user.
	capacity int                        // max observed number of data points added to the metric.
}
...
func newMetricNfsServerThreadCount(cfg NfsServerThreadCountConfig) metricNfsServerThreadCount {
