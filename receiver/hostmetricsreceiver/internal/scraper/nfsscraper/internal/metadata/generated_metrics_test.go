...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsClientNetTCPConnectionAcceptedDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsClientRPCAuthrefreshCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsClientRPCCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsClientRPCRetransmitCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsServerFhStaleCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsServerNetTCPConnectionAcceptedDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordNfsServerThreadCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				...
				assert.Empty(t, mb.metricNfsClientNetTCPConnectionAccepted.aggDataPoints)
				...
				assert.Empty(t, mb.metricNfsClientRPCAuthrefreshCount.aggDataPoints)
				assert.Empty(t, mb.metricNfsClientRPCCount.aggDataPoints)
				assert.Empty(t, mb.metricNfsClientRPCRetransmitCount.aggDataPoints)
				assert.Empty(t, mb.metricNfsServerFhStaleCount.aggDataPoints)
				assert.Empty(t, mb.metricNfsServerIo.aggDataPoints)
				assert.Empty(t, mb.metricNfsServerNetCount.aggDataPoints)
				assert.Empty(t, mb.metricNfsServerNetTCPConnectionAccepted.aggDataPoints)
				...
				assert.Empty(t, mb.metricNfsServerThreadCount.aggDataPoints)
			}
			...
			for i := 0; i < ms.Len(); i++ {
				...
				case "nfs.client.net.tcp.connection.accepted":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.client.net.tcp.connection.accepted"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.client.rpc.authrefresh.count":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.client.rpc.authrefresh.count"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.client.rpc.count":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.client.rpc.count"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.client.rpc.retransmit.count":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.client.rpc.retransmit.count"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.server.fh.stale.count":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.server.fh.stale.count"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.server.net.tcp.connection.accepted":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.server.net.tcp.connection.accepted"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
				...
				case "nfs.server.thread.count":
					if tt.name != "reaggregate_set" {
						...
						assert.Equal(t, ts, dp.Timestamp())
						assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
						switch aggMap["nfs.server.thread.count"] {
						case "sum":
							assert.Equal(t, int64(4), dp.IntValue())
						case "avg":
							assert.Equal(t, int64(2), dp.IntValue())
