...
func TestScrape(t *testing.T) {
	...
	for _, test := range testCases {
		t.Run(test.name, func(t *testing.T) {
			scraper := newMemoryScraper(context.Background(), scrapertest.NewNopSettingsWithType(metadata.Type), test.config)
...
func TestScrape_MemoryUtilization(t *testing.T) {
	...
	for _, test := range testCases {
		t.Run(test.name, func(t *testing.T) {
			...
			scraper := newMemoryScraper(context.Background(), scrapertest.NewNopSettingsWithType(metadata.Type), &scraperConfig)
			if test.virtualMemoryFunc != nil {
				scraper.virtualMemory = test.virtualMemoryFunc
			}
