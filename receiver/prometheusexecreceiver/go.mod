...
replace go.opentelemetry.io/collector/processor/batchprocessor => go.opentelemetry.io/collector/processor/batchprocessor v0.68.1-0.20230104175729-d8c9f24ecec0
