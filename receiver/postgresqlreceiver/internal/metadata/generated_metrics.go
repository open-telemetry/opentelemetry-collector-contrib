...
// WithPostgresqlQueryUserID sets provided value as "postgresql.query.user.id" attribute for current resource.
func WithPostgresqlQueryUserID(val string) ResourceMetricsOption {
	return func(rm pmetric.ResourceMetrics) {
		rm.Resource().Attributes().UpsertString("postgresql.query.user.id", val)
	}
}
