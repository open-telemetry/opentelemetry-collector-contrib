...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		PostgresqlBgwriterBuffersWrites: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"source"},
		...
		PostgresqlDatabaseLocks: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"relation", "mode", "lock_type"},
		...
		PostgresqlFunctionCalls: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"function"},
		...
		PostgresqlReplicationDataDelay: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"replication_client"},
		...
		PostgresqlWalDelay: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"operation", "replication_client"},
