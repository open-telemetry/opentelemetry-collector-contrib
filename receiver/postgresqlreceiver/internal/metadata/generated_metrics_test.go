...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlBgwriterBuffersWritesDataPoint(ts, 3, AttributeBgBufferSourceBackend)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlBgwriterCheckpointCountDataPoint(ts, 3, AttributeBgCheckpointTypeRequested)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlBgwriterDurationDataPoint(ts, 3, AttributeBgDurationTypeSync)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlBlocksReadDataPoint(ts, 3, AttributeSourceHeapRead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlDatabaseLocksDataPoint(ts, 3, "relation-val", "mode-val", "lock_type-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlFunctionCallsDataPoint(ts, 3, "function-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlOperationsDataPoint(ts, 3, AttributeOperationIns)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlReplicationDataDelayDataPoint(ts, 3, "replication_client-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlRowsDataPoint(ts, 3, AttributeStateDead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlWalDelayDataPoint(ts, 3, AttributeWalOperationLagFlush, "replication_client-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordPostgresqlWalLagDataPoint(ts, 3, AttributeWalOperationLagFlush, "replication_client-val")
			}
