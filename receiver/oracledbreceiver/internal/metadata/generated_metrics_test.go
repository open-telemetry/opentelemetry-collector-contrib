...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordOracledbSessionsUsageDataPoint(ts, "3", "session_type-val", "session_status-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordOracledbTablespaceSizeLimitDataPoint(ts, 3, "tablespace_name-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordOracledbTablespaceSizeUsageDataPoint(ts, 3, "tablespace_name-val")
			}
