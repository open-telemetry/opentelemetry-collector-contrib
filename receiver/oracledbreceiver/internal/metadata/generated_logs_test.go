		...
		t.Run(tt.name, func(t *testing.T) {
			...
			for i := 0; i < lrs.Len(); i++ {
				...
				case "db.server.query_sample":
					...
					attrVal, ok = lr.Attributes().Get("oracledb.blocking.blocker.status")
					assert.True(t, ok)
					assert.Equal(t, "oracledb.blocking.blocker.status-val", attrVal.Str())
