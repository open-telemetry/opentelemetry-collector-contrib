...
func (ms *OracledbSessionsUsageMetricConfig) Validate() error {
	for _, val := range ms.EnabledAttributes {
		switch val {
		case OracledbSessionsUsageMetricAttributeKeyOracleDbPdb, OracledbSessionsUsageMetricAttributeKeySessionStatus, OracledbSessionsUsageMetricAttributeKeySessionType:
		default:
			return fmt.Errorf("metric oracledb.sessions.usage doesn't have an attribute %v, valid attributes: [oracle.db.pdb, session_status, session_type]", val)
		}
	}
...
func (ms *OracledbTablespaceSizeLimitMetricConfig) Validate() error {
	for _, val := range ms.EnabledAttributes {
		switch val {
		case OracledbTablespaceSizeLimitMetricAttributeKeyOracleDbPdb, OracledbTablespaceSizeLimitMetricAttributeKeyTablespaceName:
		default:
			return fmt.Errorf("metric oracledb.tablespace_size.limit doesn't have an attribute %v, valid attributes: [oracle.db.pdb, tablespace_name]", val)
		}
	}
...
func (ms *OracledbTablespaceSizeUsageMetricConfig) Validate() error {
	for _, val := range ms.EnabledAttributes {
		switch val {
		case OracledbTablespaceSizeUsageMetricAttributeKeyOracleDbPdb, OracledbTablespaceSizeUsageMetricAttributeKeyTablespaceName:
		default:
			return fmt.Errorf("metric oracledb.tablespace_size.usage doesn't have an attribute %v, valid attributes: [oracle.db.pdb, tablespace_name]", val)
		}
	}
