...
func TestOracledbLockTimeMetricsConfig_Validate(t *testing.T) {
	...
	require.ErrorContains(t, cfg.Validate(), "metric oracledb.lock.time doesn't have an attribute invalid, valid attributes: [oracledb.lock.type]")
