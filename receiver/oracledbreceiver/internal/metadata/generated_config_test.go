	...
	tests := []struct {
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					DbSystemEdition:      DbSystemEditionResourceAttributeConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				...
				ResourceAttributes: ResourceAttributesConfig{
					DbSystemEdition:      DbSystemEditionResourceAttributeConfig{Enabled: false},
...
func TestResourceAttributesConfig(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			diff := cmp.Diff(tt.want, cfg, cmpopts.IgnoreUnexported(DbSystemEditionResourceAttributeConfig{}, HostNameResourceAttributeConfig{}, OracleDbHostingTypeResourceAttributeConfig{}, OracleDbOpenModeResourceAttributeConfig{}, OracleDbRoleResourceAttributeConfig{}, OracleDbVersionResourceAttributeConfig{}, OracledbInstanceNameResourceAttributeConfig{}, ServerAddressResourceAttributeConfig{}, ServerPortResourceAttributeConfig{}, ServiceInstanceIDResourceAttributeConfig{}, ServiceNameResourceAttributeConfig{}, ServiceNamespaceResourceAttributeConfig{}))
			require.Emptyf(t, diff, "Config mismatch (-expected +actual):\n%s", diff)
		})
	}
}
...
func TestResourceAttributesOverrideConfig(t *testing.T) {
	...
	assert.NotNil(t, cfg.DbSystemEdition.OverrideValue, "override_value should be set for db.system.edition")
