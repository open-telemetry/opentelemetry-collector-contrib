			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					OracledbSessionsUsage: OracledbSessionsUsageMetricConfig{
						...
						EnabledAttributes:   []OracledbSessionsUsageMetricAttributeKey{OracledbSessionsUsageMetricAttributeKeyOracleDbPdb, OracledbSessionsUsageMetricAttributeKeySessionStatus, OracledbSessionsUsageMetricAttributeKeySessionType},
					},
					...
					OracledbTablespaceSizeLimit: OracledbTablespaceSizeLimitMetricConfig{
						Enabled:             true,
						AggregationStrategy: AggregationStrategyAvg,
						EnabledAttributes:   []OracledbTablespaceSizeLimitMetricAttributeKey{OracledbTablespaceSizeLimitMetricAttributeKeyOracleDbPdb, OracledbTablespaceSizeLimitMetricAttributeKeyTablespaceName},
					},
					OracledbTablespaceSizeUsage: OracledbTablespaceSizeUsageMetricConfig{
						Enabled:             true,
						AggregationStrategy: AggregationStrategyAvg,
						EnabledAttributes:   []OracledbTablespaceSizeUsageMetricAttributeKey{OracledbTablespaceSizeUsageMetricAttributeKeyOracleDbPdb, OracledbTablespaceSizeUsageMetricAttributeKeyTablespaceName},
					},
