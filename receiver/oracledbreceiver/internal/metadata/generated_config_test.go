		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					OracledbOsMemoryLimit: OracledbOsMemoryLimitMetricConfig{
						Enabled: true,
					},
