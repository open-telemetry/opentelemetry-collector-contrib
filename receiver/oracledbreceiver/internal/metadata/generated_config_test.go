		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					OracledbSystemCPUPhysicalCount: OracledbSystemCPUPhysicalCountMetricConfig{
						Enabled: true,
					},
