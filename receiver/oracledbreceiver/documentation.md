...
| db.servicename | Oracle service name. The service the session connected through (V$SESSION.SERVICE_NAME). | Any Str | - |
...
| db.namespace | The database name. | Any Str | - |
| db.servicename | Oracle service name. The service under which the cursor was first parsed (V$SQL.SERVICE). | Any Str | - |
| db.query.text | The text of the database query being executed. | Any Str | - |
