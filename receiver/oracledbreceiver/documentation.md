...
| ---- | ----------- | ------ | ----------------- | ------------------- |
| oracle.db.pdb | The name of the Pluggable Database (PDB) in a multitenant CDB. Empty for non-CDB instances or when connected directly to a PDB. | Any Str | Recommended | - |
