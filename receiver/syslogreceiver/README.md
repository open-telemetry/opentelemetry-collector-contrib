...
| `protocol`                          | required     | The protocol to parse the syslog messages as. Options are `rfc3164`, `rfc5424`, and `none`. Use `none` for raw syslog data that doesn't conform to RFC3164 or RFC5424 formats.                                                                                                                                                                                                                |
