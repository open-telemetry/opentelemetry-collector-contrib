module github.com/asserts/opentelemetry-collector-contrib/receiver/prometheusreceiver
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/prometheus v0.71.0
