	...
	tests := []buildTestData{
		{
			...
			wants: func() []*pmetric.MetricSlice {
				...
				pt0.SetCount(10)
				pt0.SetSum(99)
				pt0.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{10, 20}))
				pt0.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{1, 1, 8}))
				pt0.SetTimestamp(startTsNanos)
				pt0.SetStartTimestamp(startTsNanos)
				pt0.Attributes().InsertString("foo", "bar")
		...
		},
		{
			...
			wants: func() []*pmetric.MetricSlice {
				...
				pt1.SetCount(3)
				pt1.SetSum(50)
				pt1.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{10, 20}))
				pt1.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{1, 1, 1}))
				pt1.SetTimestamp(startTsNanos)
				pt1.SetStartTimestamp(startTsNanos)
		...
		},
		{
			...
			wants: func() []*pmetric.MetricSlice {
				...
				pt2.SetCount(3)
				pt2.SetSum(50)
				pt2.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{10, 20}))
				pt2.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{1, 1, 1}))
				pt2.SetTimestamp(startTsNanos)
				pt2.SetStartTimestamp(startTsNanos)
		...
		},
		{
			...
			wants: func() []*pmetric.MetricSlice {
				...
				pt0.SetCount(3)
				pt0.SetSum(100)
				pt0.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{3}))
				pt0.SetTimestamp(startTsNanos)
				pt0.SetStartTimestamp(startTsNanos)
		...
		},
		{
			...
			wants: func() []*pmetric.MetricSlice {
				...
				pt0.SetSum(0)
				pt0.SetExplicitBounds(pcommon.NewImmutableFloat64SliceFromValue(&[]float64{10, 20}))
				pt0.SetBucketCounts(pcommon.NewImmutableUInt64SliceFromValue(&[]uint64{1, 1, 1}))
				pt0.SetTimestamp(startTsNanos)
				pt0.SetStartTimestamp(startTsNanos)
				pt0.Attributes().InsertString("foo", "bar")
