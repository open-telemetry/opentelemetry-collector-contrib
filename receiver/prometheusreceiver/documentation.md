...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `receiver.prometheusreceiver.EnableAppenderV2` | alpha | When enabled, uses the new Prometheus AppenderV2 interface for translating Prometheus metrics into OTLP. This new interface is expected to be more efficient but is still experimental. | v0.145.0 | N/A | [Link](https://github.com/prometheus/prometheus/pull/17872) |
