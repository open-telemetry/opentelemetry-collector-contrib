...
func setMetricsTimestamp() {
	onlyOnce.Do(func() {
		honorTimestampsPage1 = fmt.Sprintf(
			honorTimestampsPage1,
		...
		honorTimestampsPage2 = fmt.Sprintf(
			honorTimestampsPage2,
		...
		honorTimestampsPage3 = fmt.Sprintf(
			honorTimestampsPage3,
