...
| **vcenter.cluster.host.count** | The number of hosts in the datacenter | {hosts} | Sum(Int) | <ul> <li>host_effective</li> </ul> |
...
| **vcenter.cluster.vm.count** | the number of virtual machines in the datacenter | {virtual_machines} | Sum(Int) | <ul> </ul> |
