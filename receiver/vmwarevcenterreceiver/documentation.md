...
| **vcenter.host.disk.latency.avg** | The latency of operations to the host system's disk | ms | Sum(Int) | <ul> <li>latency_type</li> </ul> |
...
| **vcenter.host.network.packets** | The number of packets sent over an interval | {packets/sec} | Sum(Int) | <ul> </ul> |
| **vcenter.host.network.throughput** | The amount of data that was sent or recieved over the network by the host | {By/s} | Sum(Int) | <ul> <li>throughput_direction</li> </ul> |
...
| **vcenter.vm.disk.latency** | The latency of operations to the virtual machine's disk | µs | Sum(Int) | <ul> <li>latency_type</li> </ul> |
