...
| `supportsPerfSchemaLogStatus()` | MySQL 8.0.11+ | InnoDB redo-log LSN and checkpoint-age metrics are not emitted |
...
| Product | Series | Exact Version | Platform | `supportsQuerySampleText` | `supportsProcesslist` | `supportsReplicaStatus` | `supportsPerfSchemaLogStatus` | Timer Wait Tiers | Date |
|---|---|---|---|---|---|---|---|---|---|
