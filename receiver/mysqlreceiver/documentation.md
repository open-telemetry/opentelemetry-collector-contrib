...
The total number of rows examined by the query.
...
The total CPU time for the query.

| Unit | Metric Type | Value Type | Aggregation Temporality | Monotonic |
| ---- | ----------- | ---------- | ----------------------- | --------- |
| seconds | Sum | Double | Cumulative | false |
...
The total lock time for the query.
...
The total duration of the query.
