		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					MysqlQueryCalls:              MetricConfig{Enabled: true},
					MysqlQueryClientCount:        MetricConfig{Enabled: true},
					MysqlQueryCount:              MetricConfig{Enabled: true},
					MysqlQueryRowsReturned:       MetricConfig{Enabled: true},
					MysqlQueryRowsTotal:          MetricConfig{Enabled: true},
					MysqlQuerySlowCount:          MetricConfig{Enabled: true},
					MysqlQueryTimeCPU:            MetricConfig{Enabled: true},
					MysqlQueryTimeLock:           MetricConfig{Enabled: true},
					MysqlQueryTimeTotal:          MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					MysqlQueryCalls:              MetricConfig{Enabled: false},
					MysqlQueryClientCount:        MetricConfig{Enabled: false},
					MysqlQueryCount:              MetricConfig{Enabled: false},
					MysqlQueryRowsReturned:       MetricConfig{Enabled: false},
					MysqlQueryRowsTotal:          MetricConfig{Enabled: false},
					MysqlQuerySlowCount:          MetricConfig{Enabled: false},
					MysqlQueryTimeCPU:            MetricConfig{Enabled: false},
					MysqlQueryTimeLock:           MetricConfig{Enabled: false},
					MysqlQueryTimeTotal:          MetricConfig{Enabled: false},
