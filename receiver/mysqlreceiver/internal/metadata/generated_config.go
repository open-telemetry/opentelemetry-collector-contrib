...
type MetricsConfig struct {
	...
	MysqlReplicaIsIoThreadRunning  MetricConfig `mapstructure:"mysql.replica.is_io_thread_running"`
	MysqlReplicaIsSQLThreadRunning MetricConfig `mapstructure:"mysql.replica.is_sql_thread_running"`
...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		MysqlReplicaIsIoThreadRunning: MetricConfig{
			Enabled: false,
		},
		MysqlReplicaIsSQLThreadRunning: MetricConfig{
			Enabled: false,
		},
