...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		MysqlBufferPoolPages: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"kind"},
		...
		MysqlCommands: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"command"},
		...
		MysqlConnectionErrors: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"error"},
		...
		MysqlIndexIoWaitCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"operation", "table", "schema", "index"},
		...
		MysqlStatementEventCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"schema", "digest", "digest_text", "kind"},
		...
		MysqlStatementEventWaitTime: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"schema", "digest", "digest_text"},
		...
		MysqlTableAverageRowLength: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"table", "schema"},
		...
		MysqlTableIoWaitCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"operation", "table", "schema"},
		...
		MysqlTableLockWaitReadCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"schema", "table", "kind"},
		...
		MysqlTableSize: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"table", "schema", "kind"},
		...
		MysqlTmpResources: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"resource"},
