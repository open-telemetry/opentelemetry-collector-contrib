...
func TestScraper(t *testing.T) {
	...
	scraper := newNginxScraper(receivertest.NewNopSettingsWithType(metadata.Type), cfg)
...
func TestScraperError(t *testing.T) {
	...
	t.Run("404", func(t *testing.T) {
		sc := newNginxScraper(receivertest.NewNopSettingsWithType(metadata.Type), &Config{
