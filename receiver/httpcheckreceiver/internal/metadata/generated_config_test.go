		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					HttpcheckRequestDuration:       MetricConfig{Enabled: true},
					HttpcheckResponseDuration:      MetricConfig{Enabled: true},
					HttpcheckStatus:                MetricConfig{Enabled: true},
					HttpcheckTCPConnectionDuration: MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					HttpcheckRequestDuration:       MetricConfig{Enabled: false},
					HttpcheckResponseDuration:      MetricConfig{Enabled: false},
					HttpcheckStatus:                MetricConfig{Enabled: false},
					HttpcheckTCPConnectionDuration: MetricConfig{Enabled: false},
