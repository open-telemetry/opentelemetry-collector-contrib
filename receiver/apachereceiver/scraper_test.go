...
func TestScraper(t *testing.T) {
	...
	scraper := newApacheScraper(receivertest.NewNopSettingsWithType(metadata.Type), cfg, serverName, port)
...
func TestScraperFailedStart(t *testing.T) {
	...
	sc := newApacheScraper(receivertest.NewNopSettingsWithType(metadata.Type), &Config{
