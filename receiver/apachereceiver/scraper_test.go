...
func TestParseScoreboard(t *testing.T) {
	...
	t.Run("test freq count", func(t *testing.T) {
		...
		require.EqualValues(t, int64(150), results[metadata.AttributeOpen])
		require.EqualValues(t, int64(217), results[metadata.AttributeWaiting])
		require.EqualValues(t, int64(1), results[metadata.AttributeStarting])
		require.EqualValues(t, int64(4), results[metadata.AttributeReading])
		require.EqualValues(t, int64(12), results[metadata.AttributeSending])
		require.EqualValues(t, int64(2), results[metadata.AttributeKeepalive])
		require.EqualValues(t, int64(2), results[metadata.AttributeDnslookup])
		require.EqualValues(t, int64(4), results[metadata.AttributeClosing])
		require.EqualValues(t, int64(1), results[metadata.AttributeLogging])
		require.EqualValues(t, int64(3), results[metadata.AttributeFinishing])
		require.EqualValues(t, int64(4), results[metadata.AttributeIdleCleanup])
	})
	...
	t.Run("test unknown", func(t *testing.T) {
		...
		require.EqualValues(t, int64(0), results[metadata.AttributeOpen])
		require.EqualValues(t, int64(0), results[metadata.AttributeWaiting])
		require.EqualValues(t, int64(0), results[metadata.AttributeStarting])
		require.EqualValues(t, int64(0), results[metadata.AttributeReading])
		require.EqualValues(t, int64(0), results[metadata.AttributeSending])
		require.EqualValues(t, int64(0), results[metadata.AttributeKeepalive])
		require.EqualValues(t, int64(0), results[metadata.AttributeDnslookup])
		require.EqualValues(t, int64(0), results[metadata.AttributeClosing])
		require.EqualValues(t, int64(0), results[metadata.AttributeLogging])
		require.EqualValues(t, int64(0), results[metadata.AttributeFinishing])
		require.EqualValues(t, int64(0), results[metadata.AttributeIdleCleanup])
		require.EqualValues(t, int64(26), results[metadata.AttributeUnknown])
	})
