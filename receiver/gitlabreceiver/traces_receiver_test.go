...
const (
	...
	// Pipeline where one stage ("deploy") has a job that was queued but never
	// started — empty started_at/finished_at. The build stage ran to completion.
	pipelineWebhookEventWithUnstartedStage = `{"object_attributes":{"id":4,"status":"failed","created_at":"2022-01-04 09:00:00 UTC","finished_at":"2022-01-04 09:10:00 UTC","name":"Early Failure Pipeline","source":"push","ref":"main","tag":false,"sha":"feedface1234"},"project":{"id":126,"name":"early-fail","path_with_namespace":"test/early-fail","namespace":"test","web_url":"https://gitlab.example.com/test/early-fail","visibility":"private","default_branch":"main"},"builds":[{"id":20,"stage":"build","name":"build-job","status":"failed","created_at":"2022-01-04 09:00:00 UTC","started_at":"2022-01-04 09:01:00 UTC","finished_at":"2022-01-04 09:05:00 UTC","runner":{"id":100,"description":"shared-runner","active":true,"is_shared":true,"runner_type":"instance_type","tags":["docker"]},"queued_duration":10.0,"allow_failure":false},{"id":21,"stage":"deploy","name":"deploy-job","status":"created","created_at":"2022-01-04 09:00:00 UTC","started_at":"","finished_at":"","runner":{"id":0,"description":"","active":false,"is_shared":false,"runner_type":"","tags":[]},"queued_duration":0,"allow_failure":false}],"commit":{"id":"feedface1234","message":"Trigger failing pipeline","timestamp":"2022-01-04T08:50:00Z","author":{"name":"Test User","email":"test@example.com"}},"user":{"id":42,"username":"tuser","name":"Test User"}}`
