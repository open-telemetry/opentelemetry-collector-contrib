...
* `include_user_attributes`: (default = `false`) - When enabled, includes user information such as commit author details (name, email), commit messages, and pipeline actor information (username, name) in the trace attributes. **Note**: This data may contain sensetive information.
