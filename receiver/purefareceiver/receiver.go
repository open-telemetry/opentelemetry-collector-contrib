...
func (r *purefaReceiver) Start(ctx context.Context, compHost component.Host) error {
	...
	arrScraper := internal.NewScraper(ctx, internal.ScraperTypeArray, r.cfg.Endpoint, r.cfg.TLSSetting.InsecureSkipVerify, r.cfg.Array, r.cfg.Settings.ReloadIntervals.Array, commomLabel)
	...
	hostScraper := internal.NewScraper(ctx, internal.ScraperTypeHosts, r.cfg.Endpoint, r.cfg.TLSSetting.InsecureSkipVerify, r.cfg.Hosts, r.cfg.Settings.ReloadIntervals.Hosts, labelSet)
	...
	directoriesScraper := internal.NewScraper(ctx, internal.ScraperTypeDirectories, r.cfg.Endpoint, r.cfg.TLSSetting.InsecureSkipVerify, r.cfg.Directories, r.cfg.Settings.ReloadIntervals.Directories, commomLabel)
	...
	podsScraper := internal.NewScraper(ctx, internal.ScraperTypePods, r.cfg.Endpoint, r.cfg.TLSSetting.InsecureSkipVerify, r.cfg.Pods, r.cfg.Settings.ReloadIntervals.Pods, commomLabel)
	...
	volumesScraper := internal.NewScraper(ctx, internal.ScraperTypeVolumes, r.cfg.Endpoint, r.cfg.TLSSetting.InsecureSkipVerify, r.cfg.Volumes, r.cfg.Settings.ReloadIntervals.Volumes, labelSet)
