...
func (r *purefaReceiver) Start(ctx context.Context, compHost component.Host) error {
	...
	arrScraper := internal.NewScraper(ctx, internal.ScraperTypeArray, r.cfg.ClientConfig.Endpoint, r.cfg.Namespace, r.cfg.ClientConfig.TLS, r.cfg.Array, r.cfg.Settings.ReloadIntervals.Array, commonLabel)
	...
	hostScraper := internal.NewScraper(ctx, internal.ScraperTypeHosts, r.cfg.ClientConfig.Endpoint, r.cfg.Namespace, r.cfg.ClientConfig.TLS, r.cfg.Hosts, r.cfg.Settings.ReloadIntervals.Hosts, labelSet)
	...
	directoriesScraper := internal.NewScraper(ctx, internal.ScraperTypeDirectories, r.cfg.ClientConfig.Endpoint, r.cfg.Namespace, r.cfg.ClientConfig.TLS, r.cfg.Directories, r.cfg.Settings.ReloadIntervals.Directories, commonLabel)
	...
	podsScraper := internal.NewScraper(ctx, internal.ScraperTypePods, r.cfg.ClientConfig.Endpoint, r.cfg.Namespace, r.cfg.ClientConfig.TLS, r.cfg.Pods, r.cfg.Settings.ReloadIntervals.Pods, commonLabel)
	...
	volumesScraper := internal.NewScraper(ctx, internal.ScraperTypeVolumes, r.cfg.ClientConfig.Endpoint, r.cfg.Namespace, r.cfg.ClientConfig.TLS, r.cfg.Volumes, r.cfg.Settings.ReloadIntervals.Volumes, labelSet)
