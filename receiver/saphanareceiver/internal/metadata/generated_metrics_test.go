...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSaphanaLicenseExpirationTimeDataPoint(ts, "3", "system-val-2", "product-val-2")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSaphanaLicenseLimitDataPoint(ts, "3", "system-val-2", "product-val-2")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSaphanaLicensePeakDataPoint(ts, "3", "system-val-2", "product-val-2")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSaphanaServiceMemoryUsedDataPoint(ts, "3", "service-val-2", AttributeServiceMemoryUsedTypePhysical)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSaphanaUptimeDataPoint(ts, "3", "system-val-2", "database-val-2")
			}
