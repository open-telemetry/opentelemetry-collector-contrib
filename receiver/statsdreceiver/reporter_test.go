...
func TestReporterObservability(t *testing.T) {
	...
	const receiverName = "fake_statsd_receiver"
	...
	obsreporttest.CheckReceiverMetrics(t, receiverName, "tcp", 17, 0)
	...
	obsreporttest.CheckReceiverMetrics(t, receiverName, "tcp", 17, 10)
}
