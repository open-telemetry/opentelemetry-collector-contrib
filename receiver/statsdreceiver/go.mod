...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed v0.41.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed/mockdatareceivers/mockawsxrayreceiver v0.41.0 // indirect
