...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed v0.56.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/testbed/mockdatareceivers/mockawsxrayreceiver v0.57.2 // indirect
