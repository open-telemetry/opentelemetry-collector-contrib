module github.com/asserts/opentelemetry-collector-contrib/receiver/purefbreceiver
...
replace github.com/asserts/opentelemetry-collector-contrib/receiver/prometheusreceiver => ../prometheusreceiver
