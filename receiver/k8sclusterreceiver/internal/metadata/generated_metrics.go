...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings receiver.CreateSettings, options ...metricBuilderOption) *MetricsBuilder {
	...
	if mbc.ResourceAttributes.K8sKubeproxyVersion.Include != nil {
		mb.resourceAttributeIncludeFilter["k8s.kubeproxy.version"] = filter.CreateFilter(mbc.ResourceAttributes.K8sKubeproxyVersion.Include)
	}
	if mbc.ResourceAttributes.K8sKubeproxyVersion.Exclude != nil {
		mb.resourceAttributeExcludeFilter["k8s.kubeproxy.version"] = filter.CreateFilter(mbc.ResourceAttributes.K8sKubeproxyVersion.Exclude)
	}
