		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sNodeCPUAllocatable:               MetricConfig{Enabled: true},
					K8sNodeEphemeralStorageAllocatable:  MetricConfig{Enabled: true},
					K8sNodeMemoryAllocatable:            MetricConfig{Enabled: true},
					K8sNodePodsAllocatable:              MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sNodeCPUAllocatable:               MetricConfig{Enabled: false},
					K8sNodeEphemeralStorageAllocatable:  MetricConfig{Enabled: false},
					K8sNodeMemoryAllocatable:            MetricConfig{Enabled: false},
					K8sNodePodsAllocatable:              MetricConfig{Enabled: false},
