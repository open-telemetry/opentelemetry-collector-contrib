...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			metrics := mb.Emit(WithK8sNamespaceName("attr-val"), WithK8sReplicationcontrollerName("attr-val"), WithK8sReplicationcontrollerUID("attr-val"), WithOpencensusResourcetype("attr-val"))
