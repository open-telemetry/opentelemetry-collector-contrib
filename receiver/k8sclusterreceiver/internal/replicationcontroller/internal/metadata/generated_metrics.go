...
// WithK8sReplicationcontrollerName sets provided value as "k8s.replicationcontroller.name" attribute for current resource.
func WithK8sReplicationcontrollerName(val string) ResourceMetricsOption {
	return func(rac ResourceAttributesConfig, rm pmetric.ResourceMetrics) {
		if rac.K8sReplicationcontrollerName.Enabled {
			rm.Resource().Attributes().PutStr("k8s.replicationcontroller.name", val)
		}
	}
}

// WithK8sReplicationcontrollerUID sets provided value as "k8s.replicationcontroller.uid" attribute for current resource.
func WithK8sReplicationcontrollerUID(val string) ResourceMetricsOption {
	return func(rac ResourceAttributesConfig, rm pmetric.ResourceMetrics) {
		if rac.K8sReplicationcontrollerUID.Enabled {
			rm.Resource().Attributes().PutStr("k8s.replicationcontroller.uid", val)
		}
	}
}
