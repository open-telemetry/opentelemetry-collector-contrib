...
func TestNodeMetricsReportCPUMetrics(t *testing.T) {
	...
	rm := CustomMetrics(receivertest.NewNopSettingsWithType(metadata.Type), rb, n,
		[]string{
			"Ready",
			"MemoryPressure",
			"DiskPressure",
...
func TestNodeMetrics(t *testing.T) {
	...
	mb := metadata.NewMetricsBuilder(mbc, receivertest.NewNopSettingsWithType(metadata.Type))
