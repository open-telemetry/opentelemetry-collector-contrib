...
func getMetricsForHPA(hpa *v2beta2.HorizontalPodAutoscaler) []*resourceMetrics {
...
func getResourceForHPA(hpa *v2beta2.HorizontalPodAutoscaler) *resourcepb.Resource {
...
func getMetadataForHPA(hpa *v2beta2.HorizontalPodAutoscaler) map[metadata.ResourceID]*KubernetesMetadata {
