...
// WithK8sNamespaceUID sets provided value as "k8s.namespace.uid" attribute for current resource.
func WithK8sNamespaceUID(val string) ResourceMetricsOption {
	return func(rac ResourceAttributesConfig, rm pmetric.ResourceMetrics) {
		if rac.K8sNamespaceUID.Enabled {
			rm.Resource().Attributes().PutStr("k8s.namespace.uid", val)
		}
	}
}
