...
// WithK8sCronjobName sets provided value as "k8s.cronjob.name" attribute for current resource.
func WithK8sCronjobName(val string) ResourceMetricsOption {
	return func(rac ResourceAttributesConfig, rm pmetric.ResourceMetrics) {
		if rac.K8sCronjobName.Enabled {
			rm.Resource().Attributes().PutStr("k8s.cronjob.name", val)
		}
	}
}

// WithK8sCronjobUID sets provided value as "k8s.cronjob.uid" attribute for current resource.
func WithK8sCronjobUID(val string) ResourceMetricsOption {
	return func(rac ResourceAttributesConfig, rm pmetric.ResourceMetrics) {
		if rac.K8sCronjobUID.Enabled {
			rm.Resource().Attributes().PutStr("k8s.cronjob.uid", val)
		}
	}
}
