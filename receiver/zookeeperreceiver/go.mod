module github.com/domleb/opentelemetry-collector-contrib/receiver/zookeeperreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/scraper/zookeeperscraper v0.122.0
