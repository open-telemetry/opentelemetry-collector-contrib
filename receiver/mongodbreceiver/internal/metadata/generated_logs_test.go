...
func TestLogsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allEventsCount++
			lb.RecordDbServerTopQueryEvent(ctx, timestamp, "db.collection.name-val", "db.namespace-val", "db.operation.name-val", "db.query.text-val", AttributeDbSystemNameMongodb, 26.100000, 31, 31, 26.100000, "mongodb.operation.explain_plan-val", "mongodb.operation.explain_plan_hash-val", 31, "mongodb.operation.plan.summary-val", 33, "mongodb.operation.type-val")
