...
func TestLogsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allEventsCount++
			lb.RecordDbServerQuerySampleEvent(ctx, timestamp, "client.address-val", 11, AttributeDbSystemNameMongodb, "db.namespace-val", "db.collection.name-val", "db.operation.name-val", "db.query.text-val", true, "user.name-val", "mongodb.client.app.name-val", false, 37, 39, "mongodb.cursor.id-val", false, "mongodb.cursor.operation_using_cursor_id-val", "mongodb.cursor.originating_command-val", false, "mongodb.lsid.id-val", "mongodb.namespace-val", "mongodb.operation.id-val", "mongodb.operation.plan_summary-val", "mongodb.operation.query_framework-val", AttributeMongodbOperationStateActive, "mongodb.operation.type-val", 26.100000, 45, 38, 29, true, "mongodb.operation.locks-val", "mongodb.operation.lock_stats-val", true, "mongodb.operation.flow_control_stats-val", false, "mongodb.operation.waiting_for_latch.details-val")
