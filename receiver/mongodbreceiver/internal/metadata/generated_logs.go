...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTruncatedAttributeValue string, userNameAttributeValue string, mongodbApplicationNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorBatchesReturnedCountAttributeValue int64, mongodbCursorDocumentsReturnedCountAttributeValue int64, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOperationUsingCursorIDAttributeValue string, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorTailableAttributeValue bool, mongodbDatabaseNameAttributeValue string, mongodbLsidIDAttributeValue string, mongodbNamespaceAttributeValue string, mongodbOperationIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbOperationQueryFrameworkAttributeValue string, mongodbOperationStatusAttributeValue string, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPrepareReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitingForLockAttributeValue bool, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationWaitingForFlowControlAttributeValue bool, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchAttributeValue bool, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	if !e.config.Enabled {
		return
	}
	...
	dp.Attributes().PutStr("mongodb.operation.query_framework", mongodbOperationQueryFrameworkAttributeValue)
...
func (lb *LogsBuilder) RecordDbServerQuerySampleEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue AttributeDbSystemName, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTruncatedAttributeValue AttributeMongodbQueryTruncated, userNameAttributeValue string, mongodbApplicationNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorBatchesReturnedCountAttributeValue int64, mongodbCursorDocumentsReturnedCountAttributeValue int64, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOperationUsingCursorIDAttributeValue string, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorTailableAttributeValue bool, mongodbDatabaseNameAttributeValue string, mongodbLsidIDAttributeValue string, mongodbNamespaceAttributeValue string, mongodbOperationIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbOperationQueryFrameworkAttributeValue string, mongodbOperationStatusAttributeValue AttributeMongodbOperationStatus, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPrepareReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitingForLockAttributeValue bool, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationWaitingForFlowControlAttributeValue bool, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchAttributeValue bool, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	lb.eventDbServerQuerySample.recordEvent(ctx, timestamp, clientAddressAttributeValue, clientPortAttributeValue, dbSystemNameAttributeValue.String(), dbNamespaceAttributeValue, dbCollectionNameAttributeValue, dbOperationNameAttributeValue, dbQueryTextAttributeValue, mongodbQueryTruncatedAttributeValue.String(), userNameAttributeValue, mongodbApplicationNameAttributeValue, mongodbCursorAwaitDataAttributeValue, mongodbCursorBatchesReturnedCountAttributeValue, mongodbCursorDocumentsReturnedCountAttributeValue, mongodbCursorIDAttributeValue, mongodbCursorNoTimeoutAttributeValue, mongodbCursorOperationUsingCursorIDAttributeValue, mongodbCursorOriginatingCommandAttributeValue, mongodbCursorTailableAttributeValue, mongodbDatabaseNameAttributeValue, mongodbLsidIDAttributeValue, mongodbNamespaceAttributeValue, mongodbOperationIDAttributeValue, mongodbOperationPlanSummaryAttributeValue, mongodbOperationQueryFrameworkAttributeValue, mongodbOperationStatusAttributeValue.String(), mongodbOperationTypeAttributeValue, mongodbOperationDurationAttributeValue, mongodbOperationPrepareReadConflictCountAttributeValue, mongodbOperationWriteConflictCountAttributeValue, mongodbOperationYieldCountAttributeValue, mongodbOperationWaitingForLockAttributeValue, mongodbOperationLocksAttributeValue, mongodbOperationLockStatsAttributeValue, mongodbOperationWaitingForFlowControlAttributeValue, mongodbOperationFlowControlStatsAttributeValue, mongodbOperationWaitingForLatchAttributeValue, mongodbOperationWaitingForLatchDetailsAttributeValue)
}
