...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTextTruncatedAttributeValue bool, userNameAttributeValue string, mongodbClientAppNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorBatchesReturnedCountAttributeValue int64, mongodbCursorDocumentsReturnedCountAttributeValue int64, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOperationUsingCursorIDAttributeValue string, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorTailableAttributeValue bool, mongodbLsidIDAttributeValue string, mongodbOperationIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbQueryFrameworkAttributeValue string, mongodbOperationStateAttributeValue string, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPreparedReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitingForLockAttributeValue bool, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationWaitingForFlowControlAttributeValue bool, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchAttributeValue bool, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	if !e.config.Enabled {
		return
	}
	...
	dp.Attributes().PutBool("mongodb.query.text.truncated", mongodbQueryTextTruncatedAttributeValue)
	...
	dp.Attributes().PutInt("mongodb.cursor.batches_returned.count", mongodbCursorBatchesReturnedCountAttributeValue)
	dp.Attributes().PutInt("mongodb.cursor.documents_returned.count", mongodbCursorDocumentsReturnedCountAttributeValue)
	...
	dp.Attributes().PutStr("mongodb.cursor.operation_using_cursor_id", mongodbCursorOperationUsingCursorIDAttributeValue)
...
func (lb *LogsBuilder) RecordDbServerQuerySampleEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue AttributeDbSystemName, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTextTruncatedAttributeValue bool, userNameAttributeValue string, mongodbClientAppNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorBatchesReturnedCountAttributeValue int64, mongodbCursorDocumentsReturnedCountAttributeValue int64, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOperationUsingCursorIDAttributeValue string, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorTailableAttributeValue bool, mongodbLsidIDAttributeValue string, mongodbOperationIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbQueryFrameworkAttributeValue string, mongodbOperationStateAttributeValue AttributeMongodbOperationState, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPreparedReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitingForLockAttributeValue bool, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationWaitingForFlowControlAttributeValue bool, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchAttributeValue bool, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	lb.eventDbServerQuerySample.recordEvent(ctx, timestamp, clientAddressAttributeValue, clientPortAttributeValue, dbSystemNameAttributeValue.String(), dbNamespaceAttributeValue, dbCollectionNameAttributeValue, dbOperationNameAttributeValue, dbQueryTextAttributeValue, mongodbQueryTextTruncatedAttributeValue, userNameAttributeValue, mongodbClientAppNameAttributeValue, mongodbCursorAwaitDataAttributeValue, mongodbCursorBatchesReturnedCountAttributeValue, mongodbCursorDocumentsReturnedCountAttributeValue, mongodbCursorIDAttributeValue, mongodbCursorNoTimeoutAttributeValue, mongodbCursorOperationUsingCursorIDAttributeValue, mongodbCursorOriginatingCommandAttributeValue, mongodbCursorTailableAttributeValue, mongodbLsidIDAttributeValue, mongodbOperationIDAttributeValue, mongodbOperationPlanSummaryAttributeValue, mongodbQueryFrameworkAttributeValue, mongodbOperationStateAttributeValue.String(), mongodbOperationTypeAttributeValue, mongodbOperationDurationAttributeValue, mongodbOperationPreparedReadConflictCountAttributeValue, mongodbOperationWriteConflictCountAttributeValue, mongodbOperationYieldCountAttributeValue, mongodbOperationWaitingForLockAttributeValue, mongodbOperationLocksAttributeValue, mongodbOperationLockStatsAttributeValue, mongodbOperationWaitingForFlowControlAttributeValue, mongodbOperationFlowControlStatsAttributeValue, mongodbOperationWaitingForLatchAttributeValue, mongodbOperationWaitingForLatchDetailsAttributeValue)
}
