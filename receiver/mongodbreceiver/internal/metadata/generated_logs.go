...
func (e *eventDbServerQuerySample) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue string, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationIDAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTruncatedAttributeValue bool, userNameAttributeValue string, mongodbClientAppNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorReturnedBatchesAttributeValue int64, mongodbCursorReturnedDocumentsAttributeValue int64, mongodbCursorTailableAttributeValue bool, mongodbLsidIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbQueryFrameworkAttributeValue string, mongodbOperationStateAttributeValue string, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPreparedReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitTypeAttributeValue []any, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	if !e.config.Enabled {
		return
	}
...
func (lb *LogsBuilder) RecordDbServerQuerySampleEvent(ctx context.Context, timestamp pcommon.Timestamp, clientAddressAttributeValue string, clientPortAttributeValue int64, dbSystemNameAttributeValue AttributeDbSystemName, dbNamespaceAttributeValue string, dbCollectionNameAttributeValue string, dbOperationIDAttributeValue string, dbOperationNameAttributeValue string, dbQueryTextAttributeValue string, mongodbQueryTruncatedAttributeValue bool, userNameAttributeValue string, mongodbClientAppNameAttributeValue string, mongodbCursorAwaitDataAttributeValue bool, mongodbCursorIDAttributeValue string, mongodbCursorNoTimeoutAttributeValue bool, mongodbCursorOriginatingCommandAttributeValue string, mongodbCursorReturnedBatchesAttributeValue int64, mongodbCursorReturnedDocumentsAttributeValue int64, mongodbCursorTailableAttributeValue bool, mongodbLsidIDAttributeValue string, mongodbOperationPlanSummaryAttributeValue string, mongodbQueryFrameworkAttributeValue string, mongodbOperationStateAttributeValue AttributeMongodbOperationState, mongodbOperationTypeAttributeValue string, mongodbOperationDurationAttributeValue float64, mongodbOperationPreparedReadConflictCountAttributeValue int64, mongodbOperationWriteConflictCountAttributeValue int64, mongodbOperationYieldCountAttributeValue int64, mongodbOperationWaitTypeAttributeValue []any, mongodbOperationLocksAttributeValue string, mongodbOperationLockStatsAttributeValue string, mongodbOperationFlowControlStatsAttributeValue string, mongodbOperationWaitingForLatchDetailsAttributeValue string) {
	lb.eventDbServerQuerySample.recordEvent(ctx, timestamp, clientAddressAttributeValue, clientPortAttributeValue, dbSystemNameAttributeValue.String(), dbNamespaceAttributeValue, dbCollectionNameAttributeValue, dbOperationIDAttributeValue, dbOperationNameAttributeValue, dbQueryTextAttributeValue, mongodbQueryTruncatedAttributeValue, userNameAttributeValue, mongodbClientAppNameAttributeValue, mongodbCursorAwaitDataAttributeValue, mongodbCursorIDAttributeValue, mongodbCursorNoTimeoutAttributeValue, mongodbCursorOriginatingCommandAttributeValue, mongodbCursorReturnedBatchesAttributeValue, mongodbCursorReturnedDocumentsAttributeValue, mongodbCursorTailableAttributeValue, mongodbLsidIDAttributeValue, mongodbOperationPlanSummaryAttributeValue, mongodbQueryFrameworkAttributeValue, mongodbOperationStateAttributeValue.String(), mongodbOperationTypeAttributeValue, mongodbOperationDurationAttributeValue, mongodbOperationPreparedReadConflictCountAttributeValue, mongodbOperationWriteConflictCountAttributeValue, mongodbOperationYieldCountAttributeValue, mongodbOperationWaitTypeAttributeValue, mongodbOperationLocksAttributeValue, mongodbOperationLockStatsAttributeValue, mongodbOperationFlowControlStatsAttributeValue, mongodbOperationWaitingForLatchDetailsAttributeValue)
}
