...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbCollectionCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbConnectionCountDataPoint(ts, 3, AttributeConnectionTypeAvailable)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbDataSizeDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbDocumentOperationCountDataPoint(ts, 3, AttributeOperationQuery)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbExtentCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbIndexAccessCountDataPoint(ts, 3, "collection-val-2")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbIndexCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbIndexSizeDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbLockAcquireCountDataPoint(ts, 3, AttributeLockTypeReplicationStateTransition, AttributeLockModeExclusive)
			}

			allMetricsCount++
			mb.RecordMongodbLockAcquireTimeDataPoint(ts, 1, AttributeLockTypeParallelBatchWriteMode, AttributeLockModeShared)
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbLockAcquireTimeDataPoint(ts, 3, AttributeLockTypeReplicationStateTransition, AttributeLockModeExclusive)
			}

			allMetricsCount++
			mb.RecordMongodbLockAcquireWaitCountDataPoint(ts, 1, AttributeLockTypeParallelBatchWriteMode, AttributeLockModeShared)
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbLockAcquireWaitCountDataPoint(ts, 3, AttributeLockTypeReplicationStateTransition, AttributeLockModeExclusive)
			}

			allMetricsCount++
			mb.RecordMongodbLockDeadlockCountDataPoint(ts, 1, AttributeLockTypeParallelBatchWriteMode, AttributeLockModeShared)
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbLockDeadlockCountDataPoint(ts, 3, AttributeLockTypeReplicationStateTransition, AttributeLockModeExclusive)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbMemoryUsageDataPoint(ts, 3, AttributeMemoryTypeVirtual)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbObjectCountDataPoint(ts, 3)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordMongodbStorageSizeDataPoint(ts, 3)
			}
