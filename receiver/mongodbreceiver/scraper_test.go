	...
	errAllPartialMetrics = errors.New(
		strings.Join(
			[]string{
				...
				"failed to collect metric mongodb.collection.count: could not find key for metric",
				"failed to collect metric mongodb.data.size: could not find key for metric",
				"failed to collect metric mongodb.extent.count: could not find key for metric",
				"failed to collect metric mongodb.index.size: could not find key for metric",
				"failed to collect metric mongodb.index.count: could not find key for metric",
				"failed to collect metric mongodb.object.count: could not find key for metric",
				"failed to collect metric mongodb.storage.size: could not find key for metric",
				"failed to collect metric mongodb.connection.count with attribute(s) available: could not find key for metric",
				"failed to collect metric mongodb.connection.count with attribute(s) current: could not find key for metric",
				"failed to collect metric mongodb.connection.count with attribute(s) active: could not find key for metric",
				"failed to collect metric mongodb.document.operation.count with attribute(s) inserted: could not find key for metric",
				"failed to collect metric mongodb.document.operation.count with attribute(s) updated: could not find key for metric",
				"failed to collect metric mongodb.document.operation.count with attribute(s) deleted: could not find key for metric",
				"failed to collect metric mongodb.memory.usage with attribute(s) resident: could not find key for metric",
				"failed to collect metric mongodb.memory.usage with attribute(s) virtual: could not find key for metric",
				"failed to collect metric mongodb.index.access.count with attribute(s) orders: could not find key for index access metric",
				"failed to collect metric mongodb.index.access.count with attribute(s) products: could not find key for index access metric",
