...
| **mongodb.locks.time_acquiring_micros** | Cumulative wait time for the lock acquisitions. | microseconds | Sum(Int) | <ul> <li>database</li> <li>lock_type</li> <li>lock_mode</li> </ul> |
