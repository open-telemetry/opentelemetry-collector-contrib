module github.com/asserts/opentelemetry-collector-contrib/receiver/opencensusreceiver
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/opencensus v0.71.0
