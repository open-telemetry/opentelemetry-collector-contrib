module github.com/domleb/opentelemetry-collector-contrib/receiver/opencensusreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/opencensus v0.122.0
