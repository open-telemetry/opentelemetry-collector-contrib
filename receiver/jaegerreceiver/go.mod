module github.com/asserts/opentelemetry-collector-contrib/receiver/jaegerreceiver
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/translator/jaeger v0.71.0
