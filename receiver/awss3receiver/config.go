...
type SQSConfig struct {
	...
	// PreserveMessages indicates whether to preserve messages in the queue after processing.
	// Default is false - messages are deleted.
	PreserveMessages bool `mapstructure:"preserve_messages"`
}
