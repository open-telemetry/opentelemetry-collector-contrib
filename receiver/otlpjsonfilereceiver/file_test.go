...
func TestFileProfilesReceiver(t *testing.T) {
	...
	receiver, err := factory.(xreceiver.Factory).CreateProfiles(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, sink)
...
func TestFileTracesReceiver(t *testing.T) {
	...
	receiver, err := factory.CreateTraces(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, sink)
	assert.NoError(t, err)
	err = receiver.Start(context.Background(), nil)
	require.NoError(t, err)
...
func TestFileMetricsReceiver(t *testing.T) {
	...
	receiver, err := factory.CreateMetrics(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, sink)
	assert.NoError(t, err)
	err = receiver.Start(context.Background(), nil)
	assert.NoError(t, err)
...
func TestFileLogsReceiver(t *testing.T) {
	...
	receiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, sink)
	assert.NoError(t, err)
	err = receiver.Start(context.Background(), nil)
	assert.NoError(t, err)
