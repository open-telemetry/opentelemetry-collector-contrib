...
func TestUptime(t *testing.T) {
	...
	mbs := &metadata.MetricsBuilders{
		NodeMetricsBuilder:      metadata.NewMetricsBuilder(cfg, receivertest.NewNopSettingsWithType(metadata.Type)),
		PodMetricsBuilder:       metadata.NewMetricsBuilder(cfg, receivertest.NewNopSettingsWithType(metadata.Type)),
		ContainerMetricsBuilder: metadata.NewMetricsBuilder(cfg, receivertest.NewNopSettingsWithType(metadata.Type)),
	}
