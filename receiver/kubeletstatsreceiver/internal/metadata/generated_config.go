...
type MetricsConfig struct {
	...
	K8sNodeRuntimeImageFsAvailable  MetricConfig `mapstructure:"k8s.node.runtime.image_fs.available"`
	K8sNodeRuntimeImageFsCapacity   MetricConfig `mapstructure:"k8s.node.runtime.image_fs.capacity"`
	K8sNodeRuntimeImageFsInodes     MetricConfig `mapstructure:"k8s.node.runtime.image_fs.inodes"`
	K8sNodeRuntimeImageFsInodesFree MetricConfig `mapstructure:"k8s.node.runtime.image_fs.inodes_free"`
	K8sNodeRuntimeImageFsInodesUsed MetricConfig `mapstructure:"k8s.node.runtime.image_fs.inodes_used"`
	K8sNodeRuntimeImageFsUsed       MetricConfig `mapstructure:"k8s.node.runtime.image_fs.used"`
...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		K8sNodeRuntimeImageFsAvailable: MetricConfig{
			Enabled: true,
		},
		K8sNodeRuntimeImageFsCapacity: MetricConfig{
			Enabled: true,
		},
		K8sNodeRuntimeImageFsInodes: MetricConfig{
			Enabled: true,
		},
		K8sNodeRuntimeImageFsInodesFree: MetricConfig{
			Enabled: true,
		},
		K8sNodeRuntimeImageFsInodesUsed: MetricConfig{
			Enabled: true,
		},
		K8sNodeRuntimeImageFsUsed: MetricConfig{
			Enabled: true,
		},
