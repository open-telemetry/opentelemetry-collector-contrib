...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			aggMap["K8sNodeNetworkErrors"] = mb.metricK8sNodeNetworkErrors.config.AggregationStrategy
			aggMap["K8sNodeNetworkIo"] = mb.metricK8sNodeNetworkIo.config.AggregationStrategy
			aggMap["K8sPodNetworkErrors"] = mb.metricK8sPodNetworkErrors.config.AggregationStrategy
			aggMap["K8sPodNetworkIo"] = mb.metricK8sPodNetworkIo.config.AggregationStrategy
