...
// init fills k8s.node.runtime.imagefs.inodes.free metric with initial data.
func (m *metricK8sNodeRuntimeImagefsInodesFree) init() {
	m.data.SetName("k8s.node.runtime.imagefs.inodes.free")
	m.data.SetDescription("Node runtime imagefs inodes free")
	m.data.SetUnit("By")
	m.data.SetEmptyGauge()
}
...
// init fills k8s.node.runtime.imagefs.inodes.used metric with initial data.
func (m *metricK8sNodeRuntimeImagefsInodesUsed) init() {
	m.data.SetName("k8s.node.runtime.imagefs.inodes.used")
	m.data.SetDescription("Node runtime imagefs inodes used. This may not equal Inodes - InodesFree because this filesystem may share inodes with other filesystems.")
	m.data.SetUnit("By")
	m.data.SetEmptyGauge()
}
...
// RecordK8sNodeRuntimeImagefsInodesFreeDataPoint adds a data point to k8s.node.runtime.imagefs.inodes.free metric.
...
// RecordK8sNodeRuntimeImagefsInodesUsedDataPoint adds a data point to k8s.node.runtime.imagefs.inodes.used metric.
