		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sNodeRuntimeImageFsAvailable:  MetricConfig{Enabled: true},
					K8sNodeRuntimeImageFsCapacity:   MetricConfig{Enabled: true},
					K8sNodeRuntimeImageFsInodes:     MetricConfig{Enabled: true},
					K8sNodeRuntimeImageFsInodesFree: MetricConfig{Enabled: true},
					K8sNodeRuntimeImageFsInodesUsed: MetricConfig{Enabled: true},
					K8sNodeRuntimeImageFsUsed:       MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sNodeRuntimeImageFsAvailable:  MetricConfig{Enabled: false},
					K8sNodeRuntimeImageFsCapacity:   MetricConfig{Enabled: false},
					K8sNodeRuntimeImageFsInodes:     MetricConfig{Enabled: false},
					K8sNodeRuntimeImageFsInodesFree: MetricConfig{Enabled: false},
					K8sNodeRuntimeImageFsInodesUsed: MetricConfig{Enabled: false},
					K8sNodeRuntimeImageFsUsed:       MetricConfig{Enabled: false},
