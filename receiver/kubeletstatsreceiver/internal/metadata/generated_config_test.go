		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sPodCPULimit:                       MetricConfig{Enabled: true},
					K8sPodCPUNodeUtilization:             MetricConfig{Enabled: true},
					K8sPodCPURequest:                     MetricConfig{Enabled: true},
					...
					K8sPodMemoryLimit:                    MetricConfig{Enabled: true},
					...
					K8sPodMemoryRequest:                  MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					K8sPodCPULimit:                       MetricConfig{Enabled: false},
					K8sPodCPUNodeUtilization:             MetricConfig{Enabled: false},
					K8sPodCPURequest:                     MetricConfig{Enabled: false},
					...
					K8sPodMemoryLimit:                    MetricConfig{Enabled: false},
					...
					K8sPodMemoryRequest:                  MetricConfig{Enabled: false},
