module github.com/domleb/opentelemetry-collector-contrib/receiver/collectdreceiver

go 1.23.0

require (
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/collectd v0.122.0
