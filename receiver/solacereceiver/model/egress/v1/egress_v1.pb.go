...
type SpanData_DeleteSpan_Reason int32

const (
	SpanData_DeleteSpan_TTL_EXPIRY                SpanData_DeleteSpan_Reason = 0
	SpanData_DeleteSpan_MAX_REDELIVERIES_EXCEEDED SpanData_DeleteSpan_Reason = 1
	SpanData_DeleteSpan_ENQUEUE_FAILURE           SpanData_DeleteSpan_Reason = 2
	SpanData_DeleteSpan_ADMIN_MESSAGE_DELETE      SpanData_DeleteSpan_Reason = 3
	SpanData_DeleteSpan_ADMIN_QUEUE_DELETE        SpanData_DeleteSpan_Reason = 4
)

// Enum value maps for SpanData_DeleteSpan_Reason.
var (
	SpanData_DeleteSpan_Reason_name = map[int32]string{
		0: "TTL_EXPIRY",
		1: "MAX_REDELIVERIES_EXCEEDED",
		2: "ENQUEUE_FAILURE",
		3: "ADMIN_MESSAGE_DELETE",
		4: "ADMIN_QUEUE_DELETE",
	}
	SpanData_DeleteSpan_Reason_value = map[string]int32{
		"TTL_EXPIRY":                0,
		"MAX_REDELIVERIES_EXCEEDED": 1,
		"ENQUEUE_FAILURE":           2,
		"ADMIN_MESSAGE_DELETE":      3,
		"ADMIN_QUEUE_DELETE":        4,
	}
)

func (x SpanData_DeleteSpan_Reason) Enum() *SpanData_DeleteSpan_Reason {
	p := new(SpanData_DeleteSpan_Reason)
	*p = x
	return p
}

func (x SpanData_DeleteSpan_Reason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SpanData_DeleteSpan_Reason) Descriptor() protoreflect.EnumDescriptor {
	return file_egress_v1_proto_enumTypes[1].Descriptor()
}

func (SpanData_DeleteSpan_Reason) Type() protoreflect.EnumType {
	return &file_egress_v1_proto_enumTypes[1]
}

func (x SpanData_DeleteSpan_Reason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SpanData_DeleteSpan_Reason.Descriptor instead.
func (SpanData_DeleteSpan_Reason) EnumDescriptor() ([]byte, []int) {
...
func (SpanData_TransactionEvent_Type) EnumDescriptor() ([]byte, []int) {
	return file_egress_v1_proto_rawDescGZIP(), []int{0, 3, 0}
}
...
func (SpanData_TransactionEvent_Initiator) Descriptor() protoreflect.EnumDescriptor {
	return file_egress_v1_proto_enumTypes[3].Descriptor()
}

func (SpanData_TransactionEvent_Initiator) Type() protoreflect.EnumType {
	return &file_egress_v1_proto_enumTypes[3]
}
...
func (SpanData_TransactionEvent_Initiator) EnumDescriptor() ([]byte, []int) {
	return file_egress_v1_proto_rawDescGZIP(), []int{0, 3, 1}
}
...
type SpanData_SendSpan struct {
	...
	QueueTemporary         bool                       `protobuf:"varint,3,opt,name=queue_temporary,json=queueTemporary,proto3" json:"queue_temporary,omitempty"`
	Outcome                SpanData_SendSpan_Outcome  `protobuf:"varint,4,opt,name=outcome,proto3,enum=solace.messaging.proto.broker.trace.egress.v1.SpanData_SendSpan_Outcome" json:"outcome,omitempty"`
	ReplayedMsg            bool                       `protobuf:"varint,5,opt,name=replayed_msg,json=replayedMsg,proto3" json:"replayed_msg,omitempty"`
	ConsumerClientUsername string                     `protobuf:"bytes,6,opt,name=consumer_client_username,json=consumerClientUsername,proto3" json:"consumer_client_username,omitempty"`
	ConsumerClientName     string                     `protobuf:"bytes,7,opt,name=consumer_client_name,json=consumerClientName,proto3" json:"consumer_client_name,omitempty"`
	Protocol               string                     `protobuf:"bytes,8,opt,name=protocol,proto3" json:"protocol,omitempty"`
	ProtocolVersion        *string                    `protobuf:"bytes,9,opt,name=protocol_version,json=protocolVersion,proto3,oneof" json:"protocol_version,omitempty"`
}
...
func (x *SpanData_SendSpan) GetQueueTemporary() bool {
	if x != nil {
		return x.QueueTemporary
	}
	return false
}
...
// This message contains data unique to delete spans generated in egress.
// The only implemented delete span currently implemented is the
// ENQUEUE_FAILURE reason. Other values are defined to allow their
// implementation to be added in the future without automatically requiring
...
type SpanData_DeleteSpan struct {
	...
	Source         isSpanData_DeleteSpan_Source `protobuf_oneof:"source"`
	QueueTemporary bool                         `protobuf:"varint,3,opt,name=queue_temporary,json=queueTemporary,proto3" json:"queue_temporary,omitempty"`
	Reason         SpanData_DeleteSpan_Reason   `protobuf:"varint,4,opt,name=reason,proto3,enum=solace.messaging.proto.broker.trace.egress.v1.SpanData_DeleteSpan_Reason" json:"reason,omitempty"`
}
...
func (m *SpanData_DeleteSpan) GetSource() isSpanData_DeleteSpan_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
func (x *SpanData_DeleteSpan) GetQueueName() string {
	if x, ok := x.GetSource().(*SpanData_DeleteSpan_QueueName); ok {
		return x.QueueName
	}
	return ""
}
...
func (x *SpanData_DeleteSpan) GetTopicEndpointName() string {
	if x, ok := x.GetSource().(*SpanData_DeleteSpan_TopicEndpointName); ok {
		return x.TopicEndpointName
	}
	return ""
}

func (x *SpanData_DeleteSpan) GetQueueTemporary() bool {
	if x != nil {
		return x.QueueTemporary
	}
	return false
...
func (x *SpanData_DeleteSpan) GetReason() SpanData_DeleteSpan_Reason {
	if x != nil {
		return x.Reason
	}
	return SpanData_DeleteSpan_TTL_EXPIRY
}

type isSpanData_DeleteSpan_Source interface {
	isSpanData_DeleteSpan_Source()
}
...
func (*SpanData_DeleteSpan_QueueName) isSpanData_DeleteSpan_Source() {}

func (*SpanData_DeleteSpan_TopicEndpointName) isSpanData_DeleteSpan_Source() {}
...
var file_egress_v1_proto_rawDesc = []byte{
	...
	0x22, 0xb2, 0x16, 0x0a, 0x08, 0x53, 0x70, 0x61, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x65, 0x0a,
	...
	0x65, 0x88, 0x01, 0x01, 0x1a, 0x8b, 0x05, 0x0a, 0x0a, 0x45, 0x67, 0x72, 0x65, 0x73, 0x73, 0x53,
	...
	0x06, 0x73, 0x70, 0x61, 0x6e, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0x5f, 0x73, 0x70, 0x61, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x48,
	0x01, 0x52, 0x0c, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x53, 0x70, 0x61, 0x6e, 0x49, 0x64, 0x88,
	0x01, 0x01, 0x12, 0x2f, 0x0a, 0x14, 0x73, 0x74, 0x61, 0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65,
	...
	0x75, 0x6e, 0x69, 0x78, 0x5f, 0x6e, 0x61, 0x6e, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x10, 0x52,
	0x0f, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x6e, 0x69, 0x78, 0x4e, 0x61, 0x6e, 0x6f,
	0x12, 0x7a, 0x0a, 0x11, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x73, 0x6f,
	...
	0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x02, 0x52, 0x10, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x88, 0x01, 0x01, 0x12, 0x30, 0x0a, 0x11,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x03, 0x52, 0x10, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x5f,
	0x0a, 0x09, 0x73, 0x65, 0x6e, 0x64, 0x5f, 0x73, 0x70, 0x61, 0x6e, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x40, 0x2e, 0x73, 0x6f, 0x6c, 0x61, 0x63, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61,
	...
	0x70, 0x61, 0x6e, 0x48, 0x00, 0x52, 0x08, 0x73, 0x65, 0x6e, 0x64, 0x53, 0x70, 0x61, 0x6e, 0x12,
	0x65, 0x0a, 0x0b, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x5f, 0x73, 0x70, 0x61, 0x6e, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x73, 0x6f, 0x6c, 0x61, 0x63, 0x65, 0x2e, 0x6d, 0x65,
	...
	,
	...
	,
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x0f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c,
	0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x22, 0xab, 0x01, 0x0a, 0x07, 0x4f,
	0x75, 0x74, 0x63, 0x6f, 0x6d, 0x65, 0x12, 0x0c, 0x0a, 0x08, 0x41, 0x43, 0x43, 0x45, 0x50, 0x54,
	...
	,
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x71, 0x75, 0x65,
	0x75, 0x65, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x54, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61,
	0x72, 0x79, 0x12, 0x61, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x49, 0x2e, 0x73, 0x6f, 0x6c, 0x61, 0x63, 0x65, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	...
	,
	...
	0x6d, 0x65, 0x55, 0x6e, 0x69, 0x78, 0x4e, 0x61, 0x6e, 0x6f, 0x12, 0x61, 0x0a, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x4d, 0x2e, 0x73, 0x6f, 0x6c, 0x61, 0x63,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	,
}
...
var file_egress_v1_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_egress_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_egress_v1_proto_goTypes = []interface{}{
	...
	(SpanData_DeleteSpan_Reason)(0),                      // 1: solace.messaging.proto.broker.trace.egress.v1.SpanData.DeleteSpan.Reason
	(SpanData_TransactionEvent_Type)(0),                  // 2: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Type
	(SpanData_TransactionEvent_Initiator)(0),             // 3: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Initiator
	(*SpanData)(nil),                                     // 4: solace.messaging.proto.broker.trace.egress.v1.SpanData
	(*SpanData_EgressSpan)(nil),                          // 5: solace.messaging.proto.broker.trace.egress.v1.SpanData.EgressSpan
	(*SpanData_SendSpan)(nil),                            // 6: solace.messaging.proto.broker.trace.egress.v1.SpanData.SendSpan
	(*SpanData_DeleteSpan)(nil),                          // 7: solace.messaging.proto.broker.trace.egress.v1.SpanData.DeleteSpan
	(*SpanData_TransactionEvent)(nil),                    // 8: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent
	(*SpanData_TransactionEvent_Xid)(nil),                // 9: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Xid
	(*SpanData_TransactionEvent_LocalTransactionId)(nil), // 10: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.LocalTransactionId
}
var file_egress_v1_proto_depIdxs = []int32{
	5,  // 0: solace.messaging.proto.broker.trace.egress.v1.SpanData.egress_spans:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.EgressSpan
	8,  // 1: solace.messaging.proto.broker.trace.egress.v1.SpanData.EgressSpan.transaction_event:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent
	6,  // 2: solace.messaging.proto.broker.trace.egress.v1.SpanData.EgressSpan.send_span:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.SendSpan
	7,  // 3: solace.messaging.proto.broker.trace.egress.v1.SpanData.EgressSpan.delete_span:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.DeleteSpan
	...
	1,  // 5: solace.messaging.proto.broker.trace.egress.v1.SpanData.DeleteSpan.reason:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.DeleteSpan.Reason
	2,  // 6: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.type:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Type
	3,  // 7: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.initiator:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Initiator
	9,  // 8: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.xid:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.Xid
	10, // 9: solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.local_id:type_name -> solace.messaging.proto.broker.trace.egress.v1.SpanData.TransactionEvent.LocalTransactionId
...
func file_egress_v1_proto_init() {
	...
	file_egress_v1_proto_msgTypes[4].OneofWrappers = []interface{}{
