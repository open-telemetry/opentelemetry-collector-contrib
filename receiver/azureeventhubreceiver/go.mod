...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azure v0.91.0
	...
	go.opentelemetry.io/collector/extension v0.91.1-0.20240109173641-c5a2c78d6143
