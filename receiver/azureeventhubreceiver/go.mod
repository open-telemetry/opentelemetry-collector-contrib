...
require (
	...
	go.opentelemetry.io/collector/exporter v0.98.1-0.20240422193438-b47303424f42 // indirect
	...
	go.opentelemetry.io/collector/processor v0.98.1-0.20240422193438-b47303424f42 // indirect
