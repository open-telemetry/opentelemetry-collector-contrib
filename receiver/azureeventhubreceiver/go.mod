...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azure v0.107.0
...
require (
	...
	go.opentelemetry.io/collector/processor v0.107.1-0.20240826191928-b33913ba527d // indirect
