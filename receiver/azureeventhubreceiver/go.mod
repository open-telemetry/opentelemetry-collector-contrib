...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/azurelogs v0.124.1
...
require (
	...
	go.opentelemetry.io/collector/exporter v0.124.1-0.20250424234037-ac7c0f2f4cd8 // indirect
