...
func beginPrivateObject(r network.MultiReader) error {
	...
	return r.AssertNextByteEquals(tagBeginPrivateObject)
}

func endObject(r network.MultiReader) error {
	const tagEndObject = 6
	return r.AssertNextByteEquals(tagEndObject)
}
