...
func createMetricsReceiver(
	...
	scrp, err := scraperhelper.NewScraperWithComponentType(metadata.Type, recv.scrape, scraperhelper.WithStart(recv.start), scraperhelper.WithShutdown(recv.shutdown))
	if err != nil {
		return nil, err
	}
