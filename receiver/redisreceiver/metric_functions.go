...
func (rs *redisScraper) dataPointRecorders() map[string]any {
	return map[string]any{
		...
		"cluster_size":                              rs.mb.RecordRedisClusterNodeCountDataPoint,
		"cluster_current_epoch":                     rs.mb.RecordRedisClusterUptimeDataPoint,
		"cluster_my_epoch":                          rs.mb.RecordRedisClusterNodeUptimeDataPoint,
		...
		"total_cluster_links_buffer_limit_exceeded": rs.mb.RecordRedisClusterLinksBufferLimitExceededCountDataPoint,
