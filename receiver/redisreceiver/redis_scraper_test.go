...
func TestRedisRunnable(t *testing.T) {
	...
	// -6 because the following recorders are disabled: [maxmemory, slave_repl_offset, cluster_enabled,
	// tracking_total_keys, used_memory_overhead, used_memory_startup]
