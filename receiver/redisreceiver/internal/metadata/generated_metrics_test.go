...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisClusterStateDataPoint(ts, 3, AttributeClusterStateOk)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisCmdCallsDataPoint(ts, 3, "cmd-val")
			}

			allMetricsCount++
			mb.RecordRedisCmdLatencyDataPoint(ts, 1, "cmd-val", AttributePercentileP50)
			if tt.name == "reaggregate_set" {
				mb.RecordRedisCmdLatencyDataPoint(ts, 3, "cmd-val", AttributePercentileP50)
			}

			allMetricsCount++
			mb.RecordRedisCmdUsecDataPoint(ts, 1, "cmd-val")
			if tt.name == "reaggregate_set" {
				mb.RecordRedisCmdUsecDataPoint(ts, 3, "cmd-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisCPUTimeDataPoint(ts, 3, AttributeStateSys)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisDbAvgTTLDataPoint(ts, 3, "db-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisDbExpiresDataPoint(ts, 3, "db-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisDbKeysDataPoint(ts, 3, "db-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisModeDataPoint(ts, 3, AttributeModeCluster)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordRedisRoleDataPoint(ts, 3, AttributeRoleReplica)
			}
