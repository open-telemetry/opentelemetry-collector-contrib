		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					RedisClusterCurrentEpoch:                         MetricConfig{Enabled: true},
					RedisClusterKnownNodes:                           MetricConfig{Enabled: true},
					RedisClusterMyEpoch:                              MetricConfig{Enabled: true},
					RedisClusterSize:                                 MetricConfig{Enabled: true},
					...
					RedisClusterState:                                MetricConfig{Enabled: true},
					RedisClusterStatsMessagesReceived:                MetricConfig{Enabled: true},
					RedisClusterStatsMessagesSent:                    MetricConfig{Enabled: true},
					RedisClusterTotalClusterLinksBufferLimitExceeded: MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					RedisClusterCurrentEpoch:                         MetricConfig{Enabled: false},
					RedisClusterKnownNodes:                           MetricConfig{Enabled: false},
					RedisClusterMyEpoch:                              MetricConfig{Enabled: false},
					RedisClusterSize:                                 MetricConfig{Enabled: false},
					...
					RedisClusterState:                                MetricConfig{Enabled: false},
					RedisClusterStatsMessagesReceived:                MetricConfig{Enabled: false},
					RedisClusterStatsMessagesSent:                    MetricConfig{Enabled: false},
					RedisClusterTotalClusterLinksBufferLimitExceeded: MetricConfig{Enabled: false},
