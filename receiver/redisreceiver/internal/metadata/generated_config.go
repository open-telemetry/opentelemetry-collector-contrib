...
type MetricsConfig struct {
	...
	RedisClusterInfoClusterCurrentEpoch                  MetricConfig `mapstructure:"redis.clusterInfo.cluster_current_epoch"`
	RedisClusterInfoClusterKnownNodes                    MetricConfig `mapstructure:"redis.clusterInfo.cluster_known_nodes"`
	RedisClusterInfoClusterMyEpoch                       MetricConfig `mapstructure:"redis.clusterInfo.cluster_my_epoch"`
	RedisClusterInfoClusterSize                          MetricConfig `mapstructure:"redis.clusterInfo.cluster_size"`
	RedisClusterInfoClusterSlotsAssigned                 MetricConfig `mapstructure:"redis.clusterInfo.cluster_slots_assigned"`
	RedisClusterInfoClusterSlotsFail                     MetricConfig `mapstructure:"redis.clusterInfo.cluster_slots_fail"`
	RedisClusterInfoClusterSlotsOk                       MetricConfig `mapstructure:"redis.clusterInfo.cluster_slots_ok"`
	RedisClusterInfoClusterSlotsPfail                    MetricConfig `mapstructure:"redis.clusterInfo.cluster_slots_pfail"`
	RedisClusterInfoClusterState                         MetricConfig `mapstructure:"redis.clusterInfo.cluster_state"`
	RedisClusterInfoClusterStatsMessagesReceived         MetricConfig `mapstructure:"redis.clusterInfo.cluster_stats_messages_received"`
	RedisClusterInfoClusterStatsMessagesSent             MetricConfig `mapstructure:"redis.clusterInfo.cluster_stats_messages_sent"`
	RedisClusterInfoTotalClusterLinksBufferLimitExceeded MetricConfig `mapstructure:"redis.clusterInfo.total_cluster_links_buffer_limit_exceeded"`
...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		RedisClusterInfoClusterCurrentEpoch: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterKnownNodes: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterMyEpoch: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterSize: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterSlotsAssigned: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterSlotsFail: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterSlotsOk: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterSlotsPfail: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterState: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterStatsMessagesReceived: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoClusterStatsMessagesSent: MetricConfig{
			Enabled: false,
		},
		RedisClusterInfoTotalClusterLinksBufferLimitExceeded: MetricConfig{
			Enabled: false,
		},
