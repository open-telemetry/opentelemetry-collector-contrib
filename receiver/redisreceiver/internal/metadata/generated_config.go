...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		RedisClusterState: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"cluster_state"},
		...
		RedisCmdLatency: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"cmd", "percentile"},
		...
		RedisMode: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"mode"},
		...
		RedisRole: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"role"},
