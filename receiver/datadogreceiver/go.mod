...
require (
	github.com/DataDog/agent-payload/v5 v5.0.206
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.81.2
	github.com/DataDog/datadog-agent/pkg/proto v0.81.2
	github.com/DataDog/datadog-agent/pkg/trace v0.81.2
	github.com/DataDog/datadog-agent/pkg/trace/stats v0.81.2
	github.com/DataDog/datadog-agent/pkg/trace/traceutil v0.81.2
