...
require (
	github.com/DataDog/agent-payload/v5 v5.0.199
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/datadog v0.153.0
	...
	go.opentelemetry.io/collector/receiver/receiverhelper v0.153.1-0.20260605023205-2008f48638ec
