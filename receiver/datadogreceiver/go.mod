...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/datadog v0.150.0
	...
	go.opentelemetry.io/collector/receiver/receiverhelper v0.150.1-0.20260423084629-98f555d14cd6
