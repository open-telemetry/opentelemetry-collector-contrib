...
type receiverConfig struct {
	...
	// Type is set based on the configured receiver name.
	Type configmodels.Type `json:"type"`
	...
	Config userConfigMap `json:"config"`
}
...
type Config struct {
	...
	// StatusAddr is the [address]:port to serve status info.
