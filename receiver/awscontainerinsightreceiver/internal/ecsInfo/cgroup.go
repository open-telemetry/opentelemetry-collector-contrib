...
func newCGroupScanner(mountConfigPath string, ctx context.Context, logger *zap.Logger, ecsTaskInfoProvider ecsTaskInfoProvider, containerInstanceInfoProvider containerInstanceInfoProvider, refreshInterval time.Duration) cgroupScannerProvider {
...
func newCGroupScannerForContainer(ctx context.Context, logger *zap.Logger, ecsTaskInfoProvider ecsTaskInfoProvider, containerInstanceInfoProvider containerInstanceInfoProvider, refreshInterval time.Duration) cgroupScannerProvider {
	return newCGroupScanner(ecsInstanceMountConfigPath, ctx, logger, ecsTaskInfoProvider, containerInstanceInfoProvider, refreshInterval)
}
