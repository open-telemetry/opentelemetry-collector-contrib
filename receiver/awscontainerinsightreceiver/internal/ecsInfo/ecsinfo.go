...
func NewECSInfo(refreshInterval time.Duration, hostIPProvider hostIPProvider, logger *zap.Logger, settings component.TelemetrySettings, options ...ecsInfoOption) (*EcsInfo, error) {
