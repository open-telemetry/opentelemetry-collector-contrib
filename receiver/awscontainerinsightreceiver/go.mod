...
replace github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awscontainerinsightreceiver/internal/host => ../../receiver/awscontainerinsightreceiver/internal/host
