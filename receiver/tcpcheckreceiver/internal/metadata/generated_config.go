...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		TcpcheckDuration: MetricConfig{
			...
			requiredAttributes:  []string{"tcpcheck.endpoint"},
			definedAttributes:   []string{"tcpcheck.endpoint"},
		...
		TcpcheckError: MetricConfig{
			...
			requiredAttributes:  []string{"tcpcheck.endpoint", "error.code"},
			definedAttributes:   []string{"tcpcheck.endpoint", "error.code"},
