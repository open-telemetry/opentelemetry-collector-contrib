	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordTcpcheckDurationDataPoint(ts, 3, "tcpcheck.endpoint-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordTcpcheckErrorDataPoint(ts, 3, "tcpcheck.endpoint-val", AttributeErrorCodeConnectionRefused)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordTcpcheckStatusDataPoint(ts, 3, "tcpcheck.endpoint-val")
			}
