...
var errConfigNotSSHCheck = errors.New("config was not a SSH check receiver config")
...
// TODO make sure this is all defaults
...
func createMetricsReceiver(ctx context.Context, params receiver.CreateSettings, rConf component.Config, consumer consumer.Metrics) (receiver.Metrics, error) {
	...
	scraper, err := scraperhelper.NewScraper(typeStr, tcpcheckScraper.scrape, scraperhelper.WithStart(tcpcheckScraper.start))
	if err != nil {
		return nil, err
	}
