...
| Status        |           |
| ------------- |-----------|
| Stability     | [alpha]: metrics, traces   |
...
| [Code Owners](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/main/CONTRIBUTING.md#becoming-a-code-owner)    | [@adrielp](https://www.github.com/adrielp), [@crobert-1](https://www.github.com/crobert-1), [@TylerHelmuth](https://www.github.com/TylerHelmuth) \| Seeking more code owners! |
...
| Step | `sha256("{check_run_id}-{step_name}-s")[16:32]` |
