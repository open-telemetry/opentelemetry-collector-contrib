...
func TestEnableSemConvMetricsFeatureGate(t *testing.T) {
	...
	assert.False(t, config.Metrics.ContainerCPUUtilization.Enabled)
	assert.True(t, config.Metrics.ContainerCPUUsage.Enabled)
...
func TestDisableSemConvMetricsFeatureGate(t *testing.T) {
	...
	assert.True(t, config.Metrics.ContainerCPUUtilization.Enabled)
	assert.False(t, config.Metrics.ContainerCPUUsage.Enabled)
