...
| **container.cpu.usage.system** | System CPU usage, as reported by docker. Note this is the usage for the system, not the container. Therefore they do not contain the same resource attributes as other metrics. | ns | Sum(Int) | <ul> </ul> |
