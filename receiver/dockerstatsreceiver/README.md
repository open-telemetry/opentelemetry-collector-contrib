...
| `cpu.usage.system` no longer has resource attributes. This is because it is a system-level metric and does not measure container usage. It exists as a means to compare container usage to overall system usage. | Remove dependence on any of the resource attributes. |
