...
- `api_version` (default = `"1.44"`): The Docker client API version (must be 1.44+). Must be input as a string, not a float (e.g. `"1.40"` instead of `1.40`). [Docker API versions](https://docs.docker.com/engine/api/).
