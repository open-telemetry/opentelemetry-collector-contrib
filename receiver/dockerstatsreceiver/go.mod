...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.108.0
	...
	go.opentelemetry.io/collector/filter v0.108.2-0.20240909182537-32cff9f7f331
