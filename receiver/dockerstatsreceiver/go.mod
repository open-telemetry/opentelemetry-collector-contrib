...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.126.0
	...
	go.opentelemetry.io/collector/filter v0.126.1-0.20250515040533-97a6accbc082
