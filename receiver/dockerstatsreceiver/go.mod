...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.120.1
	...
	go.opentelemetry.io/collector/filter v0.120.1-0.20250227143715-273742a419e2
