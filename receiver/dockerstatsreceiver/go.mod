...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker v0.99.0
	...
	go.opentelemetry.io/collector/filter v0.99.1-0.20240503164040-109173d9cf84
