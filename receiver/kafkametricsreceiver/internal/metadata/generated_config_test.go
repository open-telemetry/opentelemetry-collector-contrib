		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					KafkaBrokersConsumerFetchRate: MetricConfig{Enabled: true},
					KafkaBrokersCount:             MetricConfig{Enabled: true},
					KafkaBrokersIncomingByteRate:  MetricConfig{Enabled: true},
					KafkaBrokersOutgoingByteRate:  MetricConfig{Enabled: true},
					KafkaBrokersRequestLatency:    MetricConfig{Enabled: true},
					KafkaBrokersRequestRate:       MetricConfig{Enabled: true},
					KafkaBrokersRequestSize:       MetricConfig{Enabled: true},
					KafkaBrokersRequestsInFlight:  MetricConfig{Enabled: true},
					KafkaBrokersResponseRate:      MetricConfig{Enabled: true},
					KafkaBrokersResponseSize:      MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					KafkaBrokersConsumerFetchRate: MetricConfig{Enabled: false},
					KafkaBrokersCount:             MetricConfig{Enabled: false},
					KafkaBrokersIncomingByteRate:  MetricConfig{Enabled: false},
					KafkaBrokersOutgoingByteRate:  MetricConfig{Enabled: false},
					KafkaBrokersRequestLatency:    MetricConfig{Enabled: false},
					KafkaBrokersRequestRate:       MetricConfig{Enabled: false},
					KafkaBrokersRequestSize:       MetricConfig{Enabled: false},
					KafkaBrokersRequestsInFlight:  MetricConfig{Enabled: false},
					KafkaBrokersResponseRate:      MetricConfig{Enabled: false},
					KafkaBrokersResponseSize:      MetricConfig{Enabled: false},
