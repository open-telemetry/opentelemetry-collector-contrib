...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `receiver.kafkametricsreceiver.UseFranzGo` | stable | The Kafka Metrics receiver now uses the franz-go client to connect to Kafka. | v0.137.0 | v0.154.0 | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/41480) |
