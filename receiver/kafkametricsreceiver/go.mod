...
require (
	github.com/aws/aws-msk-iam-sasl-signer-go v1.0.2 // indirect
	...
	go.opentelemetry.io/collector/config/configtls v1.31.1-0.20250430101735-2ecd0b7f95cd // indirect
