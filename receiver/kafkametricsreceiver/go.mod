...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/kafka v0.157.0
	...
	go.opentelemetry.io/collector/receiver/xreceiver v0.157.1-0.20260803152855-18ed8fe814ea
