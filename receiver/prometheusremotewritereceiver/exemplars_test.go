...
func TestSetTraceAndSpan(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:              "short trace id is not zero padded and is kept as an attribute",
		...
		{
			name:              "long trace id is not truncated and is kept as an attribute",
		...
		{
			name:              "odd length trace id is kept as an attribute",
		...
		{
			name:              "non hex trace id is kept as an attribute",
		...
		{
			name:              "all zero trace id is not a valid id and is kept as an attribute",
		...
		{
			name:              "all zero span id is not a valid id and is kept as an attribute",
		...
		{
			name:              "short span id is not zero padded and is kept as an attribute",
