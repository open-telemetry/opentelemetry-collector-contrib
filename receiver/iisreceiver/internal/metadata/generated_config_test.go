...
func TestResourceAttributesConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name: "all_set",
			want: ResourceAttributesSettings{
				IisApplicationPool: ResourceAttributeSettings{Enabled: true},
				IisSite:            ResourceAttributeSettings{Enabled: true},
			},
		},
		{
			name: "none_set",
			want: ResourceAttributesSettings{
				IisApplicationPool: ResourceAttributeSettings{Enabled: false},
				IisSite:            ResourceAttributeSettings{Enabled: false},
			},
		},
	}
