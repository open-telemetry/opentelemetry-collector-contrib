...
func (receiver *pubsubReceiver) Start(ctx context.Context, _ component.Host) error {
	...
	if receiver.tracesConsumer != nil {
		...
		go createTracesReceiverHandler(receiver.tracesConsumer)
	}
	if receiver.metricsConsumer != nil {
		...
		go createMetricReceiverHandler(receiver.metricsConsumer)
	}
	if receiver.logsConsumer != nil {
		...
		go createLogReceiverHandler(receiver.logsConsumer)
	}
	return nil
}
