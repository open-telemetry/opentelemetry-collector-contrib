...
| remote                              | object       | Remote configuration for connecting to a remote machine to collect logs. Includes server (the address of the remote server) and credentials (with username, password, and optional domain).                                                    |
