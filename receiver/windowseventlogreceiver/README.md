...
| `rate_limit`                        | 0            | The maximum number of events allowed to be read per polling interval, see `poll_interval`. Zero means that there is no limit and the receiver will consume all events available.                                                               |
