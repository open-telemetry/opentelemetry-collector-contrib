...
| `receiver.windowseventlog.multipleRemoteHosts` | alpha | When enabled, allows configuring multiple remote hosts in a single receiver instance via the remote.servers configuration field. | v0.121.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/47933) |
