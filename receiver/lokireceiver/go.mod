...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.76.1
...
require go.opentelemetry.io/collector/pdata v1.0.0-rc9.0.20230426191218-56daa378f504
