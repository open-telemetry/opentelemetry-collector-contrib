...
func TestCreateReceiver(t *testing.T) {
	...
	lReceiver, err := createLogsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, mockLogsConsumer)
	assert.Nil(t, err, "receiver creation failed")
	assert.NotNil(t, lReceiver, "receiver creation failed")

	mockMetricsConsumer := consumertest.NewNop()
	mReceiver, err := createMetricsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, mockMetricsConsumer)
	assert.Nil(t, err, "receiver creation failed")
...
func TestCreateNilNextConsumerMetrics(t *testing.T) {
	...
	mReceiver, err := createMetricsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, nil)
...
func TestCreateMetricsReceiverWithBadConfig(t *testing.T) {
	...
	mReceiver, err := createMetricsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, consumertest.NewNop())
...
func TestCreateLogsReceiverWithBadConfig(t *testing.T) {
	...
	mReceiver, err := createLogsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, consumertest.NewNop())
	assert.EqualError(t, err, "unexpected end of input")
	assert.Nil(t, mReceiver, "receiver creation failed")
}
...
func TestCreateNilNextConsumerLogs(t *testing.T) {
	...
	mReceiver, err := createLogsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, nil)
...
func TestCreateBadEndpoint(t *testing.T) {
	...
	mockLogsConsumer := consumertest.NewNop()
	mReceiver, err := createLogsReceiver(context.Background(), component.ComponentSettings{Logger: zap.NewNop()}, cfg, mockLogsConsumer)
