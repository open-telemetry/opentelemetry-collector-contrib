...
func Test_splunkV2ToMetricsData(t *testing.T) {
	...
	buildDefaultSplunkDataPt := func() *splunkhecexporter.SplunkMetric {
		return &splunkhecexporter.SplunkMetric{
			Time:       sec,
			Host:       "localhost",
			Source:     "source",
	...
	tests := []struct {
		name                  string
		splunkDataPoints      *splunkhecexporter.SplunkMetric
		...
		{
			name: "multiple",
			splunkDataPoints: func() *splunkhecexporter.SplunkMetric {
...
func Test_buildPoint_errors(t *testing.T) {
	type args struct {
		splunkDataPoint *splunkhecexporter.SplunkMetric
	}
	tests := []struct {
		name    string
		args    args
