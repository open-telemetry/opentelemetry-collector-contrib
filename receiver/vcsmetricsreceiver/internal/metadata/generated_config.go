...
// MetricsConfig provides config for vcsmetrics metrics.
...
// ResourceAttributesConfig provides config for vcsmetrics resource attributes.
...
// MetricsBuilderConfig is a configuration for vcsmetrics metrics builder.
