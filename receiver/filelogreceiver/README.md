...
| `max_log_per_poll`                    | `0bytes`                             | The maximum log size per poll before logging a warning. A warning will be emitted if, during a filesystem poll, a log entry has exceeded this limit.                                                                                                            |
