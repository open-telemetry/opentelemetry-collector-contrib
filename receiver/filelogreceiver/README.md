...
| `max_surge_size`                      | 0                                    | The maximum surge size of a log file to read. log entries will be skipped if it is larger than `max_surge_size`. Protects against lagging behind when reading large log files.                                                                                  |
