...
| `force_flush_period`                | `500ms`                              | [Time](#time-parameters) since last token was emitted from the file, after which a partial log at the end of the file may be emitted.|
