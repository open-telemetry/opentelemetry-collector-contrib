...
| `ordering_criteria.sort_by.regex`     |                                      | Regular expression used for sorting, should contain a named capture group with the name `value` to perform operations against                                                                                                                                   |
