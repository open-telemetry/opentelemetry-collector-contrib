...
| `max_surge_size`                      |                                      | The maximum surge size of a log file to read. log entries will be skipped if it is larger than `max_surge_size`. Protects against lagging behind when reading large log files.                                                                                  |
