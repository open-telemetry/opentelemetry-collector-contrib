...
// MetricsConfig provides config for vcsprovider metrics.
...
// ResourceAttributesConfig provides config for vcsprovider resource attributes.
...
// MetricsBuilderConfig is a configuration for vcsprovider metrics builder.
