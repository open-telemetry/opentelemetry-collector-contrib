...
func parseCPUUtilizationNXOS(output string) (float64, error) {
	...
	return 0, errors.New("failed to parse CPU utilization from NX-OS output")
}
...
func parseCPUUtilizationIOS(output string) (float64, error) {
	...
	return 0, errors.New("failed to parse CPU utilization from IOS output")
}
...
func parseMemoryUtilizationNXOS(output string) (float64, error) {
	...
	return 0, errors.New("failed to parse memory utilization from NX-OS output")
}
...
func parseMemoryUtilizationIOS(output string) (float64, error) {
	...
	return 0, errors.New("failed to parse memory utilization from IOS output")
}
