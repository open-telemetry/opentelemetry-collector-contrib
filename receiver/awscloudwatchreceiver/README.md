...
The AWS CloudWatch Receiver collects logs and metrics from [AWS CloudWatch](https://aws.amazon.com/cloudwatch/).
Logs are retrieved via the [CloudWatch Logs API](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/Welcome.html).
Metrics are retrieved via [GetMetricData](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_GetMetricData.html),
with optional metric discovery via [ListMetrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_ListMetrics.html).
