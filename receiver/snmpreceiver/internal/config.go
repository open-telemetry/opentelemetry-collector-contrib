...
type Config struct {
	...
	Endpoint string `toml:"version"`

	// Values: 1, v2c, 3. Default: v2c
	...
	// Only valid for version “v3” and if “no_auth_no_priv” not selected for security_level
	// Valid Options:“md5”, “sha”, “sha224”, “sha256”, “sha384”, “sha512”
	AuthenticationType string `toml:"authentication_type"`
	...
	PrivacyType string `toml:"privacy_type"`

	// Only valid if privacy_type specified
	PrivacyPassword string `toml:"privacy_password"`

	//	Resource Attributes
	ResourceAttributes map[string]ResourceAttribute
...
type ResourceAttribute struct {
	...
	IndexedValuePrefix string `indexed_value_prefix:"oid"` // required and valid if no oid field
}
