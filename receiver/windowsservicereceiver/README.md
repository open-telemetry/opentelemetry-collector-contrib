...
> [!WARNING]
> The receiver type has been renamed from `windowsservice` to `windows_service`. The old name is still supported
> as a deprecated alias but will be removed in a future release. Please update your configuration.
