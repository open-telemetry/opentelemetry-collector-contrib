...
// MasterNode provides a mock function with given fields: ctx
func (_m *MockElasticsearchClient) MasterNode(ctx context.Context) (*model.MasterNodeResponse, error) {
	ret := _m.Called(ctx)

	var r0 *model.MasterNodeResponse
	if rf, ok := ret.Get(0).(func(context.Context) *model.MasterNodeResponse); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.MasterNodeResponse)
		}
	}
