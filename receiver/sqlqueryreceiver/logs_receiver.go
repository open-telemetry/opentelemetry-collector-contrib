...
func (queryReceiver *logsQueryReceiver) start(ctx context.Context) error {
	...
	queryReceiver.client = queryReceiver.createClient(sqlquery.DbWrapper{queryReceiver.db}, queryReceiver.query.SQL, queryReceiver.logger, queryReceiver.telemetry)
