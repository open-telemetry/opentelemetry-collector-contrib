...
func TestNewTracesReceiver_version_err(t *testing.T) {
	...
	r, err := newTracesReceiver(c, receivertest.NewNopSettingsWithType(metadata.Type), consumertest.NewNop())
...
func TestNewMetricsReceiver_version_err(t *testing.T) {
	...
	r, err := newMetricsReceiver(c, receivertest.NewNopSettingsWithType(metadata.Type), consumertest.NewNop())
	require.NoError(t, err)
	err = r.Start(context.Background(), componenttest.NewNopHost())
	assert.Error(t, err)
}
...
func TestNewLogsReceiver_version_err(t *testing.T) {
	...
	r, err := newLogsReceiver(c, receivertest.NewNopSettingsWithType(metadata.Type), consumertest.NewNop())
	require.NoError(t, err)
	require.NotNil(t, r)
	err = r.Start(context.Background(), componenttest.NewNopHost())
	assert.Error(t, err)
...
func TestCreateLogs_encoding_text_error(t *testing.T) {
	...
	r, err := newLogsReceiver(cfg, receivertest.NewNopSettingsWithType(metadata.Type), consumertest.NewNop())
	require.NoError(t, err)
	require.NotNil(t, r)
	err = r.Start(context.Background(), componenttest.NewNopHost())
