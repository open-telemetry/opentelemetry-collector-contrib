...
- `group_rebalance_strategy` (default = `range`): This strategy used to assign partitions to consumers within a consumer group. This setting determines how Kafka distributes topic partitions among the consumers in the group during rebalances. Supported strategies are:
