...
- `connection_idle_timeout` (default = `9m`): The time after which idle connections to Kafka brokers are closed. Note: The connection may be closed between 0.5x-1x of the configured value.
