...
func TestWithTracesUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		require.True(t, ok)
		require.Equal(t, defaultTracesTopic, tracesConsumer.config.TracesTopic)
		require.NoError(t, err)
...
func TestWithMetricsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		require.True(t, ok)
		require.Equal(t, defaultMetricsTopic, metricsConsumer.config.MetricsTopic)
		require.NoError(t, err)
		require.NotNil(t, receiver)
	})
	t.Run("default_encoding", func(t *testing.T) {
...
func TestWithLogsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		...
		require.True(t, ok)
		require.Equal(t, defaultLogsTopic, logsConsumer.config.LogsTopic)
		require.NoError(t, err)
		require.NotNil(t, receiver)
	})
	t.Run("default_encoding", func(t *testing.T) {
