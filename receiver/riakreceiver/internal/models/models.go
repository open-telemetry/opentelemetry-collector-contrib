...
package models // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/raikreceiver/internal/models"

// Stat represents a queue in the API response
type Stats struct {
	// Identifiers
