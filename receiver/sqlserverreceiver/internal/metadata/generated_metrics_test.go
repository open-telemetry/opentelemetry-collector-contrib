...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverDatabaseCountDataPoint(ts, "3", AttributeDatabaseStatusOnline)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverDatabaseIoDataPoint(ts, "3", "physical_filename-val", "logical_filename-val", "file_type-val", AttributeDirectionRead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverDatabaseLatencyDataPoint(ts, 3, "physical_filename-val", "logical_filename-val", "file_type-val", AttributeDirectionRead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverDatabaseOperationsDataPoint(ts, "3", "physical_filename-val", "logical_filename-val", "file_type-val", AttributeDirectionRead)
			}

			allMetricsCount++
			mb.RecordSqlserverDatabaseTempdbSpaceDataPoint(ts, 1, AttributeTempdbStateFree)
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverDatabaseTempdbSpaceDataPoint(ts, 3, AttributeTempdbStateFree)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverOsWaitDurationDataPoint(ts, 3, "wait.category-val", "wait.type-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverPageLifeExpectancyDataPoint(ts, 3, "performance_counter.object_name-val")
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverPageOperationRateDataPoint(ts, 3, AttributePageOperationsRead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverReplicaDataRateDataPoint(ts, 3, AttributeReplicaDirectionTransmit)
			}

			allMetricsCount++
			mb.RecordSqlserverResourcePoolDiskOperationsDataPoint(ts, 1, AttributeDirectionRead)
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverResourcePoolDiskOperationsDataPoint(ts, 3, AttributeDirectionRead)
			}
			...
			if tt.name == "reaggregate_set" {
				mb.RecordSqlserverTableCountDataPoint(ts, 3, AttributeTableStateActive, AttributeTableStatusTemporary)
			}
