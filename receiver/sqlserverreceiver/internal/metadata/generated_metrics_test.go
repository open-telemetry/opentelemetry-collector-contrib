...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			allMetricsCount++
			mb.RecordSqlserverDatabaseDeadlockRateDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverDatabaseExecutionErrorsCountDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverDatabaseFreeSpaceTempdbDataPoint(ts, 1)
			...
			allMetricsCount++
			mb.RecordSqlserverDatabaseLockTimeoutRateDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverDatabaseLoginRateDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverDatabaseLogoutRateDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverDatabaseMirrorWriteTransactionRateDataPoint(ts, 1)
			...
			allMetricsCount++
			mb.RecordSqlserverDatabaseVersionStoreSizeDataPoint(ts, 1)
			...
			allMetricsCount++
			mb.RecordSqlserverMemoryFreeListStallsRateDataPoint(ts, 1)
			...
			allMetricsCount++
			mb.RecordSqlserverReplicaReceivedRateDataPoint(ts, 1)

			allMetricsCount++
			mb.RecordSqlserverReplicaSentRateDataPoint(ts, 1)
			...
			for i := 0; i < ms.Len(); i++ {
				...
				case "sqlserver.database.deadlock.rate":
					assert.False(t, validatedMetrics["sqlserver.database.deadlock.rate"], "Found a duplicate in the metrics slice: sqlserver.database.deadlock.rate")
					validatedMetrics["sqlserver.database.deadlock.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.database.execution_errors.count":
					assert.False(t, validatedMetrics["sqlserver.database.execution_errors.count"], "Found a duplicate in the metrics slice: sqlserver.database.execution_errors.count")
					validatedMetrics["sqlserver.database.execution_errors.count"] = true
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
					assert.Equal(t, int64(1), dp.IntValue())
				case "sqlserver.database.free_space_tempdb":
					assert.False(t, validatedMetrics["sqlserver.database.free_space_tempdb"], "Found a duplicate in the metrics slice: sqlserver.database.free_space_tempdb")
					validatedMetrics["sqlserver.database.free_space_tempdb"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
				...
				case "sqlserver.database.full_scan.rate":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "The number of unrestricted full table or index scans per second.", ms.At(i).Description())
				...
				case "sqlserver.database.latency":
					...
					assert.True(t, ok)
					assert.EqualValues(t, "read", attrVal.Str())
				case "sqlserver.database.lock_timeout.rate":
					assert.False(t, validatedMetrics["sqlserver.database.lock_timeout.rate"], "Found a duplicate in the metrics slice: sqlserver.database.lock_timeout.rate")
					validatedMetrics["sqlserver.database.lock_timeout.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.database.login.rate":
					assert.False(t, validatedMetrics["sqlserver.database.login.rate"], "Found a duplicate in the metrics slice: sqlserver.database.login.rate")
					validatedMetrics["sqlserver.database.login.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.database.logout.rate":
					assert.False(t, validatedMetrics["sqlserver.database.logout.rate"], "Found a duplicate in the metrics slice: sqlserver.database.logout.rate")
					validatedMetrics["sqlserver.database.logout.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.database.mirror_write_transaction.rate":
					assert.False(t, validatedMetrics["sqlserver.database.mirror_write_transaction.rate"], "Found a duplicate in the metrics slice: sqlserver.database.mirror_write_transaction.rate")
					validatedMetrics["sqlserver.database.mirror_write_transaction.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
				...
				case "sqlserver.database.operations":
					...
					assert.True(t, ok)
					assert.EqualValues(t, "read", attrVal.Str())
				case "sqlserver.database.version_store_size":
					assert.False(t, validatedMetrics["sqlserver.database.version_store_size"], "Found a duplicate in the metrics slice: sqlserver.database.version_store_size")
					validatedMetrics["sqlserver.database.version_store_size"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
				...
				case "sqlserver.index.search.rate":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of index searches per second.", ms.At(i).Description())
				...
				case "sqlserver.lock.wait_time.avg":
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.memory.free_list_stalls.rate":
					assert.False(t, validatedMetrics["sqlserver.memory.free_list_stalls.rate"], "Found a duplicate in the metrics slice: sqlserver.memory.free_list_stalls.rate")
					validatedMetrics["sqlserver.memory.free_list_stalls.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
					assert.Equal(t, int64(1), dp.IntValue())
				case "sqlserver.memory.grants_pending.count":
					assert.False(t, validatedMetrics["sqlserver.memory.grants_pending.count"], "Found a duplicate in the metrics slice: sqlserver.memory.grants_pending.count")
					validatedMetrics["sqlserver.memory.grants_pending.count"] = true
					assert.Equal(t, pmetric.MetricTypeSum, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Sum().DataPoints().Len())
				...
				case "sqlserver.page.lookup.rate":
					...
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					assert.Equal(t, "Total number of page lookups per second.", ms.At(i).Description())
				...
				case "sqlserver.processes.blocked":
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeInt, dp.ValueType())
					assert.Equal(t, int64(1), dp.IntValue())
				case "sqlserver.replica.received.rate":
					assert.False(t, validatedMetrics["sqlserver.replica.received.rate"], "Found a duplicate in the metrics slice: sqlserver.replica.received.rate")
					validatedMetrics["sqlserver.replica.received.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
					...
					assert.Equal(t, pmetric.NumberDataPointValueTypeDouble, dp.ValueType())
					assert.InDelta(t, float64(1), dp.DoubleValue(), 0.01)
				case "sqlserver.replica.sent.rate":
					assert.False(t, validatedMetrics["sqlserver.replica.sent.rate"], "Found a duplicate in the metrics slice: sqlserver.replica.sent.rate")
					validatedMetrics["sqlserver.replica.sent.rate"] = true
					assert.Equal(t, pmetric.MetricTypeGauge, ms.At(i).Type())
					assert.Equal(t, 1, ms.At(i).Gauge().DataPoints().Len())
