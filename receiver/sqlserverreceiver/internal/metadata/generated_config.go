...
func DefaultMetricsConfig() MetricsConfig {
	return MetricsConfig{
		...
		SqlserverDatabaseCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"database.status"},
		...
		SqlserverDatabaseIo: MetricConfig{
			...
			requiredAttributes:  []string{"physical_filename", "logical_filename", "file_type", "direction"},
		...
		SqlserverDatabaseTempdbSpace: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"tempdb.state"},
		...
		SqlserverOsWaitDuration: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"wait.category", "wait.type"},
		...
		SqlserverPageLifeExpectancy: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"performance_counter.object_name"},
		...
		SqlserverReplicaDataRate: MetricConfig{
			...
			AggregationStrategy: AggregationStrategyAvg,
			requiredAttributes:  []string{"replica.direction"},
		...
		SqlserverTableCount: MetricConfig{
			...
			AggregationStrategy: AggregationStrategySum,
			requiredAttributes:  []string{"table.state", "table.status"},
