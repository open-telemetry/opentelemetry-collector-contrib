	...
	for i, row := range rows {
		...
		case bytesReceivedFromReplicaPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverReplicaReceivedRateDataPoint(now, val)
			}
		case bytesSentForReplicaPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverReplicaSentRateDataPoint(now, val)
			}
		...
		case executionErrors:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseExecutionErrorsCountDataPoint(now, val)
			}
		case freeListStalls:
			val, err := strconv.ParseInt(row[valueKey], 10, 64)
			if err != nil {
				...
				s.mb.RecordSqlserverMemoryFreeListStallsRateDataPoint(now, val)
			}
		...
		case freeSpaceInTempdb:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseFreeSpaceTempdbDataPoint(now, val)
			}
		...
		case lockTimeoutsPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseLockTimeoutRateDataPoint(now, val)
			}
		case lockWaits:
			val, err := strconv.ParseFloat(row[valueKey], 64)
			if err != nil {
		...
		case loginsPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseLoginRateDataPoint(now, val)
			}
		case logoutPerSec:
			val, err := strconv.ParseFloat(row[valueKey], 64)
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseLogoutRateDataPoint(now, val)
			}
		...
		case mirrorWritesTransactionPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseMirrorWriteTransactionRateDataPoint(now, val)
			}
		case numberOfDeadlocksPerSec:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseDeadlockRateDataPoint(now, val)
			}
		...
		case versionStoreSize:
			...
			if err != nil {
				...
				s.mb.RecordSqlserverDatabaseVersionStoreSizeDataPoint(now, val)
			}
		}
