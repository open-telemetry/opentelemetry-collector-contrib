...
func (s *sqlServerScraperHelper) recordDiskIOMetrics(ctx context.Context) error {
	...
	for i, row := range rows {
		...
		if err != nil {
			...
			s.mb.RecordSqlserverDiskIoOperationsDataPoint(now, rOps.(int64), metadata.AttributeDirectionRead, drive)
		}
		...
		if err != nil {
			...
			s.mb.RecordSqlserverDiskIoOperationsDataPoint(now, wOps.(int64), metadata.AttributeDirectionWrite, drive)
		}
		...
		if err != nil {
			...
			s.mb.RecordSqlserverDiskIoBytesDataPoint(now, rBytes.(int64), metadata.AttributeDirectionRead, drive)
		}
		...
		if err != nil {
			...
			s.mb.RecordSqlserverDiskIoBytesDataPoint(now, wBytes.(int64), metadata.AttributeDirectionWrite, drive)
		}
