...
| service.name | Logical name of the service. When enabled, the receiver sets this to the db.system.name value for SQL Server: microsoft.sql_server. | Any Str | false | - |
