...
| ---- | ----------- | ------ | ------- | ------------------- | --------- |
| db.system.version | The version of the SQL Server instance (e.g. "15.0.4261.1"). Only available in direct connection mode, not Windows Performance Counter mode. | Any Str | true | - | - |
