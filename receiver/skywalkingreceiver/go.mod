module github.com/domleb/opentelemetry-collector-contrib/receiver/skywalkingreceiver
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/skywalking v0.122.0
