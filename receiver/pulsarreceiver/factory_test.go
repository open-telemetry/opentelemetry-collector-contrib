...
func Test_CreateTraceReceiver(t *testing.T) {
	cfg := createDefaultConfig().(*Config)
	f := pulsarReceiverFactory{tracesUnmarshalers: defaultTracesUnmarshalers()}
	recv, err := f.createTracesReceiver(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, nil)
...
func Test_CreateMetrics(t *testing.T) {
	...
	recv, err := f.createMetricsReceiver(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, nil)
	require.NoError(t, err)
	assert.NotNil(t, recv)
}
...
func Test_CreateLogs(t *testing.T) {
	...
	f := pulsarReceiverFactory{logsUnmarshalers: defaultLogsUnmarshalers()}
	recv, err := f.createLogsReceiver(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, nil)
	require.NoError(t, err)
	assert.NotNil(t, recv)
}
...
func TestWithLogsUnmarshalers(t *testing.T) {
	...
	t.Run("custom_encoding", func(t *testing.T) {
		cfg.Encoding = unmarshaler.Encoding()
		exporter, err := f.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, nil)
		require.NoError(t, err)
