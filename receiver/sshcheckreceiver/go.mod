...
require (
	...
	go.opentelemetry.io/collector/extension/auth/authtest v0.118.1-0.20250124013028-e8807bfe9423
	go.opentelemetry.io/collector/filter v0.118.1-0.20250124013028-e8807bfe9423
