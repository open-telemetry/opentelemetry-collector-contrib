...
One way those with triager permissions in the Collector contrib can help move issues along is through adding missing component labels,
...
| `needs triage`       | An issue should be considered triaged when it has been validated to be a genuine bug or enhancement that the maintainers or code owners expect will be worked on.                                       |
