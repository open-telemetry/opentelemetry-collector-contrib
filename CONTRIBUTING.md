...
All `./unreleased/*.yaml` files are removed during the release process, as they are added to `CHANGELOG.md`.

Your pull-request should add a new `.yaml` file to the `./unreleased` directory. The name of your file must be unique since the last release.
