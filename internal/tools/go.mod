...
require (
	...
	go.opentelemetry.io/collector/cmd/builder v0.146.2-0.20260301214332-7a2d8b5a5cac // indirect
	go.opentelemetry.io/collector/cmd/mdatagen v0.146.2-0.20260301214332-7a2d8b5a5cac // indirect
