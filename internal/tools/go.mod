...
require (
	...
	go.opentelemetry.io/collector/cmd/builder v0.160.1-0.20260911221045-a35b7a8db49d // indirect
	go.opentelemetry.io/collector/cmd/mdatagen v0.160.1-0.20260911221045-a35b7a8db49d // indirect
	...
	go.opentelemetry.io/collector/internal/schemagen v0.160.1-0.20260911221045-a35b7a8db49d // indirect
