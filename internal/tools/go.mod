...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/codecovgen v0.143.0
	github.com/open-telemetry/opentelemetry-collector-contrib/cmd/schemagen v0.143.0
	...
	go.opentelemetry.io/collector/cmd/builder v0.143.1-0.20260115162016-5e41fb551263
	go.opentelemetry.io/collector/cmd/mdatagen v0.143.1-0.20260115162016-5e41fb551263
