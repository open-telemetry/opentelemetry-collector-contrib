...
require (
	...
	go.opentelemetry.io/collector/cmd/builder v0.147.1-0.20260313183754-7cd8f588399b // indirect
	go.opentelemetry.io/collector/cmd/mdatagen v0.147.1-0.20260313183754-7cd8f588399b // indirect
