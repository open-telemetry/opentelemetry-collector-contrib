...
func TestGetMetadataFromImds(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			client: func(t *testing.T) ImdsGetMetadataAPI {
				return mockGetMetadataAPI(func(ctx context.Context, params *imds.GetMetadataInput, optFns ...func(*imds.Options)) (*imds.GetMetadataOutput, error) {
					t.Helper()
...
func TestInstanceIdentityDocumentFromImds(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			client: func(t *testing.T) ImdsInstanceIdentityDocumentAPI {
				return mockInstanceIdentityDocumentAPI(func(ctx context.Context, params *imds.GetInstanceIdentityDocumentInput, optFns ...func(*imds.Options)) (*imds.GetInstanceIdentityDocumentOutput, error) {
					t.Helper()
