...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/scraperhelper v0.36.1-0.20211014132958-f89d7a10d861
...
require (
	...
	go.opentelemetry.io/collector v0.36.1-0.20211004155959-190f8fbb2b9a // indirect
