...
// MetricsConfig provides config for docker/receiver metrics.
...
// ResourceAttributesConfig provides config for docker/receiver resource attributes.
...
// MetricsBuilderConfig is a configuration for docker/receiver metrics builder.
