...
package receiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker/receiver"
...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/internal/docker/receiver/internal/metadata"
)

var (
	// FIXME: type and stability level originally were taken from generated code
	// 		  but here we don't have status defined in metadata.yaml, so these weren't generated
