...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/otelarrowreceiver v0.102.0
...
require (
	...
	go.opentelemetry.io/collector/confmap v0.102.2-0.20240611143128-7dfb57b9ad1c // indirect
