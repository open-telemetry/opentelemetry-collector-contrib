...
func appendOnpremVMAttributes(attrMap pcommon.Map) {
	...
	subMap := attrMap.UpsertEmptyMap(conventions.AttributeHostName)
	subMap.UpsertString("public", "tc-prod9.internal.example.com")
	subMap.UpsertString("internal", "172.18.36.18")
...
func appendExecAttributes(attrMap pcommon.Map) {
	...
	parts := attrMap.UpsertEmptySlice(conventions.AttributeProcessCommandLine)
