...
import (
	...
	"github.com/cloudoperators/opentelemetry-collector-contrib/internal/coreinternal/testdata"
)
...
func TestConsumeLogs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := consumer.ConsumeLogs(t.Context(), testdata.GenerateLogsTwoLogRecordsSameResource())
...
func TestConsumeLogs_PartialRetry(t *testing.T) {
	...
	assert.NoError(t, consumer.ConsumeLogs(t.Context(), logs))
