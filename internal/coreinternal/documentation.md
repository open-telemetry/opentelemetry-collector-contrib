...
| ------------ | ----- | ----------- | ------------ | ---------- | --------- |
| `internal.coreinternal.goldendataset.DontEmitV0HTTPConventions` | beta | When enabled, goldendataset no longer generates spans with deprecated semconv HTTP attribute http.flavor (semconv v1.19.0). | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45294) |
| `internal.coreinternal.goldendataset.DontEmitV0MessagingConventions` | beta | When enabled, goldendataset no longer generates spans with deprecated semconv messaging attributes messaging.destination and messaging.destination.kind. | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45294) |
...
| `internal.coreinternal.goldendataset.EmitV1HTTPConventions` | beta | When enabled, goldendataset generates spans with network.protocol.version (semconv v1.40.0) alongside legacy http.flavor (semconv v1.19.0) to support migration. | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45294) |
| `internal.coreinternal.goldendataset.EmitV1MessagingConventions` | beta | When enabled, goldendataset generates spans with messaging.destination.name (semconv v1.40.0) alongside legacy messaging.destination and messaging.destination.kind to support migration. | v0.152.0 | N/A | [Link](https://github.com/open-telemetry/opentelemetry-collector-contrib/issues/45294) |
