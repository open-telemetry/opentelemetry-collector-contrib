...
func fillSpanOne(span ptrace.Span) {
	...
	ev0.Attributes().UpsertString("span-event-attr", "span-event-attr-val")
...
func fillSpanTwo(span ptrace.Span) {
	...
	link0.Attributes().UpsertString("span-link-attr", "span-link-attr-val")
...
func fillSpanThree(span ptrace.Span) {
	...
	span.SetStartTimestamp(TestSpanStartTimestamp)
	span.SetEndTimestamp(TestSpanEndTimestamp)
	span.Attributes().UpsertString("span-attr", "span-attr-val")
