...
const (
	...
	PodStatusReady           = "pod_status_ready"
	PodStatusScheduled       = "pod_status_scheduled"
	PodStatusInitialized     = "pod_status_initialized"
	PodStatusDisruption      = "pod_status_disruption"
	PodStatusContainersReady = "pod_status_containers_ready"
	PodStatusRunning         = "pod_status_running"
	PodStatusSucceeded       = "pod_status_succeeded"
	PodStatusPending         = "pod_status_pending"
	PodStatusFailed          = "pod_status_failed"
	PodStatusUnknown         = "pod_status_unknown"
