...
var (
	...
	azureResource = func() pcommon.Resource {
		...
		attrs.PutStr(string(conventions.CloudProviderKey), string(conventions.CloudProviderAzureKey))
		attrs.PutStr(string(conventions.CloudPlatformKey), string(conventions.CloudPlatformAzureVMKey))
