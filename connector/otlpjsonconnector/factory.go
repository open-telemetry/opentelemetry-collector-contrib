...
var logRegex = regexp.MustCompile(`resourceLogs"\s*:\s*\[`)
var metricRegex = regexp.MustCompile(`resourceMetrics"\s*:\s*\[`)
var traceRegex = regexp.MustCompile(`resourceSpans"\s*:\s*\[`)
