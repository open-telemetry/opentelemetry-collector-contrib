...
logs, or metrics). Partial consumption of signals are allowed i.e. if the component
successfully consumes part of the signal, producing a partial metric, then the
produced metric is forwarded to the next component with a warning log.
