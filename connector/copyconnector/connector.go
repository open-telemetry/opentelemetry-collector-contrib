...
package copyconnector // import "github.com/open-telemetry/opentelemetry-collector-contrib/connector/copyconnector"
...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/connector/copyconnector/internal/cache"
	"github.com/open-telemetry/opentelemetry-collector-contrib/connector/copyconnector/internal/metrics"
...
func (p *connectorImp) buildMetrics() pmetric.Metrics {
	...
	for _, rawMetrics := range p.resourceMetrics {
		...
		sm.Scope().SetName("copyconnector")
