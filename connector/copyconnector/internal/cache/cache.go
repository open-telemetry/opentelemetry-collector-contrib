...
package cache // import "github.com/open-telemetry/opentelemetry-collector-contrib/connector/copyconnector/internal/cache"
...
// map. In copyconnector's use case, we need to hold all the items during the current processing step for
