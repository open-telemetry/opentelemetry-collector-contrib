...
func (c *t2l) ConsumeTraces(ctx context.Context, td ptrace.Traces) error { return c.eng.ConsumeTraces(ctx, td) }
...
func (c *t2m) ConsumeTraces(ctx context.Context, td ptrace.Traces) error { return c.eng.ConsumeTraces(ctx, td) }
...
func (c *m2m) ConsumeMetrics(ctx context.Context, md pmetric.Metrics) error { return c.eng.ConsumeMetrics(ctx, md) }
...
func (c *m2l) ConsumeMetrics(ctx context.Context, md pmetric.Metrics) error { return c.eng.ConsumeMetrics(ctx, md) }
