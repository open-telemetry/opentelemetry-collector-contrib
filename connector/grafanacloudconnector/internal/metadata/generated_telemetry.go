...
const ScopeName = "github.com/open-telemetry/opentelemetry-collector-contrib/connector/grafanacloudconnector"
...
func NewTelemetryBuilder(settings component.TelemetrySettings, options ...telemetryBuilderOption) (*TelemetryBuilder, error) {
	...
	errs = errors.Join(errs, err)
	_, err = builder.meter.RegisterCallback(builder.observeGrafanacloudHostCount, builder.GrafanacloudHostCount)
	errs = errors.Join(errs, err)
	return &builder, errs
}
