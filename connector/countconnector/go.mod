module github.com/asserts/opentelemetry-collector-contrib/connector/countconnector
...
require (
	...
	github.com/asserts/opentelemetry-collector-contrib/pkg/pdatautil v0.0.0-00010101000000-000000000000 // indirect
