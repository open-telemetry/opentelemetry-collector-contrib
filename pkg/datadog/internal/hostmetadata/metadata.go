...
import (
	...
	"github.com/open-telemetry/opentelemetry-collector-contrib/pkg/datadog/internal/hostmetadata/internal/gohai"
...
func metadataFromAttributes(attrs pcommon.Map) payload.HostMetadata {
	...
	if src, ok := attributes.SourceFromAttrs(attrs, nil); ok && src.Kind == source.HostnameKind {
