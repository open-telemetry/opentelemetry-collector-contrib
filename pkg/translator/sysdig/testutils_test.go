...
var (
	...
	metadataMap = map[string]*prompb.MetricMetadata{
		"Gauge" + "-" + label11 + "-" + value11 + "-" + label12 + "-" + value12: getMetadata(validMetrics1[validDoubleGauge]),
		"Gauge" + "-" + label21 + "-" + value21 + "-" + label22 + "-" + value22: getMetadata(validMetrics1[validDoubleGauge]),
	}
)
