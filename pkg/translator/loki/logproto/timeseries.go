...
// PreallocConfig configures how structures will be preallocated to optimize
// proto unmarshalling.
...
// LabelAdapter is a labels.Label that can be marshaled to/from protos.
...
// Unmarshal a LabelAdapter, implements proto.Unmarshaler.
