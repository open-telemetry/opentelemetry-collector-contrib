...
func TestUnmarshalLogs_ResourceHealthLog(t *testing.T) {
	t.Parallel()

	dir := "testdata/resourcehealthlog"
	tests := map[string]struct {
		logFilename      string
		expectedFilename string
		expectsErr       string
...
func TestUnmarshalLogs_ServiceHealthLog(t *testing.T) {
	t.Parallel()

	dir := "testdata/servicehealthlog"
	tests := map[string]struct {
		logFilename      string
		expectedFilename string
		expectsErr       string
