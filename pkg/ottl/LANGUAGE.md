...
A `pcommon.Value` is compared by extracting its underlying typed value and then applying the comparison rules for that type. When two `pcommon.Value` instances share the same underlying type, they are compared directly. A `pcommon.Value` with `ValueTypeEmpty` is considered equivalent to nil.
...
| base type      | bool        | int64               | float64             | string                          | Bytes                    | nil                    | time.Time                            | time.Duration                                        | map[string]any                                               | pcommon.Map                                                  | []any                                                          | pcommon.Slice                                                  | pcommon.Value                                                          |
|----------------|-------------|---------------------|---------------------|---------------------------------|--------------------------|------------------------|--------------------------------------|------------------------------------------------------|--------------------------------------------------------------|--------------------------------------------------------------|----------------------------------------------------------------|----------------------------------------------------------------|------------------------------------------------------------------------|
| bool           | normal, T>F | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | extract value, compared as bool if compatible                          |
| int64          | not equal   | compared as largest | compared as float64 | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | extract value, compared as numeric if compatible                       |
| float64        | not equal   | compared as float64 | compared as largest | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | extract value, compared as numeric if compatible                       |
| string         | not equal   | not equal           | not equal           | normal (compared as Go strings) | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | extract value, compared as Go strings if compatible                    |
| Bytes          | not equal   | not equal           | not equal           | not equal                       | byte-for-byte comparison | []byte(nil) == nil     | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | extract value, byte-for-byte comparison if compatible                  |
| nil            | not equal   | not equal           | not equal           | not equal                       | []byte(nil) == nil       | true for equality only | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | ValueTypeEmpty == nil                                                  |
| time.Time      | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | uses `time.Equal()`to check equality | not equal                                            | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | not equal                                                              |
| time.Duration  | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | uses `time.Before()` and `time.After` for comparison | not equal                                                    | not equal                                                    | not equal                                                      | not equal                                                      | not equal                                                              |
| map[string]any | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | uses reflect.DeepEqual for comparison                        | convert to raw map and uses reflect.DeepEqual for comparison | not equal                                                      | not equal                                                      | extract value, convert to raw map and uses reflect.DeepEqual if compatible |
| pcommon.Map    | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | convert to raw map and uses reflect.DeepEqual for comparison | uses pcommon.Map Equal for comparison                        | not equal                                                      | not equal                                                      | extract value, uses pcommon.Map Equal for comparison if compatible     |
| []any          | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | uses reflect.DeepEqual for comparison                          | convert to raw slice and uses reflect.DeepEqual for comparison | extract value, convert to raw slice and uses reflect.DeepEqual if compatible |
| pcommon.Slice  | not equal   | not equal           | not equal           | not equal                       | not equal                | not equal              | not equal                            | not equal                                            | not equal                                                    | not equal                                                    | convert to raw slice and uses reflect.DeepEqual for comparison | uses pcommon.Slice Equal for comparison                        | extract value, uses pcommon.Slice Equal for comparison if compatible   |
| pcommon.Value  | extract value, compared as bool if compatible | extract value, compared as numeric if compatible | extract value, compared as numeric if compatible | extract value, compared as Go strings if compatible | extract value, byte-for-byte comparison if compatible | ValueTypeEmpty == nil | not equal                            | not equal                                            | extract value, convert to raw map and uses reflect.DeepEqual if compatible | extract value, uses pcommon.Map Equal for comparison if compatible | extract value, convert to raw slice and uses reflect.DeepEqual if compatible | extract value, uses pcommon.Slice Equal for comparison if compatible | extract both values, compared using underlying type rules              |
