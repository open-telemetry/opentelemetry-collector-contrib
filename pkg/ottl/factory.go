...
type Factory[K any] interface {
	...
	// Experimental reports whether the function generated by this Factory is
	// experimental and therefore not covered by the OTTL 1.0 stability
	// guarantee. If a function is experimental its name, arguments,
	// and behavior may change or be removed.
	Experimental() bool
...
func (f *factory[K]) Experimental() bool {
...
// WithExperimental marks the function generated by the Factory as experimental.
// Experimental functions are not covered by the OTTL 1.0 stability guarantee.
func WithExperimental[K any]() FactoryOption[K] {
