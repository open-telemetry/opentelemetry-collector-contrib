...
If you're looking to write OTTL statement's for a component's configuration checkout these resources.
...
If you're looking to use OTTL in your component checkout [the grammar](./GRAMMAR.md).
