...
package ottlgrammar // import "github.com/open-telemetry/opentelemetry-collector-contrib/pkg/ottl/internal/ottlgrammar"
...
func newParser() *participle.Parser[ParsedQuery] {
	...
	if err != nil {
		panic("Unable to initialize parser; this is a programming error in the ottl:" + err.Error())
	}
	return parser
}

var ParserSingleton = newParser()
