...
| span.*                                 | All fields exposed by the [ottlspan context](https://github.com/asserts/opentelemetry-collector-contrib/tree/main/pkg/ottl/contexts/ottlspan) can accessed via `span.` | varies                                                                  |
