...
| profilesample.timestamps_unix_nano       | the timestamps associcated with sample being processed.                                                                                            | []int64                                                                 |
| profilesample.timestamps                 | the timestamps associcated with sample being processed.                                                                                            | []int64                                                                 |
