...
| profile.location_indices                 | the location indices of the profile being processed                                                                                                | pcommon.Int32Slice                                                      |
...
| profile.string_table                     | the string table of the profile being processed                                                                                                    | pcommon.StringSlice                                                     |
| profile.time_unix_nano                   | the time in unix nano of the profile being processed                                                                                               | int64                                                                   |
| profile.time                             | the time of the profile being processed                                                                                                            | time.Time                                                               |
| profile.duration                         | the duration in nanoseconds of the profile being processed                                                                                         | pcommon.Timestamp                                                       |
...
| profile.comment_string_indices           | the comment string indices of the profile being processed                                                                                          | pcommon.Int32Slice                                                      |
| profile.default_sample_type_string_index | the default sample type string index of the profile being processed                                                                                | int32                                                                   |
...
| profile.attribute_indices                | the attribute indices of the profile being processed                                                                                               | pcommon.Int32Slice                                                      |
| profile.dropped_attributes_count         | the dropped attributes count of the profile being processed                                                                                        | uint32                                                                  |
