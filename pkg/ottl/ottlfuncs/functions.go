...
func converters[K any]() []ottl.Factory[K] {
	return []ottl.Factory[K]{
		...
		NewDurationToNanoFactory[K](),
		NewDurationToMicroFactory[K](),
		NewDurationToMilliFactory[K](),
		NewDurationToSecsFactory[K](),
		NewDurationToMinsFactory[K](),
		NewDurationToHoursFactory[K](),
		NewFnvFactory[K](),
		NewIntFactory[K](),
		NewIsMapFactory[K](),
		NewIsMatchFactory[K](),
