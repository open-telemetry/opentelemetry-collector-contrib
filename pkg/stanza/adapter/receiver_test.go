...
func TestStart(t *testing.T) {
	...
	logsReceiver, err := factory.CreateLogs(
		context.Background(),
		receivertest.NewNopSettingsWithType(factory.Type()),
...
func TestHandleStartError(t *testing.T) {
	...
	receiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(factory.Type()), cfg, mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
...
func TestHandleConsume(t *testing.T) {
	...
	logsReceiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(factory.Type()), factory.CreateDefaultConfig(), mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
...
func TestHandleConsumeRetry(t *testing.T) {
	...
	logsReceiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(factory.Type()), cfg, mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
...
func benchmarkReceiver(b *testing.B, logsPerIteration int) {
	...
	obsrecv, err := receiverhelper.NewObsReport(receiverhelper.ObsReportSettings{ReceiverCreateSettings: receivertest.NewNopSettingsWithType(component.MustNewType("foolog"))})
