...
func TestHandleStartError(t *testing.T) {
	...
	receiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
...
func TestHandleConsume(t *testing.T) {
	...
	logsReceiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), factory.CreateDefaultConfig(), mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
...
func TestHandleConsumeRetry(t *testing.T) {
	...
	logsReceiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(metadata.Type), cfg, mockConsumer)
	require.NoError(t, err, "receiver should successfully build")
