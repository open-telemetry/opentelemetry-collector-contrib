...
func TestCreateReceiver(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		receiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(factory.Type()), cfg, consumertest.NewNop())
	...
	t.Run("DecodeOperatorConfigsFailureMissingFields", func(t *testing.T) {
		...
		receiver, err := factory.CreateLogs(context.Background(), receivertest.NewNopSettingsWithType(factory.Type()), badCfg, consumertest.NewNop())
