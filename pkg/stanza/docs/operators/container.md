...
| `max_batch_size`             | `100`            | The maximum number of log entries to batch before flushing when parsing CRI/containerd logs. Increase this value if you have very long multiline logs (e.g., large stack traces) that exceed 100 partial log entries. |
