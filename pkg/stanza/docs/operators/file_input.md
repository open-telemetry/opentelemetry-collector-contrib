...
| `follow_symlinks`               | `true`                               | When set to `false`, the `include` globs do not descend into symlinked directories. Useful to avoid re-traversing a subtree reached through a directory-symlink loop.                                                                                             |
