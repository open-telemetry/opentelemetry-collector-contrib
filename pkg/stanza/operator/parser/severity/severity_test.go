...
func runSeverityParseTest(cfg *ParserConfig, ent *entry.Entry, buildErr bool, parseErr bool, expected entry.Severity) func(*testing.T) {
...
func parseSeverityTestConfig(parseFrom entry.Field, preset string, mapping map[interface{}]interface{}) *ParserConfig {
