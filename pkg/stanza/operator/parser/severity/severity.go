...
func init() {
	operator.Register("severity_parser", func() operator.Builder { return NewParserConfig("") })
}

// NewParserConfig creates a new severity parser config with default values
...
// ParserConfig is the configuration of a severity parser operator.
