...
func init() {
	operator.Register("syslog_parser", func() operator.Builder { return NewParserConfig("") })
}

// NewParserConfig creates a new syslog parser config with default values
...
// ParserConfig is the configuration of a syslog parser operator.
