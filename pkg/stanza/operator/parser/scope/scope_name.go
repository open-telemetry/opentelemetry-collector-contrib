...
func init() {
	operator.Register("scope_name_parser", func() operator.Builder { return NewParserConfig("") })
}

// NewParserConfig creates a new logger name parser config with default values
...
// ParserConfig is the configuration of a logger name parser operator.
