...
func init() {
	operator.Register("regex_parser", func() operator.Builder { return NewParserConfig("") })
}

// NewParserConfig creates a new regex parser config with default values
...
// ParserConfig is the configuration of a regex parser operator.
