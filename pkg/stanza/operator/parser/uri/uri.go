...
func init() {
	operator.Register("uri_parser", func() operator.Builder { return NewParserConfig("") })
}

// NewParserConfig creates a new uri parser config with default values.
...
// ParserConfig is the configuration of a uri parser operator.
