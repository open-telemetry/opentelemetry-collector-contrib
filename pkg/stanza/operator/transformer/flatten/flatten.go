...
func init() {
	operator.Register("flatten", func() operator.Builder { return NewOperatorConfig("") })
}

// NewOperatorConfig creates a new flatten operator config with default values
...
// OperatorConfig is the configuration of a flatten operator
...
// Operator flattens an object in the body field
