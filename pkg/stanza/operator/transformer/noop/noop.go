...
func init() {
	operator.Register("noop", func() operator.Builder { return NewOperatorConfig("") })
}

// NewOperatorConfig creates a new noop operator config with default values
...
// OperatorConfig is the configuration of a noop operator.
...
// Operator is an operator that performs no operations on an entry.
