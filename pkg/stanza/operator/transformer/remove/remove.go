...
func init() {
	operator.Register("remove", func() operator.Builder { return NewOperatorConfig("") })
}

// NewOperatorConfig creates a new remove operator config with default values
...
// OperatorConfig is the configuration of a remove operator
...
// Operator is an operator that deletes a field
...
func (p *Operator) Transform(entry *entry.Entry) error {
