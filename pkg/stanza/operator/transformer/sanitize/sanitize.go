...
package sanitize // import "github.com/open-telemetry/opentelemetry-collector-contrib/pkg/stanza/operator/transformer/sanitize"
...
const (
	operatorType           = "sanitize"
	invalidCharacterMarker = "�" // Unicode replacement character
)
...
// NewConfig creates a new sanitize config with default values
func NewConfig() *Config {
	return NewConfigWithID(operatorType)
}

// NewConfigWithID creates a new sanitize config with default values
...
// Config is the configuration of a sanitize operator
type Config struct {
