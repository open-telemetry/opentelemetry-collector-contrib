...
func init() {
	operator.Register("udp_input", func() operator.Builder { return NewInputConfig("") })
}

// NewInputConfig creates a new UDP input config with default values
...
// InputConfig is the configuration of a udp input operator.
