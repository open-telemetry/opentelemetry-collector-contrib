...
func init() {
	operator.Register("stdin", func() operator.Builder { return NewInputConfig("") })
}

// NewInputConfig creates a new stdin input config with default values
...
// InputConfig is the configuration of a stdin input operator.
