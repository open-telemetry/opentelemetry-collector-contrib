...
func init() {
	operator.Register("generate_input", func() operator.Builder { return NewInputConfig("") })
}

// NewInputConfig creates a new generate input config with default values
...
// InputConfig is the configuration of a generate input operator.
